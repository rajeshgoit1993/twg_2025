				...
				<div class="flex-row-multicolum appendTop10">
					...
					<div class="flex-col-md-6">
						<div class="guestInputCont">
							...
							<input type="text" class="textCapital" name="url_title" placeholder="Enter Title" value="{{$data->url_title}}" />
					...
					<div class="flex-col-md-12">
						<div class="guestInputCont">
							...
							<input type="text" name="long_url" placeholder="Enter long URL" value="{{$data->long_url}}" required>
					...
					<div class="flex-col-md-12">
						<div class="guestInputCont">
							...
							<input type="text" name="url_tags" placeholder="Enter Tags" value="{{$data->url_tags}}"/>
						</div>
					</div>
					<div class="flex-col-md-12">
						<div class="btnCont">
							<button type="submit" name="submit" class="btnSubmitEnq btn btn-danger btn-lg">Create</button>
						</div>
					</div>
				</div>
			</div>
...
<h3 class="box-title">Edit Short URLs</h3>
</div>
<div class="box-body">
<form action="{{URL::to('/update_short_url/'.$data->id)}}" method="post" enctype="multipart/form-data">
<input type="hidden" name="type" value="Private Tour"/>
...
<label class="control-label col-sm-2" for="state">Enter Long URL:</label>
<div class="col-sm-5">
<input type="text" name="long_url" class="form-control" placeholder="Enter Long URL" value="{{$data->long_url}}">
