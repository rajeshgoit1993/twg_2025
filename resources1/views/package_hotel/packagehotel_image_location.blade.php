            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <!-- Back Button -->
                        <a href="{{ URL::to('/packagehotelUploads/' . Request::segment(2)) }}" class="btn btn-success">
                        ...
                        <div class="well">
                          ...
                          <div class="box-header" style="padding: 10px 0;">
                              ...
                              <h3 class="box-title">({{ CustomHelpers::get_packagehotel_title(Request::segment(2)) }})</h3>
                          </div>

                          <div class="modal-body">
                            <!-- Form for selecting country, state, and city -->
                            <form action="{{ URL::to('/packagehotel_image_gallery/' . Request::segment(2)) }}">
                                {{ csrf_field() }}
