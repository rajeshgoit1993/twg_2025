		...
		<div class="wrapper">
            ...
            <li class="dropdown notifications-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <span class="label label-warning"><span class="total_notification">0</span></span>
                </a>
                <ul class="dropdown-menu">
                    <li class="header">You have <span class="total_notification">0</span> notifications</li>
                    <li>
                        <!-- Inner Menu: contains the notifications -->
                        <ul class="menu notification_data">
