		...
		<div class="dFtrBox">
			...
			<div class="dFtrRghtSecn">
				<div class="dFtrRgtSubTtl">
					...
					<div class="makeflex">
						<div class="dPmtModeIconBox">
							<img class="lazy-load" data-src="{{ url('/resources/assets/frontend/images/icon/visacard.png') }}" alt="visacard">
						</div>
						<div class="dPmtModeIconBox">
							<img class="lazy-load" data-src="{{ url('/resources/assets/frontend/images/icon/mastercard.png') }}" alt="mastercard">
						</div>
						<div class="dPmtModeIconBox">
							<img class="lazy-load" data-src="{{ url('/resources/assets/frontend/images/icon/amexcard.png') }}" alt="amex">
						</div>
						<div class="dPmtModeIconBox">
							<img class="lazy-load" data-src="{{ url('/resources/assets/frontend/images/icon/rupaycard.png') }}" alt="rupay">
						</div>
					</div>
				</div>
				<div class="dFtrSclMedia">
					<h3>Follow us on</h3>
					<ul class="makeflex">
						<li><a href="https://www.facebook.com/rapidextravels" aria-label="Facebook" target="_blank"><i class="fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="https://twitter.com/rapidextravels" aria-label="Twitter" target="_blank"><i class="fa-twitter" aria-hidden="true"></i></a></li>
						<li><a href="https://www.instagram.com/rapidextravels/" aria-label="Instagram" target="_blank"><i class="fa-instagram" aria-hidden="true"></i></a></li>
						<!--<li><a href="https://plus.google.com/discover" aria-label="Google Plus" target="_blank"><i class="fa-google-plus" aria-hidden="true"></i></a></li>-->
					</ul>
				</div>
