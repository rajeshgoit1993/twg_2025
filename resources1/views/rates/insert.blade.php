      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <form action="{{URL::to('/store-rate')}}" method="post" >
           ...
           <div class="col-sm-6">
             <input type="text" class="form-control" id="currency" placeholder="Enter Currency" name="currency" value="{{ old('currency') }}">
             </div>
       ...
       <div class="row">
         ...
         <div class="form-group">
           ...
           <div class="col-sm-6">
             <input type="text" class="form-control" id="rate" placeholder="Enter Rate" name="rate" value="{{ old('rate') }}">
             </div>
           <div class="col-sm-5"></div>
