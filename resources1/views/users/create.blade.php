							...
							<div class="item-container">
								<div class="form-group profile-img-wrapper">
								    ...
								    <div class="profile-img-box" id="imagePreview">
								        <img id="previewImage" src="{{ url('public/uploads/user_profiles/default-user.png') }}" 
								             alt="Profile Image Preview" loading="lazy">
								    </div>
								    
								    <!-- File Upload Input -->
								    <input type="file" id="profilepic" class="form-control profilepicattachment" name="profile_pic" accept=".jpeg,.jpg,.png,.webp" onchange="return profilepicValidation()" aria-label="Profile Image Upload" style="display: none;" />
