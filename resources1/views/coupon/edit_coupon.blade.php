    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <!-- Back Button -->
                    <a href="{{ URL::to('/Coupon') }}" class="btn btn-success">
                    ...
                    <div class="coupon-container">
                        ...
                        <form action="{{ URL::to('/Update-Coupon/' . $coupon->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="coupon_name" value="{{ $coupon->coupon_name }}" class="form-control" placeholder="Enter Coupon Name" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="coupon_desc" value="{{ $coupon->coupon_desc }}" class="form-control" placeholder="Enter Coupon Desc" required>
                                        <span class="error">{{ $errors->first("coupon_desc") }}</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="value" class="form-control">
                                            <option value="" disabled>Select</option>
                                            @for ($i = 1; $i <= 15; $i++)
                                                <option value="{{ $i }}" {{ $coupon->value == $i ? 'selected' : '' }}>{{ $i }} %</option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="start_date" value="{{ date('d-m-Y', strtotime($coupon->start_date)) }}" class="form-control coupon_datepicker" placeholder="Enter Start Date">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="end_date" value="{{ date('d-m-Y', strtotime($coupon->end_date)) }}" class="form-control coupon_datepicker" placeholder="Enter End Date">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="applicable_for" class="form-control applicable_for" required>
                                            <option value="" disabled>Select</option>
                                            <option value="1" @if($coupon->applicable_for == 1) selected @endif>All</option>
                                            <option value="2" @if($coupon->applicable_for == 2) selected @endif>All Tour Quote</option>
                                            <option value="3" @if($coupon->applicable_for == 3) selected @endif>All Tour Packages</option>
                                            <option value="4" @if($coupon->applicable_for == 4) selected @endif>Special Tour Quote</option>
                                            <option value="5" @if($coupon->applicable_for == 5) selected @endif>Special Tour Packages</option>
                                        </select>
                                    </div>
                                </div>
