<div class="modal fade my-profile-modal" id="mobile_verify_modal" role="dialog">
				...
				<div class="flex-column" style="row-gap: 10px;">
					...
					<div class="col-md-12 relativeCont">
						<div class="form-group">
							...
							<input type="text" class="mobile_otp_value" name="otp" maxlength="8" placeholder="Enter OTP">
						</div>
						<!-- resend otp -->
					...
					<!-- footer -->
		          	<div class="make-sticky-footer">
		            	<div class="modal-footer wrapper">
		              		...
		              		<button type="button" name="verify" class="mobile_verify_button btn-main save">Submit</button>
		            	</div>
		          	</div>
				</div>
			</div>
