                            	...
                            	<div class="form-group">
	                                ...
	                                <select id="supplier_email" class="form-control" name="supplier_email">
	                                    ...
	                                    @foreach($supplierdata as $supplier)
	                                        <option value="{{$supplier->supplierprimaryemail}}">{{$supplier->suppliercompanyname}}</option>
	                                    @endforeach
	                                </select>
	                            </div>
                            </div>
...
var table = $('#example2').DataTable({
	...
	stateSave: $statesave,
	ajax: {
		url: "{{ route('get_supplier_email_list') }}",
...
function fetch_datas(statesave) {
    ...
    var table = $('#example2').DataTable({
        ...
        ajax: {
            url: "{{ route('get_supplier_email_list') }}", // Fetch data from backend
