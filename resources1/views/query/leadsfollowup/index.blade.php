		...
		<div class="col-md-12">
			<div class="box" style="overflow: auto;">
				<div class="box-header">
					<h3 class="box-title">Leads Follow-up</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					@if(Sentinel::check())
						...
						<tr>
							...
							<td id={{$query->id}}>
								<select class="query_status" style="width: 100%;border-color: #ccc;border-radius: 3px;height: 34px;padding: 4px">
									...
									<option value="payment_follow_up" @if($query->status=="payment_follow_up") selected @endif>Next follow-up</option>
									<option value="payment_follow_up" @if($query->status=="payment_follow_up") selected @endif>Leads follow-up</option>
									<option value="rates_negotiation" @if($query->status=="rates_negotiation") selected @endif>Price negotiation</option>
								...
								<div style="border: 1px solid #ccc;border-radius: 3px;margin-top: 10px">
									<p class="pfwmt" style="text-align: center;border-bottom: 1px solid #ccc;padding: 5px 0px;">Follow-Up Date & Time</p>
							...
							<td id={{$query->id}}>
								...
								<div style="border: 1px solid #ccc;border-radius: 3px;margin-top: 10px">
									<p class="pfwmt" style="text-align: center;border-bottom: 1px solid #ccc;padding: 5px;">Concerned Raised</p>
									<p class="pfwmt" style="font-weight: 500;padding: 5px;text-align: center;border-right: 1px solid #ccc">Price too high</p>
								</div>
							</td>
							@endif
							@endif
