			...
			<table width="100%">
				...
				<tr>
					<td class="text" colspan="2">
						...
						<div class="mobile_font">Package Price : <b>Rs. <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data->option4_price,'adult')); ?></b></div>
						<div class="mobile_font"><i>Discount(-) : <b>Rs. <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data->option4_price,'adult')); ?></b></i></div>
						<div class="mobile_font">Price To PAY : <b>Rs. <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data->option4_price,'adult')); ?></b></div>
						@elseif($data->option4_price_type=="Group Price")
							...
							?>
						<div class="mobile_font">Package Price : <b>Rs. <?php CustomHelpers::get_indian_currency($option4_total); ?></b></div>
						<!--Discount-->
							<?php
							...
							?>
						<div class="mobile_font"><i>Discount(-) : <b>Rs. <?php CustomHelpers::get_indian_currency($option4_total_discount); ?></b></i></div>
						<!--Total Price-->
						<div class="mobile_font" style="margin-bottom: 0px;">Price To PAY : <b>Rs. <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data->option4_price,'adult')); ?></b></div>
						@endif
				...
				<tr>
					<td class="text" colspan="2">
						...
						<?php $footer=unserialize($data->option4_quotation_footer); ?>
						@endif
