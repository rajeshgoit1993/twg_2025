...
<img src="http://imgak.mmtcdn.com/holidays/images/quotemanager/rupee.png"> {{CustomHelpers::get_quotation_grandtotal($data->option1_price,'adult')}} <i>for <?php 
$total_traveler="0";
...
@php
$itinerary_data=unserialize($data->option1_dayItinerary);
$day="1";
@endphp
...
<i><b>Click Here: <a href="
	{{url('/TheWorldGateway/'.$data->unique_code)}}" target="_blank">Quotation Details</a></b></i>
