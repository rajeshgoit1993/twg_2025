<div>
	...
	<div style="padding: 20px;background: #ffffff;margin-bottom: 10px">
		<h3 class="pfwmt" style="font-size: 22px;line-height: 22px;color: #000000;margin-bottom: 10px">{{ $data4->custom_package_name }}</h3>
		<p class="pfwmt" style="font-size: 18px;line-height: 22px;color: #4a4a4a;margin-bottom: 20px">{{ $data4->duration-1 }} Nights - {{ $data4->duration }} Days</p>
	...
	<div class="" style="padding: 20px;background: #ffffff;margin-bottom: 10px">
		<div class="flex-column" style="">
			...
			<div>
				<div class="flexcenter" style="justify-content: space-between">
					...
					<p class="priceitemlist" style="font-size: 16px">&#x20B9; <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data4->option4_price,'adult')); ?></p>
				</div>
				<div style="border: 1px solid lightgray;margin: 16px 0px"></div>
				<div class="flexcenter" style="justify-content: space-between">
					<p class="priceitemlist">Discount (-)</p>
					<p class="priceitemlist" style="font-size: 16px">&#x20B9; <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data4->option4_price,'adult')); ?></p>
				</div>
				<div style="border: 1px solid lightgray;margin: 16px 0px"></div>
				<div class="flexcenter" style="justify-content: space-between">
				...
				<div class="makeflex" style="justify-content: space-between">
					...
					<p class="pfwmt" style="font-size: 11px;color: #4A4A4A;font-weight: normal;line-height: 12px">( {{ $data4->anything }} )</p>
					</div>
					<div>
					<p class="priceitemlist" style="font-size: 21px">&#x20B9; <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data4->option4_price,'adult')); ?></p>
					</div>
				</div>
			</div>
			...
			<div>
				<div class="flexcenter" style="justify-content: space-between">
					...
					?>
					<p class="priceitemlist" style="font-size: 16px">&#x20B9; <?php CustomHelpers::get_indian_currency($option4_total); ?></p>
				</div>
				<div style="border: 1px solid lightgray;margin: 16px 0px"></div>
				<div class="flexcenter" style="justify-content: space-between">
					<p class="priceitemlist">Discount (-)</p>
					...
					?>
					<p class="priceitemlist" style="font-size: 16px">&#x20B9; <?php CustomHelpers::get_indian_currency($option4_total_discount); ?></p>
				</div>
				<div style="border: 1px solid lightgray;margin: 16px 0px"></div>
				<div class="flexcenter" style="justify-content: space-between">
					<p class="priceitemlist">GST (5%)</p>
				...
				<div class="flexcenter" style="justify-content: space-between">
					...
					<p class="priceitemlist" style="font-size: 21px">&#x20B9; <?php CustomHelpers::get_indian_currency($option4_total-$option4_total_discount); ?></p>
				</div>
			</div>
			@endif
			<i>
		...
		@if($data4->option4_validaty!="")
			<div class="flexcenter" style="justify-content: flex-end;margin-top: 10px">
				...
				<p class="pfwmt" style="font-size: 12px;color: #9B9B9B;line-height: 12px;text-transform: uppercase">{{ date("d M Y", strtotime($data4->option4_validaty)) }}</p>
			</div>
		@endif
		<!--Quote Validity ends-->
	</div>
			...
			<div style="margin-bottom: 25px">
				...
				<div style="border: 1px solid #CCCCCC;padding: 15px;border-radius: 5px">
					...
					<div class="flexcenter" style="margin-bottom: 25px">
					  <span style="font-size: 14px;font-weight: 400;color: #4a4a4a">@if($flight_detail['numberstop']!="") {{$flight_detail['numberstop']}} @endif</span>
					  <div style="border-left: 2px solid #ccc;height: 16px;margin-left: 5px;margin-right: 5px"></div>
						<div>
							<p class="pfwmt" style="font-size: 14px;font-weight: 400;color: #4a4a4a;line-height: 16px;">@if($flight_detail['name']!="") {{$flight_detail['name']}} @endif</p>
					...
					<div class="flexcenter">
						...
						<div class="flex110" style="min-width: 80px;">
						...
						<div class="flexcenter flex110">
							<i class="fa fa-plane" aria-hidden="true" style="font-size: 18px;color: #4A4A4A;transform: rotate(45deg)"></i>
							<div class="flex110" style="margin: 20px 5px;border-top: 1px solid #ccc;min-width: 110px;"></div>
	...
	<div style="padding: 20px;background: #ffffff;margin-bottom: 10px">
		<h3 class="pfwmt" style="font-size: 16px;line-height: 19px;color: #000000;margin-bottom: 20px;text-transform: uppercase">{{ $data4->option4_transport }}</h3>
		<div style="">
			<p class="pfwmt" style="font-size: 16px;line-height: 16px;font-weight: 500;color: #4A4A4A">{{ $data4->option4_transport_description }}</p>
		</div>
	</div>
	@endif
			...
			<div style="margin-bottom: 25px">
				...
				<div style="border: 1px solid #CCCCCC;padding: 15px;border-radius: 5px;">
						...
						<div class="makeflex" style="justify-content: center">
							<img width="" height="106" src="{{ url('/public/uploads/no-image.png') }}" style="border-radius: 5px;flex: 1">								
						</div>
					<div class="">
					<div>
							...
							<div style="margin-top: 20px;margin-bottom: 25px">
								...
								<p class="pfwmt" style="font-size: 20px;line-height: 20px">Private Transfer</p>
							</div>
							...
							<div class="flexcenter" style="justify-content: space-between">
								...
								<div>
									<p class="pfwmt" style="text-align: right;font-size: 12px;line-height: 17px;color: #9B9B9B">DURATION</p>
									<p class="pfwmt" style="text-align: right;font-size: 14px;line-height: 17px;color: #4A4A4A">1 hrs</p>
								</div>
							</div>							
	...
	<div style="padding: 20px 20px 10px;background: #ffffff">
		...
		<div class="content" style="margin: 10px 0px 0px 0px;background: #ffffff">
			...
			<p style="margin: 10px 0px;border-bottom: 1px solid #e9e9e9">{!!$data4->option4_inclusions!!}</p>
			<!--Exclusions-->
			<h3 class="pfwmt" style="margin-top: 25px;font-size: 16px;line-height: 19px;color: #000000">Exclusions</h3>
			<p style="margin: 10px 0px;border-bottom: 1px solid #e9e9e9">{!!$data4->option4_exclusions!!}</p>
		</div>
	</div>
	...
	@else
		<div style="padding: 20px 20px 10px;background: #ffffff">
			...
			@endforeach
				<div class="pfwmt" style="margin-bottom: 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 5px;background: #ffffff">{{ $data4->option4_visa_policies }}</div>
		</div>
		<div style="border-bottom: 1px solid #CED0D4;margin: 0px 5px"></div>
	@endif
	@endif
	...
	<div style="padding: 20px 20px 10px;background: #ffffff">
		...
		@endforeach
				<div class="pfwmt" style="margin-bottom: 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 5px;background: #ffffff">{{ $data4->option4_payment_policies }}</div>
			</div>
	</div>
		<div style="border-bottom: 1px solid #CED0D4;margin: 0px 5px"></div>
	@endif
	...
	<div style="padding: 20px 20px 10px;background: #ffffff">
		...
		@endforeach
				<div class="pfwmt" style="margin-bottom: 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 5px;background: #ffffff">{{ $data4->option4_cancellation }}</div>
			</div>
	...
	<div style="padding: 20px 20px 10px;background: #ffffff">
			...
			@endforeach
				<div class="pfwmt" style="margin-bottom: 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 5px;background: #ffffff">{{ $data4->option4_extra_imp }}</div>
				</div>
			<!--<div style="border-bottom: 1px solid #CED0D4"></div>-->
	</div>
		<div style="border-bottom: 1px solid #CED0D4;margin: 0px 5px"></div>
	...
	<div style="width: 100%;background-color: #000000;position: fixed;bottom: 0px;z-index:999">
		<div class="flexcenter" style="padding: 10px 20px;justify-content: space-between">
			<div class="makeflex" style="align-items: baseline">
				<p class="pfwmt" style="font-size: 20px;line-height: 24px;color: #ffffff;margin-right: 5px"><span style="font-size: 18px;font-weight: 500;">&#x20B9;</span> <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data4->option4_price,'adult')); ?></p>
				<p class="pfwmt" style="font-size: 10px;line-height: 12px;color: #CED0D4">Per person</p>
			</div>
			<div>
				<div style="border-left: 1px solid white;height: 35px;margin-left: -5%;position: absolute;"></div>
				<button class="button" style="padding: 0px 60px;height: 40px;border-radius: 25px;font-size: 18px;font-weight: 900;background-color: #008cff;" id="book">BOOK</button>
			</div>
		</div>
	</div>
