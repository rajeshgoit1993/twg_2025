<div>
	...
	<div class="" style="padding: 20px;background: #ffffff;margin-bottom: 10px">
		<div class="flex-column" style="">
			...
			<div>
				<div class="flexcenter" style="justify-content: space-between">
					...
					<p class="priceitemlist" style="font-size: 16px">&#x20B9; <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data3->option3_price,'adult')); ?></p>
				</div>
				<div style="border: 1px solid lightgray;margin: 16px 0px"></div>
				<div class="flexcenter" style="justify-content: space-between">
					<p class="priceitemlist">Discount (-)</p>
					<p class="priceitemlist" style="font-size: 16px">&#x20B9; <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data3->option3_price,'adult')); ?></p>
				</div>
				<div style="border: 1px solid lightgray;margin: 16px 0px"></div>
				<div class="flexcenter" style="justify-content: space-between">
				...
				<div class="makeflex" style="justify-content: space-between">
					...
					<div>
					<p class="priceitemlist" style="font-size: 21px">&#x20B9; <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data3->option3_price,'adult')); ?></p>
					</div>
				</div>
			</div>
			...
			<div>
				<div class="flexcenter" style="justify-content: space-between">
					...
					?>
					<p class="priceitemlist" style="font-size: 16px">&#x20B9; <?php CustomHelpers::get_indian_currency($option3_total); ?></p>
				</div>
				<div style="border: 1px solid lightgray;margin: 16px 0px"></div>
				<div class="flexcenter" style="justify-content: space-between">
					<p class="priceitemlist">Discount (-)</p>
					...
					?>
					<p class="priceitemlist" style="font-size: 16px">&#x20B9; <?php CustomHelpers::get_indian_currency($option3_total_discount); ?></p>
				</div>
				<div style="border: 1px solid lightgray;margin: 16px 0px"></div>
				<div class="flexcenter" style="justify-content: space-between">
					<p class="priceitemlist">GST (5%)</p>
				...
				<div class="flexcenter" style="justify-content: space-between">
					...
					<p class="priceitemlist" style="font-size: 21px">&#x20B9; <?php CustomHelpers::get_indian_currency($option3_total-$option3_total_discount); ?></p>
				</div>
			</div>
			@endif
			<i>
		...
		@if($data3->option3_validaty!="")
			<div class="flexcenter" style="justify-content: flex-end;margin-top: 10px">
				...
				<p class="pfwmt" style="font-size: 12px;color: #9B9B9B;line-height: 12px;text-transform: uppercase">{{ date("d M Y", strtotime($data3->option3_validaty)) }}</p>
			</div>
		@endif
		<!--Quote Validity ends-->
	</div>
	...
	@else
		<div style="padding: 20px 20px 10px;background: #ffffff">
			...
			@endforeach
				<div class="pfwmt" style="margin-bottom: 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 5px;background: #ffffff">{{ $data3->option3_visa_policies }}</div>
		</div>
		<div style="border-bottom: 1px solid #CED0D4;margin: 0px 5px"></div>
	@endif
	@endif
	...
	<div style="padding: 20px 20px 10px;background: #ffffff">
		...
		@endforeach
				<div class="pfwmt" style="margin-bottom: 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 5px;background: #ffffff">{{ $data3->option3_payment_policies }}</div>
			</div>
	</div>
		<div style="border-bottom: 1px solid #CED0D4;margin: 0px 5px"></div>
	@endif
	...
	<div style="padding: 20px 20px 10px;background: #ffffff">
		...
		@endforeach
				<div class="pfwmt" style="margin-bottom: 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 5px;background: #ffffff">{{ $data3->option3_cancellation }}</div>
			</div>
	...
	<div style="padding: 20px 20px 10px;background: #ffffff">
			...
			@endforeach
				<div class="pfwmt" style="margin-bottom: 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 5px;background: #ffffff">{{ $data3->option3_extra_imp }}</div>
				</div>
			<!--<div style="border-bottom: 1px solid #CED0D4"></div>-->
	</div>
		<div style="border-bottom: 1px solid #CED0D4;margin: 0px 5px"></div>
	...
	<div style="width: 100%;background-color: #000000;position: fixed;bottom: 0px;z-index:999">
		<div class="flexcenter" style="padding: 10px 20px;justify-content: space-between">
			<div class="makeflex" style="align-items: baseline">
				<p class="pfwmt" style="font-size: 20px;line-height: 24px;color: #ffffff;margin-right: 5px"><span style="font-size: 18px;font-weight: 500;">&#x20B9;</span> <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data3->option3_price,'adult')); ?></p>
