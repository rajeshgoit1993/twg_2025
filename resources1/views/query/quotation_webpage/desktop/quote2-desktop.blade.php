	...
	<div class="tourQuoteSummaryCont">
		<div>
			<h4 class="tourQuoteTitle">{{ $data2->custom_package_name }}</h4>
			<h5 class="tourQuoteDaysBadge">{{ $data2->duration-1 }} Nights / {{ $data2->duration }} Days</h5>
		</div>
			...
			@for($i=0;$i<$count_package_service;$i++)
				...
				<div class="serviceIcons">
					<div class="serviceIconsImage">
						<img class="serviceImage" src="{{ url('/public/uploads/icons/'.CustomHelpers::getimagename($package_service[$i],'rt_icons','icon')) }}" title="{{ CustomHelpers::getimagename($package_service[$i],'rt_icons','icon_title') }}">
					</div>
					<div class="serviceIconsTitle">{{ CustomHelpers::getimagename($package_service[$i],'rt_icons','icon_title') }}</div>
				</div>
				@else
				@endif
			@endfor
	...
	<div class="tourQuoteDatePricingCont">
		<div class="makeflex" style="">
			...
			<div class="tourQuoteCityBox">
				...
				<h3 class="tourQuoteCityName">{{ $data2->source }}</h3>
			</div>
			<!--Tour Date-->
			...
			<div>
				<div class="makeflexCenterBewtween">
					...
					<p class="tourQuotePriceValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data2->option2_price,'adult')); ?></p>
				</div>
				<div class="tourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="tourQuotePriceBoxSubHead">Discount (-)</p>
					<p class="tourQuotePriceValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data2->option2_price,'adult')); ?></p>
				</div>
				<div class="tourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
				...
				<div class="flexBetween">
					...
					<p class="tourQuotePriceTagline">( {{ $data2->anything }} )</p>
					</div>
					<div>
					<p class="tourQuotePriceTotalValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data2->option2_price,'adult')); ?></p>
					</div>
				</div>
			</div>
			...
			<div>
				<div class="makeflexCenterBewtween">
					...
					?>
					<p class="tourQuotePriceValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option2_total); ?></p>
				</div>
				<div class="tourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="tourQuotePriceBoxSubHead">Discount (-)</p>
					...
					?>
					<p class="tourQuotePriceValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option2_total_discount); ?></p>
				</div>
				<div class="tourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="tourQuotePriceBoxSubHead">GST (5%)</p>
				...
				<div class="makeflexCenterBewtween">
					<p class="tourQuotePriceTotal">Grand Total</p>
					<p class="tourQuotePriceTotalValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option2_total-$option2_total_discount); ?></p>
				</div>
			</div>
			@endif
			<i>
		...
		@if($data2->option2_validaty!="")
			<div class="tourQuoteValidity">QUOTE VALIDITY - {{ date("d M Y", strtotime($data2->option2_validaty)) }}</div>
		@endif
		<!--Quote Validity ends-->
	</div>
	...
	<div class="tourQuoteFlightCont">
		<h3 class="tourQuoteFlightHead">{{ $data2->option2_transport }}</h3>
		<div class="tourQuoteTransportBox">
			<p class="transportDesc">{{ $data2->option2_transport_description }}</p>
		</div>
	</div>
	@endif
	...
	<div class="tourQuoteTransferCont">
		...
		<div class="tourQuoteTransferBox">
			<div class="tourQuoteTransferTitle">Airport to Dubai Hotel transfer</div>
			<div class="tourQuoteTransferDescBox">
				<div class="makeflex">
					<!--Vehicle Image-->
					<div class="transferImageBox">
						<img class="transferImageType" src="{{ url('/public/uploads/no-image.png') }}">								
					</div>
					<div>
						<!--Private, Shared or Coach-->
						<div class="transferDescTopSection">
							<h4 class="transferTitle">Airport to Hotel Transfer</h4>
							<h2 class="transportType">Private Transfer</h2>
						</div>
						<!--Vehicle Type,Duration & Inclusion-->
						<div class="flexCenter">
							<div class="transferVehicleCont">
								<h4 class="transferHead">VEHICLE TYPE</h4>
								<h5 class="transferSubHead">Toyata Hiace</h5>
							</div>
							<div class="transferDurationCont">
								<h4 class="transferHead">DURATION</h4>
								<h5 class="transferSubHead">1 hrs</h5>
							</div>
							<div>
								<h4 class="transferHead">INCLUDES</h4>
								<h5 class="transferSubHead">One-way Private transfer</h5>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="tourQuoteVisaPolicyCont">
		...
		<?php $v_policy=unserialize($data2->option2_package_visa); ?>
			...
			@endforeach
			<div class="tourQuoteVisaAddPolicy">{{ $data2->option2_visa_policies }}</div>
		</div>
	</div>
	@endif
	@endif
	...
	<div class="tourQuoteBookPolicyCont">
		...
		@else
			...
			@endforeach
				<div class="tourQuoteBookAddPolicy">{{ $data2->option2_payment_policies }}</div>
		...
		@else
			...
			@endforeach
				<div class="tourQuoteCancelAddPolicy">{{ $data2->option2_cancellation }}</div>
		@endif
	...
	<div class="tourQuoteImpCont">
		...
		@endforeach
			<div class="tourQuoteImpAddPolicy">{{ $data2->option2_extra_imp }}</div>
		</div>
	</div>
	@endif
