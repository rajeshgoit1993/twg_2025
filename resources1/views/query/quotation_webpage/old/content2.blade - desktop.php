...
<div class="" style="border: 1px solid #CED0D4;padding: 25px 40px;border-radius: 10px;background: #ffffff;margin-bottom: 10px">
	<div class="makeflex" style="">
		<!--Departure City-->
		<div class="" style="background: #F9F9F9;padding: 25px;border-radius: 5px;box-shadow: 0px 3px 6px #CED0D4;margin-right: 40px;width: 360px;max-height: 235px">
		...
		<!--Pricing-->
		<div class="" style="background: #F9F9F9;padding: 25px;border-radius: 5px;box-shadow: 0px 3px 6px #CED0D4;width: 360px">
...
<div style="border: 1px solid #CED0D4;padding: 25px;border-radius: 10px;background: #ffffff;margin-bottom: 10px">
	...
	<div style="margin: 0px 15px">
		...
		<div style="margin-bottom: 25px">
			...
			<div style="border: 1px solid #CED0D4;padding: 25px 25px;border-radius: 5px;background: #F9F9F9">
				<div class="flexcenter" style="margin-bottom: 15px">
					...
					<?php
						...
						$newDate_flight = date("d M Y", strtotime($originalDate_flight));
					?>
					<span style="font-size: 18px;color: #4a4a4a;font-weight: 600;margin-right: 10px">{{date('D', strtotime($originalDate_flight))}}, {{$newDate_flight}}</span>
				  @endif 
				  @endif
				  <div style="border-right: 2px solid #ccc;height: 18px;margin-right: 10px;"></div>
			...
			<div style="border: 1px solid #CED0D4;padding: 25px 25px;border-radius: 5px;background: #F9F9F9">
				<div class="flexcenter" style="margin-bottom: 15px">
					...
					<?php
						...
						$newDate_flight_down = date("d M Y", strtotime($originalDate_flight_down));
					?>
					<span style="font-size: 18px;color: #4a4a4a;font-weight: 600;margin-right: 10px">{{ date('D', strtotime($originalDate_flight_down)) }}, {{ $newDate_flight_down }}</span>
					@endif 
					@endif
					<div style="border-right: 2px solid #ccc;height: 18px;margin-right: 10px;"></div>
					<span class="" style="font-size: 14px;font-weight: 400;color: #4a4a4a">@if($flight_detail['numberstop']!="") {{$flight_detail['numberstop']}} @endif</span>
...
<div style="border: 1px solid #CED0D4;padding: 25px;border-radius: 10px;background: #ffffff;margin-bottom: 10px">
	...
	<div style="margin-bottom: 25px">
		...
		<div style="border: 1px solid #e9e9e9;padding: 25px 25px;border-radius: 5px;background: #F9F9F9">
			<div class="makeflex">
			<!--Property Image-->
