...
?>
<input type="text" class="form-control" value="{{$day_night}}" name="duration" readonly="" placeholder="Package Destination"> 
</div>
</div>
...
<div class="row">
<div class="col-md-6">
<a href="{{URL::to('quo_new/'.$data->id)}}"><button type="button" name="add" id="" class="btn btn-success">New Quotation
<i class="fa  fa-arrow-right"></i> </button> </a>

<a href="{{URL::to('quo_copy/'.$data->id)}}"><button type="button" name="add" id="" class="btn btn-success">Copy Quotation
<i class="fa  fa-arrow-right"></i> </button> </a>
</div>
</div>
