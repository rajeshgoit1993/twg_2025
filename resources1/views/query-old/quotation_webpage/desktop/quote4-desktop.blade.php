<div class="row">
	...
	@endforeach
	@endif
	@if($data4->accept_status=="0" && $data4->send_option=="1")
	...
	<div class="tourQuoteSummaryCont">
		<div>
			<h4 class="tourQuoteTitle">{{ $data4->custom_package_name }}</h4>
			<h5 class="tourQuoteDaysBadge">{{ $data4->duration-1 }} Nights / {{ $data4->duration }} Days</h5>
		</div>
	...
	<div class="tourQuoteDatePricingCont">
		<div class="makeflex">
			...
			<div class="tourQuoteCityBox">
				...
				<h3 class="tourQuoteCityName">{{ $data4->source }}</h3>
			</div>
			<!--Tour Date-->
			...
			<div>
				<div class="makeflexCenterBewtween">
					...
					<p class="tourQuotePriceValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data4->option4_price,'adult')); ?></p>
				</div>
				<div class="tourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="tourQuotePriceBoxSubHead">Discount (-)</p>
					<p class="tourQuotePriceValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data4->option4_price,'adult')); ?></p>
				</div>
				<!--<div class="tourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
				...
				<div class="flexBetween">
					...
					<p class="tourQuotePriceTagline">( {{ $data4->anything }} )</p>
					</div>
					<div>
					<p class="tourQuotePriceTotalValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data4->option4_price,'adult')); ?></p>
					</div>
				</div>
			</div>
			...
			<div>
				<div class="makeflexCenterBewtween">
					...
					?>
					<p class="tourQuotePriceValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option4_total); ?></p>
				</div>
				<div class="tourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="tourQuotePriceBoxSubHead">Discount (-)</p>
					...
					?>
					<p class="tourQuotePriceValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option4_total_discount); ?></p>
				</div>
				<div class="tourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="tourQuotePriceBoxSubHead">GST (5%)</p>
				...
				<div class="makeflexCenterBewtween">
					<p class="tourQuotePriceTotal">Grand Total</p>
					<p class="tourQuotePriceTotalValue"><span class="tourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option4_total-$option4_total_discount); ?></p>
				</div>
			</div>
			@endif
			<i>
		...
		@if($data4->option4_validaty!="")
			<div class="tourQuoteValidity">QUOTE VALIDITY - {{ date("d M Y", strtotime($data4->option4_validaty)) }}</div>
		@endif
		<!--Quote Validity ends-->
	</div>
	...
	<div class="tourQuoteFlightCont">
		<h3 class="tourQuoteFlightHead">{{ $data4->option4_transport }}</h3>
		<div class="tourQuoteTransportBox">
			<p class="transportDesc">{{ $data4->option4_transport_description }}</p>
		</div>
	</div>
	@endif
	...
	<div class="tourQuoteVisaPolicyCont">
		...
		<?php $v_policy=unserialize($data4->option4_package_visa); ?>
			...
			@endforeach
			<div class="tourQuoteVisaAddPolicy">{{ $data4->option4_visa_policies }}</div>
		</div>
	</div>
	@endif
	@endif
	...
	<div class="tourQuoteBookPolicyCont">
		...
		@else
			...
			@endforeach
				<div class="tourQuoteBookAddPolicy">{{ $data4->option4_payment_policies }}</div>
		...
		@else
			...
			@endforeach
				<div class="tourQuoteCancelAddPolicy">{{ $data4->option4_cancellation }}</div>
		@endif
	...
	<div class="tourQuoteImpCont">
		...
		@endforeach
			<div class="tourQuoteImpAddPolicy">{{ $data4->option4_extra_imp }}</div>
		</div>
	</div>
	@endif
