		...
		<div class="col-md-12">
			<div class="tourQuoteRefCont">
				...
				<ul class="nav nav-tabs">
					...
					<li><a data-toggle="tab" href="#menu2">Quote 2</a></li>
					<li><a data-toggle="tab" href="#menu1">Quote 3</a></li>
					<li class="active"><a data-toggle="tab" href="#home">Quote 4</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="paddingTop3">
		...
		<div class="mtourQuoteTabCont">
			<ul class="flexCenter">
				...
				<li><a data-toggle="tab" href="#menu22">Quote 2</a></li>
				<li><a data-toggle="tab" href="#menu11">Quote 3</a></li>
				<li class="active"><a data-toggle="tab" href="#homee">Quote 4</a></li>
			</ul>
		</div>
	</div>
	<div class="tab-content">
