...
<td id={{$query->id}}>
  <select class="query_status" style="width: 100px">
      ...
      <option value="0" @if($query->status=="0") selected @endif disabled>--Choose Status--</option>
...
<button type="submit" class="btn btn-success btn-xcrud btn btn-success send_voucher" data-id="{{$query->id}}" data-toggle="modal" ><i class="fa fa-send"></i></button>
...
<div class="modal-body custom_border" id="voucher_list_body" style="font-size: 15px;
line-height: 24px;">
...
<h4 class="modal-title">Voucher Send</h4>
</div>
<div class="modal-body custom_border"  style="font-size: 15px;
line-height: 24px;">
...
<input type="file" required name="voucher[]" class="voucher form-control" multiple >
<br>
<input type="submit" name=""  class="send_file btn btn-success">
</form>
