	...
	<!--common css-->
	<link rel="stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/frontend/css/common.css') }}" />

	<!--header & footer css-->
	<link rel="stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/frontend/css/header.css') }}" />
	...
	<!--datepicker css-->
	<!-- <link rel="stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/frontend/css/ui-datepicker.css') }}" /> -->
	<link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
	<link rel="stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/frontend/css/ui-datepicker-new.css') }}" />
	...
	<!--Testimonials Slick-->
	<link rel="stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/slick/css/slick.css') }}" />
	<link rel="stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/slick/css/slick-theme.css') }}" />

	<!--scroll-to-top css-->
	<link type="text/css" href="{{ asset('/resources/assets/frontend/css/scroll-to-top.css') }}" rel="stylesheet" />

	<!--footer css-->
	<link type="text/css" href="{{ asset('/resources/assets/frontend/css/footer.css') }}" rel="stylesheet" />

	<!--Lazy-loading-images (to be check and remove from footer and try-->
	<!-- <script rel="preload" as="script" type="text/javascript" src='{{ asset ("/resources/assets/frontend/js/lazy-loading.js") }}'></script> -->
