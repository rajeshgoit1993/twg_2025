    ...
    <script type="text/javascript" src='{{ asset ("/resources/assets/frontend/js/desktop-mobile-width.js") }}'></script>
    ...
    <!-- my-booking redirect -->
    <script type="text/javascript" src='{{ asset ("/resources/assets/frontend/js/my-booking-redirect.js") }}'></script>

    <!-- gateway -->
    <script type="text/javascript" src='{{ asset ("/resources/assets/frontend/js/gateway.js") }}'></script>

    <!-- user login-->
    <script type="text/javascript" src='{{ asset ("/resources/assets/frontend/js/user-login.js") }}'></script>
    ...
    <!-- slidershow -->
    <!-- <script type="text/javascript" src='{{ asset ("/resources/assets/frontend/js/slideshow.js") }}'></script> -->

    <!-- swal -->
    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>

    <!-- news letter -->
    <script type="text/javascript" src='{{ asset ("/resources/assets/frontend/js/newsletter.js") }}'></script>
