    ...
    <!-- Bootstrap 3.3.2 JS -->
    <script type="text/javascript" src='{{ asset ("/resources/assets/admin-lte/bootstrap/js/bootstrap.min.js") }}'></script>

    <script type="text/javascript" src='{{ asset ("/resources/assets/admin-lte/dist/js/select2.js") }}'></script>

    <!-- AdminLTE App -->
    <script type="text/javascript" src='{{ asset ("/resources/assets/admin-lte/dist/js/app.min.js") }}'></script>

    <script type="text/javascript" src='{{ asset ("/resources/assets/admin-lte/plugins/datatables/jquery.dataTables.min.js") }}'></script>

    <script type="text/javascript" src='{{ asset ("/resources/assets/admin-lte/plugins/datatables/dataTables.bootstrap.min.js") }}'></script>
    
    <!-- SlimScroll -->
    <script type="text/javascript" src='{{ asset ("/resources/assets/admin-lte/plugins/slimScroll/jquery.slimscroll.min.js") }}'></script>
    
    <!-- FastClick -->
    <script type="text/javascript" src='{{ asset ("/resources/assets/admin-lte/plugins/fastclick/fastclick.js") }}'></script>
    
    <!-- AdminLTE for demo purposes -->
    <script type="text/javascript" src='{{ asset ("/resources/assets/admin-lte/dist/js/demo.js") }}'></script>
    ...
    <script type="text/javascript" src='{{ asset ("/resources/assets/frontend/js/bootstrap-formhelpers.min.js") }}'></script>
    ...
    <script type="text/javascript" src='{{ asset ("/resources/assets/js/hotel/hotel.js") }}'></script>
    
    <script type="text/javascript" src='{{ asset ("/resources/assets/js/room/room.js") }}'></script>
    ...
    <script type="text/javascript" src='{{ asset ("/resources/assets/js/packages/global.js") }}'></script>
    <!-- tour package and tour quote -->
    <script type="text/javascript" src='{{ asset ("/resources/assets/js/packages/packages.js") }}'></script>

    
    
    <script type="text/javascript" src='{{ asset ("/resources/assets/js/packages/query.js") }}'></script>
    <!--<script type="text/javascript" src='{{ asset ("/resources/assets/admin-lte/dist/js/select2.js") }}'></script> -->
    ...
    jQuery(document).ready(function() {
       ...
       $('.destinations').select2({
            ajax: {
                url: $("#APP_URL").val() + '/search_tour_destination', // Endpoint to fetch countries
                type: "get",
                dataType: 'json',
                delay: 250, // Delay for AJAX request
                data: function(params) {
   ...
   //
      ...
      $('.sp_city').select2({
    ajax: {
        url: $("#APP_URL").val() + '/search_similar_package_city', // Endpoint to fetch cities
        type: "get",
        dataType: 'json',
        delay: 250, // Delay for AJAX request
        data: function(params) {
    ...
    sorter: function(data) {
        return data;  // Disable sorting of results in the dropdown
    }
});
