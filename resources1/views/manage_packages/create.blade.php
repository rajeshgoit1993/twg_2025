...
<!-- create quote -->
<!-- tour-package -->
<link rel="stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/backend/css/tour-package.css') }}" />

<!-- tour-price css -->
<link rel="stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/backend/css/tour-price.css') }}" />
...
<!-- nav tabs -->
                    <ul class="nav nav-tabs makeflex mobscroll scrollX">
                     ...
                     <form action="{{ URL::to('/store-package') }}" method="post" id="package-form">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" placeholder="Enter tour name" value="{{ old('package_name') }}" name="package_name" class="form-control package_name" required>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" placeholder="Package Code" value="{{ old('package_code') }}" name="package_code" class="form-control package_code" required>
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" name="tour_category">
                                        ...
                                        <option value="{{$tourcategory->id}}"> {{$tourcategory->tour_category}} </option>
                                        @endforeach
                                      </select>
                                    </div>
                                  </div>
                                      ...
                                      <div class="input-group pdngBtm5">
                                        ...
                                        <select name="package_suitables[]" id="package_suitables" class="form-control select2" multiple>
                                          ...
                                          @foreach($suitables as $suit)
                                            <option value="{{$suit->icon_title}}">{{$suit->icon_title}} </option>
                                          @endforeach
                                          @else
                                            <option value="No Result Found">No Result Found</option>
                                          @endif
                                      ...
                                      <div class="input-group pdngBtm5">
                                        ...
                                        <select name="package_tags[]" id="package_tags" class="form-control select2" multiple>
                                          ...
                                          @foreach($generals as $general)
                                            <option value="{{$general->icon_title}}">{{$general->icon_title}} </option>
                                          @endforeach
                                          @else
                                            <option value="No Result Found">No Result Found</option>
                                          @endif
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="input-group pdngBtm5">
                                        ...
                                        <select name="package_holiday[]" id="package_holiday" class="form-control select2" multiple>
                                          ...
                                          <option value="{{$holiday->icon_title}}">{{$holiday->icon_title}} </option>
                                          @endforeach
                                          @else
                                          <option value="No Result Found">No Result Found</option>
                                          @endif
                                    ...
                                    <div class="item-container remove dfp dfp-1">
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                          ...
                                          <select name="continent[0]" id="package_continent" class="form-control package_continent">
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                          ...
                                          <select name="country[0]" id="package_dest_countries0" class="form-control package_dest_country" >
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                          ...
                                          <select name="state[0]" id="package_dest_state0" class="form-control package_dest_state" >
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                          ...
                                          <select name="city[0]" id="package_dest_city0" class="package_dest_cities form-control city_package_dest_countries min-select" >
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12 collapsable-form">
                                <div class="form-group item-container custom_inc_exc">
                                  ...
                                  <textarea class="form-control ckeditor collapse-item" name="description" cols="30" rows="5">{{ old('description') }}</textarea>
                                </div>
                              </div>
                              ...
                              <div class="col-md-12">
                                <div class="form-group item-container custom_inc_exc">
                                  ...
                                  <br><br>
                                  <span class="show_hide morePlus">More+</span>
                                  <textarea class="form-control ckeditor collapse-item" name="highlights" id="" cols="30" rows="5">{{ old('highlights') }}</textarea>
                                </div>
                              </div>
                            </div>
                          </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-6 relativeCont appendBottom10">
                                          <div class="form-group daysel">
                                            ...
                                            <select class="form-control select_day select2" name="accommodation_add[{{ $j ?? 0 }}][night][]" multiple>
...
<!-- select hotel name -->
                        ...
                        <div class="col-md-12">
                                  <div class="flightOption">
                                    <label for="flightOption">Add Itinerary</label>
                                ...
                                <div class="form-group pricelistpackage" style="display:none;">
                                  <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field">
                                      ...
                                      <tr>
                                        <td><input name="Price_title" placeholder="Title.." class="form-control" type="text" value="{{ old('Price_title') }}"></td>
                                        <td>
                                          <select name="Price_type" class="form-control">
                                            <option value="0">Select Type </option>
                                            <option value="Per Person">Per Person </option>
                                ...
                                <div class="form-group pricelistpackage_upcoming" style="display:none;">
                                  <div class="table-responsive">
                                    <table class="table table-bordered" id="dynamic_field_upcoming">
                                      ...
                                      <tr>
                                        <td><input name="Price_title_upcoming" placeholder="Title.." class="form-control" type="text" value="{{ old('Price_title') }}"></td>
                                        <td>
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  <div class="table-responsive no-border">
                                    @include('manage_packages.price_fields')
                                    </div>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="item-container">
                              <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <option value="{{$suppliers->id}}" >{{$suppliers->suppliercompanyname}}</option>
                                  @endforeach
                                </select>
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="supplier_remarks" placeholder="Supplier Remarks">{{ old('supplier_remarks') }}</textarea>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12">
                                <div class="item-container">
                                  ...
                                  <div class="form-group">
                                    <label class="field-required">Meta Keywords</label>
                                    <textarea class="form-control" name="rapidex_meta_keyword" placeholder="Keywords">{{ old('rapidex_meta_keyword') }}</textarea>
                                  </div>
                                </div>
                              </div>
                              <!---->
                                  ...
                                  <div class="form-group">
                                    <div class="makeflex align-center ">
                                      ...
                                      <div class="toggle-switch">
                                        <input type="checkbox" value="1" id="book-online-toggle" name="livemode">
...
@section("custom_js_code_second")
  ...
  <!-- tour package -->
  <!-- <script type="text/javascript" src='{{ asset ("/resources/assets/js/packages/tour-package.js") }}'></script> -->
  
  <!-- package property selection -->
  <script type="text/javascript" src='{{ asset ("/resources/assets/js/packages/package-property-selection.js") }}'></script>

  <!-- new pricing -->
  <script type="text/javascript" src='{{ asset ("/resources/assets/js/packages/package_new_price.js") }}'></script>
