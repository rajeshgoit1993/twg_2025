          ...
          <div class="box-body">
            ...
            <div id="dGalleryTopBarCont">
              <div class="makeflex align-center">
                <div>
                  <a href="{{ URL::to('/edit_package_gallery_image/'.Request::segment(2).'/'.Request::segment(3).'/'.Request::segment(4)) }}" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left"> </i> Back</a>
                </div>
                ...
                <div>
                  ...
                  <h3>Edit Images from gallery 
                    <span class="font14">
                    (Images from 
                    {{ CustomHelpers::get_master_table_data('countries', 'id', (int)$city_name, 'name') }} &rarr; 
                    {{ CustomHelpers::get_master_table_data('city', 'id', (int)$city_name, 'name') }} &rarr; 
                    {{ CustomHelpers::get_package_title(Request::segment(3)) }}
                    )</span>
                  </h3>
                </div>
              </div>
            ...
            <div class="dImgSelectionCont">
              ...
              <div class="pagination-container text-center">
                {{ $data->links() }} <!-- Laravel generates pagination links here -->
              </div>
