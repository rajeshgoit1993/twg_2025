			...
			<div id="enquiryModal_desktop" class="modal">
				...
				<div class="enq_modalContent enq_modalContent_size">
					...
					<div class="enq_modalBody">
						<!-- <form  method="Post" action="{{url('save_otp_Query')}}"> -->
								...
								<div class="enq_rightSection">
									<div class="enq_tourImgBox">
										...
										@if(CustomHelpers::get_imgpath_gallery($gallery_id,'image_path')!="0")
											<img src="{{ route('home').'/public/'.CustomHelpers::get_imgpath_gallery($gallery_id,'image_path') }}">
										@elseif(CustomHelpers::get_imgpath_gallery($gallery_id,'image_path')=="0")
											<img src="{{ route('home').'/public/uploads/default_profile_image.png' }}">
										@endif
