<div class="tab-pane fade tourPkgDesc" id="dTourDestinations">
		...
		<div class="fancy-collapse-panel">
			...
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingThree">
					...
					<a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#{{str_slug($data, '-')}}" aria-expanded="false" aria-controls="collapseThree"><span class="glyphicon glyphicon-map-marker" style="color: #da2128"></span> {{$data}} , {{CustomHelpers::get_destination_data($data,'country')}}
					</a>
					</h4>
				</div>
				<div id="{{str_slug($data, '-')}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
