	...
	<div>
		...
		<div class="modalContent">
			...
			<div class="row makeflex">
					...
					<div class="row">
						...
						<div class="row">
							<div class="col-md-12 guestCont">
								...
								<div class="flexCenter mobscroll" style="overflow-x: auto;">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="addOnDtlsCont mobscroll" style="overflow-x: auto;">
				...
				<!--Sidebar Tour Image-->
				<div class="col-md-4 sideTourImage">
					...
					@if(CustomHelpers::get_imgpath_gallery($gallery_id,'image_path')!="0")
						<img class="enqTourImage" src="{{ URL::to('/').'/public/'.CustomHelpers::get_imgpath_gallery($gallery_id,'image_path') }}">
					@elseif(CustomHelpers::get_imgpath_gallery($gallery_id,'image_path')=="0")
						<img class="enqTourImage" src="{{ URL::to('/').'/public/uploads/default_profile_image.png' }}">
					@endif
