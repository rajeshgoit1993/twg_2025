<div class="tab-pane fade tourPkgDesc" id="dTourFlights">	
	@if($details->flight!='')
							...
							<div class="onwardFlightBox">
								<div class="flexCenter appendBottom15">
									...
									<span class="flightClass">
										@if(array_key_exists('cabin',$flight_detail)) {{$flight_detail['cabin']}} @endif
									</span>
								</div>
								<div class="flexCenter appendLeft20">
									<div class="appendRight10">
										...
										<div class="airlineLogoBox">
											<img class="airlineLogo" src="{{ asset('public/uploads/default-img.webp') }}">
										</div>
									</div>
									...
									<div class="flightDurationCont">
										<p class="flightDuration">
											@if(array_key_exists('duration_hours',$flight_detail)) {{$flight_detail['duration_hours']}}h @endif
									...
									<div class="W100">
										<p class="flightTiming">
											@if($flight_detail['ahours']!="") {{$flight_detail['ahours']}} @endif:@if($flight_detail['damins']!="") @if($flight_detail['damins']==0) 00 @else {{$flight_detail['damins']}} @endif @endif
										</p>
										<p class="flightCity">
						...
						<div class="tourQuoteReturnFlightBox">
							...
							<div class="returnFlightBox">
								<div class="flexCenter appendBottom15">
									...
									<!--<div style="border-right: 2px solid #ccc;height: 18px;margin: 0px 10px"></div>-->
									<span class="flightStop">
										@if($flight_detail['numberstop']!="") {{$flight_detail['numberstop']}} @endif</span>
									<div class="classSeparator"></div>
								...
								<div class="flexCenter appendLeft20">
									<div class="appendRight10">
										...
										<div class="airlineLogoBox">
											<img class="airlineLogo" src="{{ url('/resources/assets/frontend/images/icon/default-img.webp') }}">
										</div>
									</div>
									<div class="appendRight20 W120">
										<p class="flightName">
									...
									<div class="flightDurationCont">
										<p class="flightDuration">
											@if(array_key_exists('return_duration_hours',$flight_detail)) {{$flight_detail['return_duration_hours']}}h @endif
											@if(array_key_exists('return_duration_mins',$flight_detail)) {{$flight_detail['return_duration_mins']}}m @endif
										</p>
										<div class="flexCenter">
											<i class="fa-plane" aria-hidden="true"></i>
											<div class="flightPathWay"></div>
