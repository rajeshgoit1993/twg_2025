				...
				<div class="mPageContainer">
					<div class="flexCenter flexBetween">
						<div class="mTourTitle">
							<h2>
								<a class="mHomeArrow" href="{{ url('/') }}"></a>
								<span>{{ $destination_search }} Tour Packages</span>
								<input type="hidden" id="destination" value="{{ $destination_search }}">
							</h2>
						</div>
						<!--Filter Modal Starts-->
						<div class="mFltrTtl" id="btn_get_mFilterModal"><span class="fa fa-filter">&nbsp;</span>Filter</div>
					    <!--Filter Modal Ends-->
		...
		<div class="mEditSearch_Sticky">
			<div class="mEditSearchCont">
				<div class="mEditSearchBox mobscroll">
					<div class="mEditSearchItem">{{ $destination_search }}</div>
					<div class="mEditSearchItem mSpaceIcon">{{$theme_name}}
					</div>
					<div class="mEditSearchItem mSpaceIcon">
