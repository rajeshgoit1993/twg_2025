...
<style>
  ...
  <h3 class="box-title">Add Company Profile</h3>
  </div>
            <!-- /.box-header -->
  <div class="box-body">
  <!---->
  <form action="{{URL::to('/company_profile_save')}}" method="Post" id="enquiry_form" enctype="multipart/form-data">
    {{csrf_field()}}
...
<div class="col-md-4">
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="office_no" placeholder="Office Landline No" name="office_no">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="mobile_no">Mobile No:</label>
    <input type="text" class="form-control" id="mobile_no" placeholder="Mobile No" name="mobile_no">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="alternate_no">Alternate Mobile No:</label>
    <input type="text" class="form-control" id="alternate_no" placeholder="Alternate Mobile No" name="alternate_no">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="primary_email">Primary Email ID:</label>
    <input type="email" class="form-control" id="primary_email" name="primary_email" placeholder="Primary Email ID">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="secondary_email">Secondary Email ID:</label>
    <input type="email" class="form-control" id="secondary_email" name="secondary_email" placeholder="Secondary Email ID">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
...
<div class="col-md-4">
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="facebook_link" placeholder="Facebook Link" name="facebook_link">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="twiter">Twitter Link:</label>
    <input type="text" class="form-control" id="twiter" placeholder="Twitter Link" name="twiter">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
...
<div class="col-md-4">
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="other_social_link" name="other_social_link" placeholder="Other Social Link">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
...
<div class="col-md-4">
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="name_of_pan" placeholder="Name on the PAN Card" name="name_of_pan">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="gst_no">GST No.:</label>
    <input type="text" class="form-control" id="gst_no" placeholder="GST No." name="gst_no">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="gst_name">GST Name:</label>
    <input type="text" class="form-control" id="gst_name" placeholder="GST Name" name="gst_name">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="gst_email">GST Email:</label>
    <input type="email" class="form-control" id="gst_email" placeholder="GST Email" name="gst_email">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="gst_contact">GST Contact Number:</label>
    <input type="text" class="form-control" id="gst_contact" placeholder="GST Contact Number" name="gst_contact">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="gst_address">GST Address:</label>
    <input type="text" class="form-control" id="gst_address" placeholder="GST Address" name="gst_address">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="account_dept_no">Accounts Dept. Contact No.:</label>
    <input type="text" class="form-control" id="account_dept_no" placeholder="Accounts Dept. Contact No." name="account_dept_no">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
    <label for="account_dept_email">Accounts Dept. Email ID:</label>
    <input type="email" class="form-control" id="account_dept_email" placeholder="Accounts Dept. Email ID" name="account_dept_email">
  </div>
</div>
<div class="col-md-4">
   <div class="form-group">
...
<div class="col-md-6">
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="other_first_name" placeholder="Name of the Document" name="other_first_name">
  </div>
</div>
<div class="col-md-6">
   <div class="form-group">
...
<div class="col-md-6">
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="other_second_name" placeholder="Name of the Document" name="other_second_name">
  </div>
</div>
<div class="col-md-6">
   <div class="form-group">
