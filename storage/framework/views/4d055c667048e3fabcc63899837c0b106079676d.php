...
<!-- content goes here -->
<form action="<?php echo e(URL::to('/save-quotationheader')); ?>" method="POST">
...
<tbody>
<?php $__currentLoopData = $quotation_header; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$pol): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>   
<tr id="editquoheader_<?php echo e($pol->id); ?>">
<td><input class="checkboxcls" value="3" type="checkbox"></td>
<td class="center"><?php echo e(++$key); ?></td>
<td class="quo_header"><?php echo e($pol->header); ?></td>
<td class="quo_desc">
<input type="hidden" name="" value="<?php echo e($pol-> header_desc); ?>">
<div class="wrap_small">
<div class="small_class">
  <?php echo $pol-> header_desc; ?>
...
<form action="<?php echo e(URL::to('/delete_quotationheader')); ?>" onsubmit="return confirm('Do you really want to delete this.?');" method="POST">
<?php echo e(csrf_field()); ?> 
<input type="hidden" name="id" value="<?php echo e($pol->id); ?>"/>
<a class="btn btn-warning editquotationheader" data-id="<?php echo e($pol->id); ?>" data-toggle="modal"  data-target="#edit_quotationheader" href="#" style="display: inline;padding: 2px 6px !important;">Edit</a> 
...
<div class="modal-body">
<!-- content goes here -->
<form action="<?php echo e(URL::to('/save-quotationfooter')); ?>" method="POST">
<?php echo e(csrf_field()); ?>
...
<tbody>
<?php $__currentLoopData = $quotation_footer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$pol): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>   
<tr id="editquofooter_<?php echo e($pol->id); ?>">
<td><input class="checkboxcls" value="3" type="checkbox"></td>
<td class="center"><?php echo e(++$key); ?></td>
<td class="quo_footer"><?php echo e($pol->footer); ?></td>
<td class="quo_desc">
<input type="hidden" name="" value="<?php echo e($pol-> footer_desc); ?>">
<div class="wrap_small">
<div class="small_class">
  <?php echo $pol-> footer_desc; ?>
...
<form action="<?php echo e(URL::to('/delete_quotationfooter')); ?>" onsubmit="return confirm('Do you really want to delete this.?');" method="POST">
<?php echo e(csrf_field()); ?> 
<input type="hidden" name="id" value="<?php echo e($pol->id); ?>"/>
<a class="btn btn-warning editquotationfooter" data-id="<?php echo e($pol->id); ?>" data-toggle="modal"  data-target="#edit_quotationfooter" href="#" style="display: inline;padding: 2px 6px !important;">Edit</a> 
<!--<a href="#" data-id="<?php echo e($pol->id); ?>" class="btn btn-danger deletePkgType"><i class="fa fa-times"></i></a>-->
<button class="btn-danger" style="display: inline;;border-radius: 5px;padding-top: 0px">Delete</button>
