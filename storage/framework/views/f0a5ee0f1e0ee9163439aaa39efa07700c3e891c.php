 ...
 <?php $__env->startSection('keywords','The world Gateway, Holiday Packages, Hotel Booking, Flight Booking, Tour Activities, Car Rental, Visa Assistance, Forex Exchange, Travel Insurances'); ?>
 <?php $__env->startSection('desc','The world Gateway, Holiday Packages, Hotel Booking, Flight Booking, Tour Activities, Car Rental, Visa Assistance, Forex Exchange, Travel Insurances'); ?>
 <?php $__env->startSection("title", 'The World Gateway'); ?>
 <?php elseif(env("WEBSITENAME")==0): ?>
 <?php $__env->startSection('keywords','RapidexTravels, Holiday Packages, Hotel Booking, Flight Booking, Tour Activities, Car Rental, Visa Assistance, Forex Exchange, Travel Insurances'); ?>
 <?php $__env->startSection('desc','RapidexTravels Holiday Packages, Hotel Booking, Flight Booking, Tour Activities, Car Rental, Visa Assistance, Forex Exchange, Travel Insurances'); ?>
 <?php $__env->startSection("title", 'RapidexTravels'); ?>
 <?php endif; ?>
 
<?php $__env->startSection("custom_css"); ?>

<!-- trip quote -->
<link type="text/css" rel="stylesheet" href="<?php echo e(asset('/resources/assets/frontend/css/trip-quote.css')); ?>" />
...
<section>
	...
	?>
	<?php if($validity<=$today): ?>
		<?php if(Sentinel::check()): ?>
			<?php if(Sentinel::getUser()->roles()->first()->slug == 'customer'): ?>

				<?php echo $__env->make("query.quotation_webpage.expired_modal", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			...
			<div class="pageContainer">
				<div class="paddingTop10">
					<div class="tourQuoteRefCont">
						<h3 class="tourQuoteRefHeading">Reference ID #<?php echo e($data1->quo_ref); ?></h3>
						<ul class="flexCenter">
							<!-- Desktop Tab Links -->
				...
				<div class="tabcontent" id="tourQuote1">
					<?php echo $__env->make("query.quotation_webpage.desktop.quote1-desktop", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="mobile_test_exp">
		<div class="m-quote-cont">
			<div class="mtourQuoteRefCont">
				<h3 class="mtourQuoteRefHeading">Reference ID #<?php echo e($data1->quo_ref); ?></h3>
			</div>
			...
			<div>
				<div class="tabcontent" id="mtourQuote1">
					<?php echo $__env->make("query.quotation_webpage.mobile.quote1-mobile", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				</div>
			</div>
		</div>
	</div>
	   	...
	   	<div class="modal-content modalContent shadow-sm">
	   		...
	   		<div class="modal-body">
	    		<ul class="previous_raise_data">
	    			<?php $__currentLoopData = $previous_raises; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $previous_raise): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
	    				<li>
	    					<?php echo e($previous_raise->raise_concern); ?>
        ...
        <div class="modal-content modalContent shadow-sm">
            ...
            <div class="modal-body">
                <form id="store_raise" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="content_id" value="<?php echo e(CustomHelpers::custom_encrypt($data1->id)); ?>">
...
<!-- page script -->
<script type="text/javascript" src='<?php echo e(asset ("/resources/assets/frontend/js/tour-web-quote.js")); ?>'></script>
