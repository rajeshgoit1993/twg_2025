...
<div id="payment_follow_up_modal" class="modal">
	<div class="modalContent lead-modalbox">
		<form class="user" id="payment_follow_up" method="POST" enctype="multipart/form-data">
			<?php echo e(csrf_field()); ?>

			<input type="hidden" name="query_id" id="query_id_payment_follow_up" value="">
			
			<!-- Modal content starts-->
			<!-- Modal header-->
			<div class="lead-modalheader">
				<h2>Add Payment Follow-up</h2>
			</div>
			...
			<div class="lead-modalbody">
				...
				<!-- <div class="form-group">
					...
					<select class="lead-input-text fullWidth" required id="assign_person" name="assign_person">							
					</select>
				</div> -->
				<!--Follow-up Reason-->
				<!-- <div class="form-group">
					<label for="follow_up_reason" class="detailsInput">Follow-up Reason </label>
					<select class="lead-input-text fullWidth" required id="payment_follow_up_reason" name="follow_up_reason"></select>
				</div> -->
			...
			<div class="lead-modalfooter">
				<button type="button" class="btn_lead_modal_close btn_payment_follow_up_close">Cancel</button>
				<button type="submit" class="btn_lead_modal_update btn_payment_follow_up_update">Update</button>
			</div>
		</form>
		<!-- Modal content ends-->
	</div>
