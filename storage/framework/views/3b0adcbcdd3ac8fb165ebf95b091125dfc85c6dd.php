...
$path=CustomHelpers::get_image_gallery($image->gallery_id,'thum_small');
                                            ?>
                                                <img src="<?php echo e($path); ?>" class="list-item-image">
                                            <?php endif; ?>
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        <?php if(CustomHelpers::get_imgpath_gallery($image->gallery_id,'country')!="0"): ?>
                                            <span><?php echo e(CustomHelpers::get_master_table_data('countries', 'id', (int)CustomHelpers::get_imgpath_gallery($image->gallery_id,'country'), 'name')); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <?php if(CustomHelpers::get_imgpath_gallery($image->gallery_id,'state')!="0"): ?>
                                            <span><?php echo e(CustomHelpers::get_master_table_data('states', 'id', (int)CustomHelpers::get_imgpath_gallery($image->gallery_id,'state'), 'name')); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                        <?php if(CustomHelpers::get_imgpath_gallery($image->gallery_id,'city')!="0"): ?>
                                            <span><?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)CustomHelpers::get_imgpath_gallery($image->gallery_id,'city'), 'name')); ?></span>
                                        <?php endif; ?>
                                    </td>
