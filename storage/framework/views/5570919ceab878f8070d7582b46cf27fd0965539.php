      ...
      <div class="col-md-12">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <!-- Back Button -->
            <a href="<?php echo e(URL::to('/packageUploads/'.Request::segment(3))); ?>" class="btn btn-success">
            ...
            <div class="well">
              ...
              <div class="box-header" style="padding: 10px 0;">
                ...
                <h3 class="box-title">(<?php echo e(CustomHelpers::get_package_title(Request::segment(3))); ?>)</h3>
              </div>
              <div class="modal-body">
                <!-- Form for selecting country, state, and city -->
                <form action="<?php echo e(URL::to('/package_image_gallery_edit/'.Request::segment(2).'/'.Request::segment(3).'/'.Request::segment(4))); ?>"  >
