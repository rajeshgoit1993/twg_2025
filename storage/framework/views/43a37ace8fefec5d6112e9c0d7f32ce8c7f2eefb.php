                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" placeholder="Package Code" value="<?php echo e(old('package_code')); ?>" name="package_code" class="form-control package_code" required>
                                          ...
                                          <select name="continent[0]" id="package_continent" class="form-control package_continent">
                                           <option value="">--Select Continent--</option>
                                            ...
                                            <?php $__currentLoopData = $continents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cont): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                              <option value="<?php echo e($cont->id); ?>"><?php echo e($cont->continent_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                          </select>
                                        </div>
                                      </div>
                            ...
                            <div class="item-container">
                              <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <option value="<?php echo e($suppliers->id); ?>" ><?php echo e($suppliers->suppliercompanyname); ?></option>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                </select>
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="supplier_remarks" placeholder="Supplier Remarks"><?php echo e(old('supplier_remarks')); ?></textarea>
                                  </div>
                                </div>
                              </div>
                            </div>
