...
<style>
  ...
  <div class="add">
    <a href="<?php echo e(URL::to('/query')); ?>" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left"> </i> Back</a>
    </div>
  ...
  <div class="box-body">
  <!---->
  <form action="<?php echo e(URL::to('/saveQuery1')); ?>" method="Post" id="enquiry_form" name="enquiry_form">
...
<select class="form-control" name="packageId">
  <?php $__currentLoopData = $package_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $packages): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
<span class="error" id="name_error"><?php echo e($errors->first("name")); ?></span>
</div>
...
<span class="error" id="mobile_error"><?php echo e($errors->first("mobile")); ?></span>
</div>
...
<span class="error" id="email_error"><?php echo e($errors->first("email")); ?></span>
...
<span class="error" id="city_of_residence_error"><?php echo e($errors->first("city_of_residence")); ?></span>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
...
<span class="error" id="destinations_error"><?php echo e($errors->first("destinations")); ?></span>
</div>
</div>
<div class="col-md-6">
...
<div class="col-md-12">
 ...
 <p class="error" id="accept_value_error"><?php echo e($errors->first("accept_value")); ?></p>
