            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box autoScroll">
                        ...
                        <!-- search lead form -->
                        <?php echo $__env->make('query.search_lead_form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dashboard-inner-table">
                                                            ...
                                                            <p class="q-dtls"><?php echo e($query->enquiry_ref_no ?? 'No enquiry id available.'); ?></p>
                                                        ...
                                                        <div class="dashboard-inner-table">
                                                            ...
                                                            <p class="q-dtls"><?php echo e($query->quo_ref ?? 'No quote id available.'); ?></p>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="dashboard-inner-table">
                                                            ...
                                                            <?php if($loged_user->lock_before_quote_send == ''): ?>
                                                                <?php if(isset($query->mobile) && $query->mobile != ""): ?>
                                                                    <p class="q-dtls"><?php echo e($query->mobile); ?></p>
                                                                <?php endif; ?>
                                                                <p class="q-dtls"><?php echo e($query->email ?? 'N/A'); ?></p>
                                                            <?php else: ?>
                                                                <?php if(isset($query->mobile) && $query->mobile != ""): ?>
                                                                    <p class="q-dtls"><?php echo e(CustomHelpers::mask_mobile_no($query->mobile)); ?></p>
                                                                <?php endif; ?>
                                                                <p class="q-dtls"><?php echo e(CustomHelpers::partiallyHideEmail($query->email ?? 'N/A')); ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="dashboard-inner-table">
                                                            ...
                                                            <!-- travel date -->
                                                            <p class="q-dtls">
                                                                <?php if(isset($query->date_arrival) && $query->date_arrival != ""): ?>
                                                                    <?php
                                                            ...
                                                            <p class="q-dtls">
                                                                ...
                                                                ?>
                                                                <?php if($adult != 0): ?>
                                                                    <?php  $adultText = $adult == 1 ? 'Adult' : 'Adults';  ?>
                                                                    <?php echo e($adult); ?> <?php echo e($adultText); ?>

                                                                <?php endif; ?>
                                                                <?php if($child_with_bed != 0): ?>
                                                                    <?php  $childWithBedText = $child_with_bed == 1 ? 'Child (with bed)' : 'Children (with bed)';  ?>
                                                                    + <?php echo e($child_with_bed); ?> <?php echo e($childWithBedText); ?>

                                                                <?php endif; ?>
                                                                <?php if($child_without_bed != 0): ?>
                                                                    <?php  $childWithoutBedText = $child_without_bed == 1 ? 'Child (without bed)' : 'Children (without bed)';  ?>
                                                                    + <?php echo e($child_without_bed); ?> <?php echo e($childWithoutBedText); ?>

                                                                <?php endif; ?>
                                                                <?php if($infant != 0): ?>
                                                                    <?php  $infantText = $infant == 1 ? 'Infant' : 'Infants';  ?>
                                                                    + <?php echo e($infant); ?> <?php echo e($infantText); ?>

                                                                <?php endif; ?>
                                                                <?php if($adult == 0 && $child_with_bed == 0 && $child_without_bed == 0 && $infant == 0): ?>
                                                                    No guests specified
                                                                <?php endif; ?>
                                                            </p>

                                                            <!-- nationality -->
                                                            <p class="q-dtls"><?php echo e($query->nationality ?? 'N/A'); ?></p>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="dashboard-inner-table">
                                                            ...
                                                            <?php if(is_numeric((int) $query->query_reference)): ?>
                                                                ...
                                                                <?php endif; ?>
                                                            <?php else: ?>
                                                                <p class="q-dtls"><?php echo e($query->destinations ?? 'No destinations available.'); ?></p>
                                                            <?php endif; ?>
                                                            ...
                                                            <?php if(is_numeric((int) CustomHelpers::get_query_field((int)$query->query_reference, 'packageId'))): ?>
                                                                ...
                                                                <?php endif; ?>
                                                            <?php else: ?>
                                                                <p class="q-dtls"><?php echo e($query->packageId ?? 'N/A'); ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="dashboard-inner-table">
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <p class="q-user-name" value="<?php echo e(CustomHelpers::get_query_field($query->query_reference, 'status')); ?>"><?php echo e(CustomHelpers::get_query_field($query->query_reference, 'status') ?? 'N/A'); ?></p>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <div class="dashboard-inner-table">
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr class="makeflex">
                                                                        <td class="flexOne">
                                                                            <?php if(($query->send_option ?? '0') == '0' && ($query->accept_status ?? '0') == '0'): ?>
                                                                                <p class="q-sendbox">Not Sent</p>
                                                                            <?php elseif(($query->send_option ?? '0') == '1' && ($query->accept_status ?? '0') == '0'): ?>
                                                                                <p class="q-noresponsebox">No Response</p>
                                                                            <?php elseif(($query->send_option ?? '0') == '1' && ($query->accept_status ?? '0') == '1'): ?>
                                                                                <p class="q-acceptancebox">Quote Accepted</p>
                                                                            <?php elseif(($query->send_option ?? '0') == '0' && ($query->accept_status ?? '0') == '1'): ?>
                                                                                <p class="q-acceptancebox">Quote Accepted</p>
                                                                            <?php elseif(($query->send_option ?? '0') == '1' && ($query->accept_status ?? '0') == '2'): ?>
                                                                                <p class="q-rejectionbox">Quote Rejected</p>
                                                                            <?php elseif(($query->send_option ?? '0') == '0' && ($query->accept_status ?? '0') == '2'): ?>
                                                                                <p class="q-rejectionbox">Quote Rejected</p>
                                                                            <?php endif; ?>
                                                                        </td>
                                                                        <td class="flexOne">
                                                                            <?php if(($query->quote_view ?? '0') == '0'): ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if(count($check_raise_concern) > 0): ?>
                                                            <button class="btn-q <?php echo e($btn_class); ?> view_raise raise_btn_class<?php echo e((int)$query->query_reference); ?>" data-id="<?php echo e((int)$query->query_reference); ?>">
                                                                <?php echo e($btn_name); ?>
                                                        ...
                                                        <div class="dashboard-inner-table">
                                                            ...
                                                            ?>
                                                            <p class="q-dtls textCenter"><?php echo e($lead_date_time); ?>, (<?php echo e(date('D', strtotime($query->created_at ?? now()))); ?>)</p>
                                                        </div>
                                                        ...
                                                        <div class="dashboard-inner-table">
                                                            ...
                                                            ?>
                                                            <p class="q-dtls textCenter"><?php echo e($last_updated_at); ?>, (<?php echo e(date('D', strtotime($query->created_at ?? now()))); ?>)</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
