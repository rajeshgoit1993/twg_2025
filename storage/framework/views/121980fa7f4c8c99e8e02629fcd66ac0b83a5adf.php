          ...
          <div class="box-body">
            ...
            <div class="well">
              <div class="modal-body">
                <form action="<?php echo e(URL::to('/store_packagehotel')); ?>" method="post" enctype="multipart/form-data" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <!-- <input type="text" class="form-control" id="location" name="location" value="<?php echo e(old('location')); ?>" placeholder="Select City Name" required> -->
                      </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hotelname" name="hotelname" value="<?php echo e(old('hotelname')); ?>" placeholder="Enter Property Name" required>
                      </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="hotel_image" name="hotel_image" value="<?php echo e(old('hotel_image')); ?>" accept=".jpg, .jpeg, .webp">
                      </div>
                      <span class="error"><?php echo e($errors->first("rate")); ?></span>
                    </div>
