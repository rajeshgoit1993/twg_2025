						    ...
						    <div class="dTourImgBoxTwo">
						        <?php 
						            ...
						            foreach ($images as $img) {
						                $imageMain = CustomHelpers::get_image_gallery($img->gallery_id, 'image_main');
						                if ($imageMain !== "0") {
						                    $lastValidImage = $imageMain;
						                }
						            }
						         ?>

						        <!-- <img src="<?php echo e($lastValidImage ?? asset('default-image-path.jpg')); ?>" alt="tourimg-two"> -->
						        
						        <?php if($lastValidImage): ?>
						            <img src="<?php echo e($lastValidImage); ?>" alt="tourimg">
						        <?php else: ?>
						            <!-- <img src="<?php echo e(URL::to('/public/Uploads/default_profile_image.png')); ?>" alt="noimage"> -->
						            <img src="" alt="noimage">
						        <?php endif; ?>
