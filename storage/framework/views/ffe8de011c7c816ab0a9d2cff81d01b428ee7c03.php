		    ...
		    <?php $__currentLoopData = $destination_theme_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row => $col): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
		        ...
		        <div class="mThemeContnt">
		            <div class="mThemeDestCont">
		                <h2 class="mThemeDestTtl"><?php echo e($col["destination"]); ?> <?php echo e($theme_name); ?> Packages</h2>
		                            ...
		                            <a href="<?php echo e(url('/Holidays/' . str_slug($package->title) . '?package_id=' . CustomHelpers::custom_encrypt($package->id))); ?>">
		                                <div class="mTourTopSection">
		                                    ...
		                                    <div class="mTourPrcBox">
		                                        ...
		                                        <?php elseif($package->onrequest != 1 && $package->upcoming == 1): ?>
		                                            ...
		                                            <?php else: ?>
		                                                <div class="mTourPrcValueBox">
		                                                    <p class="mTourPrcValue"><span class="mTourDefaultCurency">&nbsp;</span><?php echo e(CustomHelpers::get_price($package->id)); ?></p>
		                                                    <p class="mTourPrcTyp"><?php echo e($package->Price_type); ?></p>
		                                                </div>
		                                            <?php endif; ?>
		                                        <?php elseif($package->onrequest == 1 && $package->upcoming != 1): ?>
		                                            ...
		                                            <?php else: ?>
		                                                <div class="mTourPrcValueBox">
		                                                    <p class="mTourPrcValue"><span class="mTourDefaultCurency">&nbsp;</span><?php echo e(CustomHelpers::get_up_price($package->id)); ?></p>
		                                                    <p class="mTourPrcTyp"><?php echo e($package->upcoming_type); ?></p>
		                                                </div>
		                                            <?php endif; ?>
		                                        <?php endif; ?>
		                                    </div>
		                                ...
		                                <div class="mTourBtmSection">
		                                    ...
		                                    <div>
		                                        ...
		                                        <div class="mTourDuration"><?php echo e($package->duration); ?> Nights</div>
		                                    </div>
		                                </div>
		                            </a>
		                        </div>
