				...
				<tr>
					<td class="text" colspan="2">
						...
						<div class="mobile_font">
							<i>Discount(-) : <b>Rs. <?php CustomHelpers::get_indian_currency(round($price_data_first['query_total_discount_group']/($data->adult+$data->extra_adult+$data->child_with_bed+$data->child_without_bed+$data->infant+$data->solo_traveller))); ?></b></i>
						</div>
