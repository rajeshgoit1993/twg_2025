                  ...
                  <div class="box">
                    ...
                    <div class="box-body">
                      <table id="example1" class="table table-bordered table-striped example1">
                        ...
                        <tbody>
                          <?php $__currentLoopData = $payathotelpaymenttype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$paytype): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                          <tr id="editpaytype_<?php echo e($paytype->id); ?>">
                            <!-- <td><input class="checkboxcls" value="3" type="checkbox"></td> -->
                            <td class="center"><?php echo e(++$key); ?></td>
                            <td class="typename"><?php echo e($paytype->name); ?></td>
                            <td class="typestatus center">
                              <?php if($paytype->status == 1): ?>
                              <button class="btn btn-sm btn-success no-event">Enabled</button>
                              <?php else: ?>
                              <button class="btn btn-sm btn-danger no-event">Disabled</button>
                              <?php endif; ?>
                              <input type="hidden" name="status" value="<?php echo e($paytype->status); ?>">
                            </td>
                            <td>
                              <form action="<?php echo e(URL::to('/deletePayHotelPayment')); ?>" method="post" id="deletePayHotelPayment<?php echo e($paytype->id); ?>">
                                <?php echo e(csrf_field()); ?>

                                <input type="hidden" name="id" value="<?php echo e($paytype->id); ?>" />
                                <a class="editPaymentTypeModel" data-id="<?php echo e($paytype->id); ?>" data-toggle="modal" data-target="#editPaymentTypeModel" href="#"><span class="btn btn-sm btn-warning">Edit</span></a>
                                <a href="#" data-id="<?php echo e($paytype->id); ?>" class="deletePaymentType"><span class="btn btn-sm btn-danger">Delete</span></a>
                              </form>
                            </td>
                          </tr>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
...
<?php if(is_numeric($tour->location)): ?>
<input type="hidden" class="typelocation_id" value="<?php echo e($tour->location); ?>">
<input type="hidden" class="typelocation_name" value="<?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)$tour->location, 'name')); ?>">
<?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)$tour->location, 'name')); ?>

<?php else: ?>
<input type="hidden" class="typelocation_id" name="<?php echo e($tour->location); ?>">
<input type="hidden" class="typelocation_name" name="<?php echo e($tour->location); ?>">
<?php echo e($tour->location); ?> (old)
<?php endif; ?>
                              </td>
                            <td class="typedesc">
                      ...
                      <table id="example1" class="table table-bordered table-striped example1">
                        ...
                        <tbody>
                          ...
                          <tr id="editact_<?php echo e($activity->id); ?>">
                            ...
                            <td class="typelocation">
<?php if(is_numeric($activity->location)): ?>
<input type="hidden" class="typelocation_id" value="<?php echo e($activity->location); ?>">
<input type="hidden" class="typelocation_name" value="<?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)$activity->location, 'name')); ?>">
<?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)$activity->location, 'name')); ?>

<?php else: ?>
<input type="hidden" class="typelocation_id" name="<?php echo e($activity->location); ?>">
<input type="hidden" class="typelocation_name" name="<?php echo e($activity->location); ?>">
<?php echo e($activity->location); ?> (old)
<?php endif; ?>
</td>
                            <td class="typedesc">
