			...
			<div class="lead-modalbody">
				...
				<div class="form-group fullWidth">
					...
					<div class="makeflex">
						...
						?>
						<input type="datetime-local" id="meeting-time" value="<?php echo e($date_time); ?>" min="<?php echo e($date_time); ?>" class="lead-input-text fullWidth" id="follow_up_date_time" name="follow_up_date" style="border-radius: 4px 0px 0px 4px;" required/>
