				...
				<!--<div class="flexCenter" style="margin: 20px 0;display: none">
					<span><a href="<?php echo e(url('/')); ?>">Home<span class="rightArrow"></span></a></span>
					<span><a href="<?php echo e(URL::previous()); ?>">Holidays<span class="rightArrow"></span></a></span>
					<span class="active fontSize16 lineHeight18 fontWeight600"><?php echo e($details->title); ?></span>
				</div>-->
				<!--breadcrumbs ends-->
				<!--Tour Name-->
				<div class="dTourNameCont">
					<div class="dTourNameWrapper">
						...
						<!-- Star Rating -->
						<?php if(!empty($details->select_star_rating)): ?>
					...
					<div class="dTourDescCont">
						<!-- duration -->
						<div class="dTourDuration"><?php echo e($details->duration); ?>N / <?php echo e($details->duration + 1); ?>D</div>

						<!-- tour type -->
						<div class="dHolidayType">
						    <?php echo e(in_array($details->tour_type, [null, 2]) ? 'Customized Tour' : 
