            ...
            <div class="mTourHgLhts">
              ...
              <?php $__currentLoopData = $city_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                ...
                <div class="collapsible-container">
                  <div class="collapsible-item mItem-box mItem-arrow"><span class="glyphicon glyphicon-map-marker" style="color: #da2128;"></span>&nbsp;<?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)$data, 'name')); ?>,&nbsp;<?php echo e(CustomHelpers::get_master_table_data('countries', 'id', (int)CustomHelpers::get_destination_data($data,'country'), 'name')); ?></div>
                  <!--Collapsible Content-->
