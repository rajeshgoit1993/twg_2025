				<div class="tab">
					...
					<div class="sub-nav-item-content">
						<div class="sub-tab active">
							<!-- <form action="<?php echo e(URL::to('/packages_list')); ?>" method="post" autocomplete="off" name="search2" id="search2" > -->
							<form action="<?php echo e(route('productList')); ?>" method="post" autocomplete="off" name="search2" id="search2" >
									...
									<div class="dHldyPanelBox">
										...
										<div class="dSvcPanel_inputbox_date flexOne">
											<label for="datepicker_holiday" class="">
												...
												<input type="text" id="datepicker_holiday" name="datepicker" value="<?php echo e(date('d M y', strtotime('+2 months'))); ?>" placeholder="Select Date" />
