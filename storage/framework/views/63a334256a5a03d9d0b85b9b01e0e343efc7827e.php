					...
					<div class="mTourDtlsCont">
						...
						<div class="mTourDuration"><?php echo e($details->duration); ?>N&nbsp;/&nbsp;<?php echo e($details->duration + 1); ?>D</div>
						...
						<div class="mSelectDateCont">
							<div class="mSearchInput_box mobscroll">
								<div class="mSearchInput_city"><?php echo e($details->sourcecity == null ? 'JoiningDirect' : $details->sourcecity); ?></div>
							        ...
							        <?php for($i = 0; $i < $count_package_service; $i++): ?>
							            <?php if(in_array($package_service[$i], $ico1)): ?>
							                ...
							                <div class="mTourSvcItemIconBox">
							                    ...
							                    <div class="mTourSvcItemIconName"><?php echo e($iconTitle ?: 'no-title'); ?></div>
							                </div>
							            <?php endif; ?>
							        <?php endfor; ?>
							    <?php endif; ?>
