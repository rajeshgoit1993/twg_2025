				...
				<div class="contents" id="services_type_content_<?php echo e($service_type_data->id); ?>">
						...
						<div>
							<select class="lead-input-text fullWidth" id="lead_current_status" name="services_status[<?php echo e($service_type_data->id); ?>][status]">
								<?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $services): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
									<option value="<?php echo e($services->id); ?>"><?php echo e($services->field_name); ?></option>
					...
					<div class="service_category_dtls_part form-group fullWidth">
						...
						<div>
							<input type="text" class="lead-input-text fullWidth" id="supplier_reference_no" name="services_status[<?php echo e($service_type_data->id); ?>][supplier_reference_no]" placeholder="Enter Supplier Reference No" />
						</div>
					</div>
					...
					<div class="service_category_dtls_part form-group fullWidth">
						...
						<div class="makeflex">
							<input type="date" name="services_status[<?php echo e($service_type_data->id); ?>][date]" class="lead-input-text fullWidth" id="service_cancellation_deadline" style="border-radius: 4px 0px 0px 4px; border-right: none;" />
							<input type="time" name="services_status[<?php echo e($service_type_data->id); ?>][time]" class="lead-input-text fullWidth" id="service_cancellation_deadline" style="border-radius: 0px 4px 4px 0px;flex-basis: 70%;" />
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<span class="add_content" style="display: none;">
						<textarea class="lead-input-text-area fullWidth" type="text" name="services_status[<?php echo e($service_type_data->id); ?>][user_remarks]" style="" placeholder="Remarks"></textarea>
					</span>
				</div>
				</div>