								...
								<td>
									...
									<!-- <td>
										...
										<?php if(CustomHelpers::get_query_field((int)$query->query_reference,'packageId')!="N" && CustomHelpers::get_query_field((int)$query->query_reference,'packageId')!="" && is_numeric((int)CustomHelpers::get_query_field((int)$query->query_reference,'packageId'))): ?>
											...
											<p class="pfwmt text-capitalize lineHeight15 padding-top10"><a href="<?php echo e(url('/Holidays/'.str_slug($query->package_name).'?package_id='.CustomHelpers::custom_encrypt((int)CustomHelpers::get_query_field($query->query_reference,'packageId')))); ?>" target="_blank">
