                    ...
                    <div class="box-body">
                         ...
                         <div id="dGalleryTopBarCont">
                              <div class="makeflex align-center">
                                   <div>
                                        <a href="<?php echo e(URL::to('/packagehotel_image_location/'.Request::segment(2))); ?>" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left"></i> Back</a>
                                   </div>

                                   <!-- package_hotel -> packagehotel_image_gallery -->
                                   <div class="box-header">
                                        <h3 class="box-title">Add Photos from gallery <span class="font14">
                                             (Images from
...
<?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)$city, 'name')); ?>
                         ...
                         <div class="dImgSelectionCont">
                              ...
                              <form action="<?php echo e(URL::to('/packagehotel_image_save/'.Request::segment(2))); ?>" method="post">
                                        ...
                                        <div class="col-md-3" style="margin-bottom: 20px">
                                             <div class="dImgCardCont">
                                                  ...
                                                  <label class="labelGallery">
                                                       <input type="checkbox" name="image_from_gallery[]" value="<?php echo e($datavalue->id); ?>" <?php if(CustomHelpers::get_data_condition1($datavalue->id, Request::segment(2)) == "1"): ?> checked <?php endif; ?>>
