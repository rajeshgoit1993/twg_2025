									...
									<!-- <div class="">
										<div class="col-md-12">
											<div class="mAcceptTerms">
												...
												<span class="mAcceptTermsStatement">I here by accept the <a href="<?php echo e(URL::to('/Privacy-Policy')); ?>" target="_blank">
												<span class="color008 fontWeight600">Privacy Policy</span></a> and authorize <?php if(env("WEBSITENAME")==1): ?>The World Gateway <?php elseif(env("WEBSITENAME")==0): ?>Rapidex Travels <?php endif; ?> team to contact me.</span>
											</div>
