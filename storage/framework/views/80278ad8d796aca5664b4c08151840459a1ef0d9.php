                ...
                <div class="box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="supplier_email" class="form-control" name="supplier_email">
                                    ...
                                    <?php if(!empty($email_s)): ?>
                                        <?php $__currentLoopData = $email_s; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row makeflex aligncenter form-group">
                            <div class="col-md-6">
                            	<a href="<?php echo e(route('supplierEmailCompose')); ?>">
...
var getSupplierEmailURL = `<?php echo route('get_supplier_email_list_non_lead'); ?>`;
