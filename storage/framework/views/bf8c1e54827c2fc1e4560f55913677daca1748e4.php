...
<section>
	...
	<?php else: ?>
		...
		<input type="hidden" id="given_year" name="" value="<?php echo e(date('Y')); ?>">
		<input type="hidden" id="given_month" name="" value="<?php echo e(date('m')); ?>">
		<input type="hidden" id="given_date" name="" value="<?php echo e(date('d')); ?>">
