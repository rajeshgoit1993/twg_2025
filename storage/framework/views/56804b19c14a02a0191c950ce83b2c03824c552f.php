                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo e(URL::to('packagehotel_image_location/'.Request::segment(2))); ?>">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tr id="tr_<?php echo e($image->id); ?>">
                                ...
                                <td>
                                    ...
                                    <span class="" id="">
                                    <?php echo e(CustomHelpers::get_master_table_data('countries', 'id', (int)CustomHelpers::get_imgpath_gallery($image->gallery_id,'country'), 'name')); ?>
                                ...
                                <td>
                                    ...
                                    <span class="" id="">
                                    <?php echo e(CustomHelpers::get_master_table_data('states', 'id', (int)CustomHelpers::get_imgpath_gallery($image->gallery_id,'state'), 'name')); ?>
                                ...
                                <td>
                                    ...
                                    <span class="" id="">
                                    <?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)CustomHelpers::get_imgpath_gallery($image->gallery_id,'city'), 'name')); ?>
