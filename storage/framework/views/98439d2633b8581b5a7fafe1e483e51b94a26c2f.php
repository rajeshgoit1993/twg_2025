				    ...
				    <div class="modal-dialog">
				    	...
				    	<div class="login-modal-content">
					        ...
					        <div class="login-modal-body">
								<form action="<?php echo e(route('guestlogin')); ?>" method="post" id="login_customer" name="login_customer">
									...
									<div class="user-login-field">
										...
										<div class="user-input-group innerField">
											...
											<input type="email" id="login_email" name="email" value="<?php echo e(old('email')); ?>" autocomplete="off" placeholder="Enter email id" />
										</div>
									...
									<div class="btn-login-cont">
										<input type="hidden" name="currentURL" value="<?php echo e(url()->current()); ?>">
								...
								<div class="social-media-cont">
									<!-- <a href="<?php echo e(url('/login_with_google')); ?>" class="login-googleplus"> -->
									<a href="<?php echo e(route('loginViaGoogle')); ?>" class="login-googleplus">
								...
								<div class="login-footer-cont">
									<!-- <p>By proceeding, you agree to 
										<?php if(env("WEBSITENAME")==1): ?>The World Gateway's <?php elseif(env("WEBSITENAME")==0): ?> Rapidex Travels's <?php endif; ?> <a href="<?php echo e(route('privacyPolicy')); ?>" class="link-color" target="_blank">Privacy Policy</a> and <a href="<?php echo e(route('userAgreement')); ?>" class="link-color" target="_blank">User Agreement</a>
									</p> -->
									<?php 
										$websiteData = getWebsiteData();
									 ?>
									<p>By proceeding, you agree to <?php echo e(getWebsiteData('name')); ?> 
										<a href="<?php echo e(route('privacyPolicy')); ?>" class="link-color" target="_blank">Privacy Policy</a> and 
										<a href="<?php echo e(route('userAgreement')); ?>" class="link-color" target="_blank">User Agreement</a>
									</p>
								</div>
				...
				<div class="guest-login-modal fade" id="otp_login_modal" role="dialog">
				    <div class="modal-dialog">
					    ...
					    <div class="login-modal-content">
					        ...
					        <div class="login-modal-body">
								<!-- <form action="<?php echo e(URL::to('/login-customer')); ?>" method="post" id="login_customer" name="login_customer"> -->
								<form action="<?php echo e(route('guestlogin')); ?>" method="post" id="login_customer" name="login_customer">
									<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
									...
									<div class="user-login-field">
										...
										<div class="user-input-group innerField-enter-otp">
											<input type="text" name="login_otp_value" id="login_otp_value" autocomplete="off" value="<?php echo e(old('email')); ?>" maxlength="5" placeholder="Enter OTP here" style="width: 75%" required />
											<!-- OTP timer & Resend -->
					        	...
					        	<form action="#" method="post" id="forget_password_form" name="forget_password_form">
									...
									<div class="user-login-field">
										...
										<div class="user-input-group innerField-pwd-reset">
											...
											<input type="email" id="email-pwd-reset" name="email" value="<?php echo e(old('email')); ?>" placeholder="Enter email id registered with us" required />
										</div>
										<div class="flexCenter">
					    ...
					    <div class="login-modal-content">
					        ...
					        <div class="login-modal-body">
								...
								<form id="register-customer" name="register-customer" method="post">
									...
									<div class="user-login-field">
										...
										<div class="user-input-group innerField-signup-firstName">
											<input type="text" name="first_name" id="firstName" autocomplete="off" value="<?php echo e(old('first_name')); ?>" placeholder="Enter first name" />
										</div>
									...
									<div class="user-login-field">
										...
										<div class="user-input-group innerField-signup-lastName">
											<input type="text" name="last_name" id="last_name" autocomplete="off" value="<?php echo e(old('last_name')); ?>" placeholder="Enter last name" />
										</div>
									...
									<div class="user-login-field">
										...
										<div class="user-input-group innerField-signup">
											...
											<input type="email" name="email" id="signupEmail" value="<?php echo e(old('email')); ?>" autocomplete="off" placeholder="Enter email id" />
										</div>
									...
									<div class="acceptance-cont">
										...
										<!-- <p><?php if(env("WEBSITENAME")==1): ?>Subscribe for latest promotions and offers <?php elseif(env("WEBSITENAME")==0): ?>Subscribe for latest promotions and offers <?php endif; ?></p> -->
									...
									<div class="acceptance-cont">
										...
										<!-- <p>By signing up, you agree to <?php if(env("WEBSITENAME")==1): ?> The World Gateway's <?php elseif(env("WEBSITENAME")==0): ?> Rapidex Travels's <?php endif; ?> <a href="<?php echo e(URL::to('/Privacy-Policy')); ?>" class="link-color" target="_blank">Privacy Policy</a> and <a href="<?php echo e(URL::to('/User-Agreement')); ?>" class="link-color" target="_blank">User Agreement</a></p> 
										-->
										<p>By signing up, you agree to <?php echo e(getWebsiteData('name')); ?> 
											<a href="<?php echo e(route('privacyPolicy')); ?>" class="link-color" target="_blank">Privacy Policy</a> and 
											<a href="<?php echo e(route('userAgreement')); ?>" class="link-color" target="_blank">User Agreement</a>
										</p>
									</div>
								...
								<div class="existing-user-cont">
									<!-- <p>Already a <?php if(env("WEBSITENAME")==1): ?> The World Gateway <?php elseif(env("WEBSITENAME")==0): ?> Rapidex Travels <?php endif; ?> member? 
										<a href="#user-login" class="link-color" data-dismiss="modal" data-toggle="modal">Login</a>
									</p> -->
									<p>Already a <?php echo e(getWebsiteData('name')); ?> member? 
										<a href="#user-login" class="link-color" data-dismiss="modal" data-toggle="modal">Login</a>
									</p>
								</div>
					        </div>
				...
				<!--Processing Modal-->
				<?php echo $__env->make('home.profile_pages.processing', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
