									...
									<div class="dTourHgLhts">
										...
										<div class="makeflex mobscroll scrollX">
											<div class="dSimilarTourCont">
												<a href="<?php echo e(url('/Holidays/'.str_slug($package->title).'?package_id='.CustomHelpers::custom_encrypt($package->id))); ?>" class="pkg_search" target="_blank">
													<div class="dSimilarItemCont">
														...
														<div class="dSimilarItemDesc">
															<div class="dSimilarItemDaysBadge"><?php echo e($package->duration); ?>N / <?php echo e($package->duration + 1); ?>D</div>
															<div class="dSimilarItemDescHeadSection">
																<div class="dSimilarItemDescHeadingBox">
																	<h3 class="dSimilarItemDescHeading"><?php echo e($package->title); ?></h3>
																</div>
															</div>
															...
															<div class="dSimilarItemFooter">
																		...
																		<?php else: ?>
																			...
																			<?php for($i=0;$i<$count_package_service;$i++): ?> 
																				...
																				<div class="ditemSvcCont">
																					...
																					<div class="ditemSvcIconName"><?php echo e(CustomHelpers::getimagename($package_service[$i],'rt_icons','icon_title')); ?></div>
																				</div>
																				<?php else: ?>
																				<?php endif; ?>
																			<?php endfor; ?>
																...
																<div class="dSimilarItemDescPriceSection">
																	...
																	<?php elseif($package->onrequest != 1 && $package->upcoming == 1): ?>
																		<?php if(CustomHelpers::get_price($package->id)=="On Request"): ?>
																			<span class="priceRequest"><span class="defaultCurrency dTourSimilarCurrency">&nbsp;</span>On Request</span>
																		<?php else: ?>
																			<span class="priceValue"><span class="defaultCurrency dTourSimilarCurrency">&nbsp;</span><?php echo e(CustomHelpers::get_price($package->id)); ?></span>
																	...
																	<?php elseif($package->onrequest == 1 && $package->upcoming != 1): ?>
																		<?php if(CustomHelpers::get_up_price($package->id)=="On Request"): ?>
																			<span class="priceRequest"><span class="defaultCurrency dTourSimilarCurrency">&nbsp;</span>On Request</span>
																		<?php else: ?>
																			<span class="priceValue"><span class="defaultCurrency dTourSimilarCurrency">&nbsp;</span><?php echo e(CustomHelpers::get_up_price($package->id)); ?></span>
																...
																<!--<div class="dStarRating_wrapper" style="display: none;">
																	...
																	<div class="dStar_rating">
																		<?php if($customer_rating=="3.5"): ?>
																		<?php for($i=1;$i<=$customer_rating;$i++): ?>
																		...
																		<?php elseif($customer_rating=="4.5"): ?>
																		<?php for($i=1;$i<=$customer_rating;$i++): ?>
																			<img src="<?php echo e(url('/public/uploads/icons/star1.png')); ?>" title="<?php echo e($customer_rating); ?> Star">
																		<?php endfor; ?>
																			<img src="<?php echo e(url('/public/uploads/icons/halfstar.png')); ?>" title="<?php echo e($customer_rating); ?> Star">
																		...
																		<?php for($i=1;$i<=$customer_rating;$i++): ?>
																			<img src="<?php echo e(url('/public/uploads/icons/star1.png')); ?>" title="<?php echo e($customer_rating); ?> Star">
																		<?php endfor; ?>
																		<?php for($j=5;$j>$customer_rating;$j--): ?>
																			<img src="<?php echo e(url('/public/uploads/icons/star2.png')); ?>" title="<?php echo e($customer_rating); ?> Star">
																		<?php endfor; ?>
																		<?php endif; ?>
																	</div>
