              ...
              <div class="mTourPkgDesc">
                <?php if($details->flight!=''): ?>
                  ...
                  <?php if(array_key_exists('flightOption',$flight_data) 
                          ...
                          <div class="flexCenter appendBottom5">
                            ...
                            <div class="appendRight20">
                              <!-- <?php if(array_key_exists('origin',$flight_detail) && $flight_detail['origin']==0): ?> 
                                <span class="mFlightCityName"><?php echo e($flight_detail['origin']); ?></span>
                              <?php endif; ?>
                                <span class="mFlightCityName">-</span> 
                              <?php if($flight_detail['dest']!=""): ?>
                                <span class="mFlightCityName"><?php echo e($flight_detail['dest']); ?></span>
                              <?php endif; ?> -->
                              <?php if(array_key_exists('origin',$flight_detail) && $flight_detail['origin']==0): ?>
                            ...
                            <?php if(array_key_exists('onwarddate',$flight_detail)): ?> 
                              <?php if($flight_detail['onwarddate']!=""): ?>
                                ...
                                ?>
                                <span class="mFlightDate"><?php echo e(date('D', strtotime($originalDate_flight))); ?>, <?php echo e($newDate_flight); ?></span> -->
                                <span class="mflightDate"><?php echo e(date('d M Y', strtotime($originalDate_flight))); ?></span>
                                <?php endif; ?> 
                              <?php endif; ?>
                            </div>
                          </div>
                          ...
                          <div class="flexCenter">
                            ...
                            <div class="mFlightDurationCont">
                              <div class="mFlightDuration">
                                <!-- <?php if(array_key_exists('duration_hours',$flight_detail)): ?> 
                                  <?php echo e($flight_detail['duration_hours']); ?>h 
                                <?php endif; ?>
                                <?php if(array_key_exists('duration_dmins',$flight_detail)): ?>
                                  <?php echo e($flight_detail['duration_dmins']); ?>m 
                                <?php endif; ?> -->
                          ...
                          <div class="mReturnFlightBox">
                            ...
                            <div class="flexCenter appendBottom5">
                              <div class="appendRight20">
                                <!-- <?php if($flight_detail['dOrigin']!=""): ?>
                                  <span class="mFlightCityName"><?php echo e($flight_detail['dOrigin']); ?></span>
                                <?php endif; ?>
                                  <span class="mFlightCityName">-</span> 
                                <?php if($flight_detail['ddest']!=""): ?>
                                  <span class="mFlightCityName"><?php echo e($flight_detail['ddest']); ?></span>
                                <?php endif; ?> -->
                                <?php if($flight_detail['dOrigin']!=""): ?>
                                  <span class="mFlightCityName"><?php echo e(CustomHelpers::get_city_seperate_code($flight_detail['dOrigin'],'previous_data')); ?></span>
                                <?php endif; ?>
                                <span class="mFlightCityName">-</span>
                                <?php if($flight_detail['ddest']!=""): ?>
                                  <span class="mFlightCityName"><?php echo e(CustomHelpers::get_city_seperate_code($flight_detail['ddest'],'previous_data')); ?></span>
                                <?php endif; ?>
                              </div>
                              ...
                              <div>
                                <?php if(array_key_exists('downwarddate',$flight_detail)): ?> 
                                  ...
                                  ?>
                                  <span class="mFlightDate"><?php echo e(date('D', strtotime($originalDate_flight_down))); ?>, <?php echo e($newDate_flight_down); ?></span> -->
                                  <span class="mflightDate"><?php echo e(date('d M Y', strtotime($originalDate_flight_down))); ?></span>
                                  <?php endif; ?> 
                                <?php endif; ?>
                              </div>
                            </div>
                            ...
                            <div class="flexCenter">
                              <div class="mAirlineDtls">
                                ...
                                <div class="mFlightNumber">
                                  <?php if(array_key_exists("dno", $flight_detail) && $flight_detail['dno']!=""): ?>
                            ...
                            <!--Baggage Info-->
                            <?php if((array_key_exists('baggage',$flight_detail) && $flight_detail['baggage']!='') || (array_key_exists('cbaggage',$flight_detail) && $flight_detail['cbaggage']!='')): ?>
                            <div class="mBaggageCont">
                              <div class="mFlightBaggageTitle">Baggage info</div>
                              <div class="flexCenter">
                                <!--Check-in Baggage Info-->
