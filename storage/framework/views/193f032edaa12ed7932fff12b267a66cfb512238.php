			...
			<div class="box">
				...
				<div class="box-body">
					...
					<?php if(Sentinel::check()): ?>
						...
						<div class="add">
							<a href="<?php echo e(URL::route('add_short_url')); ?>" class="btn btn-success"><i class="glyphicon glyphicon-plus-sign"></i> Add Short URLs</a>
						</div>
						<?php endif; ?>
					<?php endif; ?>
					<thead>
					...
					<?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); $__empty_1 = false; ?>
						<tr>
							...
							<td><?php echo e($single->url_domain); ?></td>

							<td><?php echo e($single->url_title); ?></td>

							<td>
								<?php echo e($single->long_url); ?>

							</td>

							<td>
								<?php if($single->url_domain=='rapidextravels'): ?>
									https://www.rapidextravels.com/<?php echo e($single->short_code); ?>

								<?php else: ?>
									https://www.theworldgateway.com/<?php echo e($single->short_code); ?>

								<?php endif; ?>
							</td>
							<td class="textCapitalize"><?php echo e($single->url_app); ?></td>

							<td class="textCapitalize"><?php echo e($single->url_device); ?></td>

							<td>
								<?php $hits=DB::table('short_urls_link_tracking')->where('short_url_id',$single->id)->get(); ?>
								<?php echo e(count($hits)); ?></td>

							<td><?php echo e($single->url_tags); ?></td>

							<td>
								<form action="<?php echo e(URL::to('/delete_short_url/'.$single->id)); ?>" onsubmit="return confirm('Are you sure you want to delte this?');" method="POST">
									...
									<?php if(Sentinel::getUser()->inRole('administrator') || Sentinel::getUser()->inRole('supervisor') || Sentinel::getUser()->inRole('super_admin')): ?>
										<a href="<?php echo e(URL::to('/edit_short_url/'.$single->id)); ?>">
