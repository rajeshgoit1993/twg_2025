                  ...
                  <div class="form-group">
                    <div class="dImgVdoCard">
                      ...
                      <div class="makeflex flex-wrap">
                        <div class="dImgVdoCardCntry flexOne"><?php echo e(CustomHelpers::get_master_table_data('countries', 'id', (int)$datavalue->country, 'name')); ?></div>
                        <div class="dImgVdoCardCity flexOne"><?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)$datavalue->city, 'name')); ?></div>
                      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-7 country_val">
              ...
              <select class="form-control country" name="country" >
                <option value="">Select Country</option>
                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cont): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                  <option value="<?php echo e($cont->id); ?>" c_id="<?php echo e($cont->id); ?>" ><?php echo e($cont->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
              </select>
            </div>
          </div>
