                  ...
                  <div class="row">
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" name="continent" id="continent">
                              ...
                              <?php $__currentLoopData = $continent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cont): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                  <option value="<?php echo e($cont->continent); ?>"><?php echo e($cont->continent_name); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                          </select>
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="country" id="country" onchange="get_states(this)">
                            ...
                            <?php $__currentLoopData = $country; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cont): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <option value="<?php echo e($cont->name); ?>" data-cid="<?php echo e($cont->id); ?>"><?php echo e($cont->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control ct_values" name="location" id="city">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" name="best_time_to_visit[]" id="best_time_to_visit" multiple>
                          ...
                          <option value="10">October</option> <!-- Fixed spelling from "Octuber" -->
