					        ...
					        <div class="drop">
					            <label class="dDropLabel">
					                <input 
					                    ...
					                    name="duration" 
					                    value="7" 
					                    <?php echo e($duration_data_less_than_7_nights->count() === 0 ? 'disabled' : ''); ?>>
					                <span class="dCheckMark"></span>
					                <div class="fullWidth flexBetween">
					                    <div>Less than 7 nights</div>
					                    <div>(<?php echo e($duration_data_less_than_7_nights->count()); ?>)</div>
					                </div>
					            </label>
					        </div>
					        <div class="drop">
					            <label class="dDropLabel">
					                <input 
					                    ...
					                    name="duration" 
					                    value="8" 
					                    <?php echo e($duration_data_between_8_and_12->count() === 0 ? 'disabled' : ''); ?>>
					                <span class="dCheckMark"></span>
					                <div class="fullWidth flexBetween">
					                    <div>8 to 12 nights</div>
					                    <div>(<?php echo e($duration_data_between_8_and_12->count()); ?>)</div>
					                </div>
					            </label>
					        </div>
					        <div class="drop">
					            <label class="dDropLabel">
					                <input 
					                    ...
					                    name="duration" 
					                    value="12" 
					                    <?php echo e($duration_data_greater_than_12->count() === 0 ? 'disabled' : ''); ?>>
					                <span class="dCheckMark"></span>
					                <div class="fullWidth flexBetween">
					                    <div>More than 12 nights</div>
					                    <div>(<?php echo e($duration_data_greater_than_12->count()); ?>)</div>
					                </div>
					            </label>
					        </div>
					    </div>
