			...
			<div class="get_update_price">
				...
				<?php if($new_price!='na'): ?>
					...
					<div class="dSideItemBoxTop flexCenter">
						<p class="dSlashedPrice defaultCurrency"><?php echo e($new_price['actual_price']); ?></p>
						<p class="dPriceTag"><span class="dActualPrice defaultCurrency"><?php echo e($new_price['discount_price']); ?></span> 
<?php echo e(PackagePriceHelpers::get_price_type($details->Price_type)); ?>
