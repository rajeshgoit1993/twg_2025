                        ...
                        <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <!-- <select id="package_country" class="form-control" name="choosecountry"> -->
                                        ...
                                        <?php $__currentLoopData = $pac_countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row => $col): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
function fetch_datas($statesave) {
    ...
    var country = $("#country").val();
    if (country == '') {
        country = 'NA'; // Set default value if no country is selected
    }

    var state = $("#state").val();
    if (state == '') {
        state = 'NA'; // Set default value if no state is selected
    }

    var city = $("#city").val();
    if (city == '') {
        city = 'NA'; // Set default value if no city is selected
    }
