	...
	<div class="row">
		<div class="col-md-5">
			<select id="addcountry" class="form-control addcountry" name="choosecountry">
				...
				<?php $__currentLoopData = $country_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $countries): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
				<option value="<?php echo e($countries->id); ?>"><?php echo e($countries->name); ?></option>
...
<section class="content" id="content">
	<div class="row">
		...
		<?php if(Sentinel::getUser()->inRole('administrator') || Sentinel::getUser()->inRole('supervisor') || Sentinel::getUser()->inRole('super_admin') ): ?>
			<a href="" class="btn btn-success appendRight20 add_state"><i class="glyphicon glyphicon-plus-sign"></i> Add New City</a>
...
$(document).on("click",".find_city",function(){
	...
	if(country=='' || state=='') {
		alert('Kindly Select Country & State both')
		}
	else {
		get_city_datable()
		}
...
$(document).on('click','.close',function(){
	...
	$(document).on('click',".add_state",function(e){
		...
		var state=$("#addstate").val()
		if(country=='' || state=='') {
			alert('Kindly Select Country & City Both')
			}
		else {
