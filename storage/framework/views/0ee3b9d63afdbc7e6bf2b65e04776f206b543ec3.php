  ...
  <section class="content">
    <div class="row">
      ...
      <div class="col-md-12">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <select class="form-control continent" name="continent" id="continent">
                                  ...
                                  <option value="<?php echo e($cont->id); ?>" <?php if($cont->id==$locData->continent): ?> selected <?php endif; ?>><?php echo e($cont->continent_name); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
        ...
        <option value="<?php echo e($country->id); ?>" <?php echo e($locData->country == $country->id ? 'selected' : ''); ?>>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>    
        ...
        <option value="<?php echo e($state->id); ?>" <?php echo e($locData->state == $state->id ? 'selected' : ''); ?>>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
        ...
        <option value="<?php echo e($city->id); ?>" <?php echo e($locData->location == $city->id ? 'selected' : ''); ?>>
