					...
					<div class="box-body">
						...
						<div class="well">
							<div class="modal-body">
								<form action="<?php echo e(route('updateTheme', $data_value->id)); ?>" method="POST">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<select class="form-control" name="theme_name">
													...
													<option value="<?php echo e($typ->name); ?>" <?php if($data_value->theme_name == $typ->name): ?> selected="selected" <?php endif; ?>><?php echo e($typ->name); ?></option>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="file" class="form-control" id="theme_image"  name="theme_image" value="<?php echo e($data_value->theme_image); ?>" accept=".jpg, .jpeg, .png, .webp">

												<img class="apndTop5 bdrRadius3" src="<?php echo e(URL::to('/').'/public/uploads/theme/'.$data_value->theme_image); ?>" width="100" height="50" loading="lazy">
												<input type="hidden" name="theme_image_value" value="<?php echo e($data_value->theme_image); ?>">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="theme_para1" class="form-control" placeholder="Enter Content 1" value="<?php echo e($data_value->theme_para1); ?>">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="theme_para2" class="form-control" placeholder="Enter Content 2" value="<?php echo e($data_value->theme_para2); ?>">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control ckeditor" rows="5" placeholder="Enter About Theme(Front End)" name="about_theme"><?php echo e($data_value->about_theme); ?></textarea>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" name="theme_title" class="form-control" placeholder="Enter Theme Title(SEO)" value="<?php echo e($data_value->title); ?>">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" name="theme_key" class="form-control" placeholder="Enter Theme Key(SEO)" value="<?php echo e($data_value->theme_key); ?>">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="theme_desc" placeholder="Enter Theme Description(SEO)" rows="4"><?php echo e($data_value->theme_desc); ?></textarea>
										...
										<div class="col-md-12">
											...
											<?php if($data_value->destination_theme_link!=''): ?>
											<?php
												$dynamic_details=unserialize($data_value->destination_theme_link);
												$a=0;
												$b=1;
											?>
											<?php $__currentLoopData = $dynamic_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows=>$col): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
												<?php if($b>1): ?>
													<div id="thirdrow<?php echo e($b); ?>">
														<div class="row">
															<div class="col-md-4">
																<div class="form-group">
																	<label for="" class="required">Destination</label>
																	<select class="select_theme_add_destination form-control" name="dynamic[<?php echo e($a); ?>][destination]" required>
																		<option value="<?php echo e($col['destination']); ?>" selected><?php echo e($col["destination"]); ?></option>
																	</select>
																</div>
															</div>
															...
															<div class="col-md-4">
																<div class="form-group">
																	...
																	<select class="select_theme_type form-control" name="dynamic[<?php echo e($a); ?>][theme]" required>
																		<option value="<?php echo e($col['theme']); ?>" selected><?php echo e($col["theme"]); ?></option>
																	</select>
																</div>
															</div>
															...
															<div class="col-md-3">
																<div class="form-group">
																	...
																	<input type="text" name="dynamic[<?php echo e($a); ?>][link]" value="<?php echo e($col['link']); ?>" class="form-control" placeholder="Link">
																</div>
															</div>

															<div class="col-md-1">
																<label for="" class="required" style="visibility:hidden">Share</label>
																<button type="button" name="remove" id="<?php echo e($b); ?>" class="btn btn-danger btn_remove_third" style="display:block">Remove</button>
															</div>
														</div>
													</div>
												<?php else: ?>
