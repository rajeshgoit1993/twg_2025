								...
								<div class="tourItmLeftSec">
									...
									<div class="tourImage_focusInOut pkg_search tourItmImgBox">
										<?php if(!empty($image_url) && $image_url !== "0"): ?>
											...
											<img src="<?php echo e($image_url); ?>" class="tourImage_zoom_image fade-in" alt="tourimage">
										<?php else: ?>
											<!-- Display default image if no valid image is found -->
											<img src="<?php echo e(URL::to('/public/Uploads/default_profile_image.png')); ?>" class="fade-in" alt="noimage">
										<?php endif; ?>
									</div>
										...
										<div class="tourItemFooter">
											...
											<div class="makeflex">
												...
												<div class="dSvcIconCont">
													<div class="dSvcIcon">
														<img src="<?php echo e(url('/public/uploads/icons/' . CustomHelpers::getimagename($service, 'rt_icons', 'icon'))); ?>" title="<?php echo e(CustomHelpers::getimagename($service, 'rt_icons', 'icon_title')); ?>">
													</div>
									...
									<?php if($new_price!='na'): ?>
										<?php if($new_price['actual_price']==$new_price['discount_price']): ?>
											<div class="dItemPriceBoxTop flexCenter">
												...
												<p class="dItemPriceType"><span id="" class="dItemOfferPrice defaultCurrency"><?php echo e($new_price['discount_price']); ?></span>  
<?php echo e(PackagePriceHelpers::get_price_type($package->Price_type)); ?></p>
											</div>
											<?php else: ?>
									...
									<div class="tourItmLeftSec">
										<div class="mTourItmImgBox">
											...
											<?php if($image_url != "0"): ?>
												...
												<img class="fade-in" src="<?php echo e($image_url); ?>" alt="tourimage">
											<?php else: ?>
												<!-- Display default image if no valid image is found -->
												<img class="fade-in" src="<?php echo e(URL::to('/public/Uploads/default_profile_image.png')); ?>" alt="noimage">
											<?php endif; ?>
										</div>
									</div>
									<div class="tourItmRightSec">
										<div class="mTourItmDescCont">
											...
											<div class="mDaysBadgeTop"><?php echo e($package->duration); ?>N / <?php echo e($package->duration + 1); ?>D</div>
											...
											<div class="mTourItemTopSec">
												<div class="mTourTtlWrapper">
													...
													<!--Holiday Type-->
													<div class="mTourType"><?php echo e($package->tour_type); ?></div>
												</div>
											</div>
