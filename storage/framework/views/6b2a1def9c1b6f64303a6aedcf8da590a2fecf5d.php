...
<section>
    ...
    <div class="reviewCont">
        ...
        <!-- <form action="<?php echo e(url('/save_traveller_details')); ?>"  method="post"> -->
            ...
            <div class="pageContainer">
                <div class="reviewTourDtlsCont">
            		<div class="reviewTourBox">
            			...
            			<h3><?php $day_night=(int)filter_var($query->duration, FILTER_SANITIZE_NUMBER_INT); ?> <?php echo e($day_night-1); ?> Nights / <?php echo e($day_night); ?> Days</h3>
