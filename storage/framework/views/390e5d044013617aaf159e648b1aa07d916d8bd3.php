<!-- Refund Under Process Modal -->
<div id="refund_under_process_modal" class="modal">
	<div class="modalContent lead-modalbox">
		<!-- Modal content starts-->
		<!-- Modal header-->
		<form class="user" id="refund_under_process_form" method="POST" enctype="multipart/form-data">
			<?php echo e(csrf_field()); ?>

			<input type="hidden" name="query_id" id="query_id_refund_under_process" value="">

			<div class="lead-modalheader">
				<h2>Refund Under Process</h2>
			</div>
			...
			<div class="lead-modalbody">
				...
				<select class="lead-input-text fullWidth" required id="assign_person_refund_under_process" name="assign_person"></select>
				</div>
				<!--Lead Cancelled Reason-->
				<!--<div class="form-group">
					<label for="tour_cancel_reason" class="detailsInput">Reason </label>
					<select class="lead-input-text fullWidth" required id="refund_under_process_cancel_reason" name="tour_cancel_reason"></select>
				</div> -->
			...
			<div class="lead-modalfooter">
				<button type="button" class="btn_lead_modal_close btn_refund_under_process_modal_close_cancelled" id="btn_refund_under_process_modal_close_cancelled">Cancel</button>
				<!-- <button type="button" class="btn_lead_modal_link">Add Lead</button> -->
				<button type="submit" class="btn_refund_under_process_modal_update">Update</button>
			</div>
		 </form>
		<!-- Modal content ends-->
	</div>
