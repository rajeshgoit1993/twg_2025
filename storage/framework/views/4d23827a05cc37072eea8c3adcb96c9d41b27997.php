			...
			<div class="lead-modalbody">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<!-- input type="date" value="<?php echo e(date('Y-m-d')); ?>" class="lead-input-text disabled fullWidth" id="datetimestamp" name="datetimestamp" disabled/> -->
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="datetimestamp" class="detailsInput">Current Time</label>
							<!-- <input type="time" value="<?php echo e(date('H:i')); ?>" class="current_time lead-input-text disabled fullWidth" id="datetimestamp" name="datetimestamp" disabled/> -->
