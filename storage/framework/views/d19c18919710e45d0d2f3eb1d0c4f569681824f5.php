...
<input type="hidden" value="<?php echo e($id); ?>" name="query_id" id="query_id" />
...
<?php if($loged_user->lock_before_quote_send == ''): ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="lead-input-text fullWidth" id="email" name="email" value="<?php echo e(old('email', $data->email)); ?>" placeholder="Enter email id" />
        </div>
    </div>
