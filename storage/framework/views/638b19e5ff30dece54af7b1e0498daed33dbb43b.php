	...
	<div class="mBG">
		<div class="dPageContainer">
			...
			<div class="ditemSlider dItemCardGap mobscroll scrollX" id="dynamic_pkg_add_domestic">
				<?php $__currentLoopData = $packages_domestic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
					<?php 
					...
					<div class="dItemCard">
						...
						<a href="<?php echo e(url('/holidays/'.str_slug($package->title).'?package_id='.CustomHelpers::custom_encrypt($package->id))); ?>" target="_blank">
							<div class="dItemCardImgCont">
								<?php if(CustomHelpers::get_image_gallery($gallery_id,'thum_medium')!="0"): ?>
									<img class="lazy-load" data-src="<?php echo e(CustomHelpers::get_image_gallery($gallery_id,'thum_medium')); ?>" alt="img">
									<?php elseif(CustomHelpers::get_image_gallery($gallery_id,'thum_medium')=="0"): ?>
									<img class="lazy-load" data-src="<?php echo e(URL::to('/').'/public/uploads/default_profile_image.png'); ?>" alt="img">
								<?php endif; ?>
							</div>
						</a> -->
						<!-- <?php 
						...
						<a href="<?php echo e($packageUrl); ?>" target="_blank">
						    <div class="dItemCardImgCont">
						        <img class="lazy-load" data-src="<?php echo e($imageSrc); ?>" alt="<?php echo e(e($package->title ?? 'Package Image')); ?>">
						    </div>
						</a> -->
												...
												<?php if($new_price['actual_price']==$new_price['discount_price']): ?>
													<div class="flexCenter">
														...
														<p class="dItemPriceType">
															<span id="" class="dItemOfferPrice defaultCurrency"><?php echo e($new_price['discount_price']); ?></span> <?php echo e($package->Price_type); ?>
