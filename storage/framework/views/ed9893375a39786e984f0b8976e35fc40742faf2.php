<?php $__env->startSection("title", 'Booking Review'); ?>

<?php $__env->startSection('content'); ?>

<!-- payment review page css -->
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('/resources/assets/frontend/css/payme.css')); ?>" />

<!-- add traveller review page css -->
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('/resources/assets/frontend/css/addtraveller-bookingReview.css')); ?>" />
...
<section>
	...
	<div class="reviewCont">
		...
		<!-- <form action="<?php echo e(url('/save_booking_details')); ?>"  method="post"> -->
		...
		<div class="pageContainer">
			<div class="reviewTourDtlsCont">
				<div class="reviewTourBox">
					<h2><?php echo e(CustomHelpers::get_package_name($query->packageId)); ?></h2>
					<h3>
						<?php 
							$day_night=(int)filter_var($query->duration, FILTER_SANITIZE_NUMBER_INT);
						?>
						<span><?php echo e($day_night-1); ?> Nights / <?php echo e($day_night); ?> Days</span>
					</h3>
						...
						<?php $__currentLoopData = $package_service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
							<div class="serviceIcons appendTop10">
								<div class="serviceIconsImage">
									<img class="serviceImage" src="<?php echo e(url('/public/uploads/icons/'.CustomHelpers::getimagename($icon,'rt_icons','icon'))); ?>" title="<?php echo e(CustomHelpers::getimagename($icon,'rt_icons','icon_title')); ?>" >
								</div>
								<div class="serviceIconsTitle"><?php echo e(CustomHelpers::getimagename($icon,'rt_icons','icon_title')); ?></div>
							</div>
				...
				<div class="tourDepartureBox">
					...
					<h5><?php echo e($data->sourcecity); ?></h5>
				</div>
				<div class="tourTravelDateBox">
					<?php
						...
						?>
					<h4>FROM</h4>
					<h5><?php echo "$day_from"; ?>, <?php echo e($datefrom_print); ?></h5>
					<h4>TO</h4>
					<h5><?php echo "$day_to"; ?>, <?php echo e($stop_date_print); ?></h5>
				</div>
			</div>
			...
			<div class="mtourContBox">
				<div class="leftContainer">
		            ...
		            <?php echo $__env->make('payment.bookingre_traveller', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
					...
					?>
					<?php if($package && (in_array('India', $country) || in_array('Nepal', $country) || in_array('Bhutan', $country))): ?>
						
					<?php else: ?>
						<?php echo $__env->make('payment.tcs-info', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
					<?php endif; ?>
				...
				<div class="rightContainer">
					<?php echo $__env->make('payment.right_payment', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('payment.travellerdetails.addtraveller', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
