                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select class="quote_city form-control" id="location" name="location" required>
                            <option value="<?php echo e($data->id); ?>" selected><?php echo e(CustomHelpers::get_master_table_data('city', 'id', (int)$data->location, 'name')); ?></option>
                          </select>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select class="form-control" id="propertycountry" name="propertycountry" required>
                            ...
                            <option value="<?php echo e($country->id); ?>" <?php if($country->id==$data->propertycountry): ?> selected <?php endif; ?>><?php echo e($country->name); ?></option>
