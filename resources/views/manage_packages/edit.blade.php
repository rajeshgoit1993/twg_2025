 ...
 @include('manage_packages.packages-blocks.itinerary')  
                  ...
                  <!--   <?php $new_price=CustomHelpers::get_package_new_price($packagesData->newprices); 
                          ...
                          <div class="col-md-12">
                            <div class="form-group pricelistpackage" >
                              <div class="table-responsive no-border">
                                @include('manage_packages.price_fields_edit')                          
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div id="Supplier" class="tab-pane fade">
                      <div class="panel-body">
                       @include('manage_packages.packages-blocks.supplier')   
                      </div>
                    </div>
                    ...
                    <div id="meta" class="tab-pane fade">
                      <div class="panel-body">
                 @include('manage_packages.packages-blocks.seo')        
                      </div>
                    </div>
                    @endif
                    @endif
                    ...
                    <div id="destination" class="tab-pane fade">
                      <div class="panel-body">
                      @include('manage_packages.packages-blocks.destination')   
                      </div>
                    </div>
                    ...
                    <div id="similar-tour" class="tab-pane fade">
                      <div class="panel-body">
           @include('manage_packages.packages-blocks.similar_tour')             
                      </div>
                    </div>
                                ...
                                <div class="form-group">
                                  <div class="makeflex align-center ">
                                    ...
                                    <div class="toggle-switch">
                                      <input type="checkbox" id="book-online-toggle" value="1" name="livemode" @if($packagesData->livemode==1) checked @endif>
