					...
					<div class="box-body">
						...
						<div class="well">
							<div class="modal-body">
								<form action="{{ route('saveTheme') }}" method="post" enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="theme_para1" class="form-control" id="themePara1" placeholder="Enter Content 1" value="{{ old('theme_para1') }}">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="theme_para2" class="form-control" id="themePara2" placeholder="Enter Content 2" value="{{ old('theme_para2') }}">
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control ckeditor" name="about_theme" id="themeAbout" placeholder="Enter About Theme(Front End)" >{{ old('about_theme') }}</textarea>
										...
										@if(Sentinel::check())
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" name="theme_title" class="form-control" id="thmeTitle" placeholder="Enter Theme Title(SEO)" value="{{ old('theme_title') }}">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" name="theme_key" class="form-control" id="themeKeywords" placeholder="Enter Theme Key(SEO)" value="{{ old('theme_key') }}">
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea class="form-control" name="theme_desc" id="themeDesc" placeholder="Enter Theme Description(SEO)" rows="4">{{ old('theme_desc') }}</textarea>
