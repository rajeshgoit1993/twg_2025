				...
				<div class="navHeaderWrapper navClass">
					...
					<ul class="navTabs headerIconsGap" role="tablist">
						...
						<!--<li class="nav-item" role="presentation" style="display: ;">
							<a href="https://flights.theworldgateway.com/" target="_blank" style="">
							<div class="dSrvcCont">
								<div class="dSvcIconBox">
									<img class="flightIcon">
								</div>
								<div class="dSvcIconName">Flights</div>
							</div>
							</a>
						</li>-->
						<!--Hotels-->
						...
						<li class="nav-item" role="presentation">
							<!--<a href="#holidays" class="active" aria-controls="holidays" role="tab" data-toggle="tab"></a>-->
							<div class="dSrvcCont">
								<div class="dSvcIconBox">
