				<div class="tab">
					...
					<div class="sub-nav-item-content">
						<div class="sub-tab active">
							<!-- <form action="{{ URL::to('/packages_lists') }}" method="post" autocomplete="off" name="search2" id="search2" > -->
									...
									<div class="dHldyPanelBox">
										...
										<div class="dSvcPanel_inputbox_date flexOne">
											<label for="datepicker_insurance_startdate">
												...
												<input type="text" id="datepicker_insurance_startdate" name="datepicker_insurance_startdate" value="{{ date('d M y', strtotime('+10 days')) }}" placeholder="Select Date" style="opacity: 0;height: 0;padding: 0;" />
										...
										<div class="dSvcPanel_inputbox_date flexOne">
											<label for="datepicker_insurance_enddate">
												...
												<input type="text" id="datepicker_insurance_enddate" name="datepicker_insurance_enddate" value="{{ date('d M y', strtotime('+10 days')) }}" placeholder="Select Date" />
												<div class="dateValueCont">
													<div class="dateValue makeflex">
