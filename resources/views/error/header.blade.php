...
<head>
    ...
    <!--common css-->
    <link rel="preload stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/frontend/css/common.css') }}" />

    <!--header & footer css-->
    <link rel="preload stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/frontend/css/header.css') }}" />
    ...
    <!--datepicker css-->
    <link rel="preload stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/frontend/css/ui-datepicker.css') }}" />
    ...
    <!--Testimonials Slick-->
    <link rel="preload stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/slick/css/slick.css') }}" />
    <link rel="preload stylesheet" type="text/css" as="style" href="{{ asset('/resources/assets/slick/css/slick-theme.css') }}" />
