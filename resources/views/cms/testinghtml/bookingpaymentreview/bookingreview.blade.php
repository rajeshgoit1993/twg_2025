			...
			<div class="guestContactDtlsBox">
				...
				<div class="flex-row-multicolum appendTop10">
					<div class="flex-col-md-6">
						<div class="formGroup">
							<label for="name" class="formLabel">Leading Guest Name</label>
							<input class="formInput" type="text"  value="" id="" name="name" placeholder="Enter full name as per id card" />
		...
		<div class="rightContainer">
			...
			<div class="totalCostBox">
				<div class="totalBasicCostBox">
					<div>
						<p class="basicCostItem fontBold">Total Cost</p>
					</div>
			...
			<div class="payPartBox" style="display: ;">
				<label>
					...
					<div class="payFullItem"><span class="defaultCurencyPay"></span> 0</div>
				</label>
			</div>
			<!--part payment-->
