		...
		<form action="{{URL::to('/copy_option1')}}" method="post" id="quo1" name="quo1">
			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#Info"><span class="glyphicon glyphicon-file"></span> Guest Info</a>
						</h4>
					</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#package_name"><span class="glyphicon glyphicon-th-list">
							</span> Package Name</a>
							</h4>
						</div>
						<div id="package_name" class="panel-collapse collapse">
							<div class="panel-body">
								<div class="row">
									<div class="col-md-4">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#package_service"><span class="glyphicon glyphicon-th-list"></span> Package Services</a>
							</h4>
						</div>
				...
				<div id="Description" class="panel-collapse collapse">
					...
					<td  class="anything">
					  <input type="text" name="anything" class="form-control" placeholder=" write anything like price per person / for all travelling passengers..." value="{{$reference_data->anything}}">
					</td>
					@else
					<td  class="anything">
					...
					<td class="remarks">
					  ...
					  placeholder="Remarks ..."  value="{{ $reference_data->remarks }}">
					</td>
					</tr>
					</table>
					...
					<td>
					<?php
					$option1_price=unserialize($reference_data->option1_price);
					?>
					...
					<td>
					<input type="text" class="form-control query_air_adult" name="price[query_air_adult]" @if($option1_price["query_air_adult"]!="") value="{{$option1_price["query_air_adult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_air_exadult" name="price[query_air_exadult]" @if($option1_price["query_air_exadult"]!="") value="{{$option1_price["query_air_exadult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_air_childbed" name="price[query_air_childbed]" @if($option1_price["query_air_childbed"]!="") value="{{$option1_price["query_air_childbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_air_childwbed" name="price[query_air_childwbed]" @if($option1_price["query_air_childwbed"]!="") value="{{$option1_price["query_air_childwbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_air_infant" name="price[query_air_infant]" @if($option1_price["query_air_infant"]!="") value="{{$option1_price["query_air_infant"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_air_single" name="price[query_air_single]" @if($option1_price["query_air_single"]!="") value="{{$option1_price["query_air_single"]}}"  @endif>
					</td>
					</tr>
					<!--Cruise Start-->
					<tr>
					...
					<select class="form-control query_cruise_curr" name="price[query_cruise_curr]">
					  @foreach($rates as $rate)
						<option value="{{ $rate-> id}}" @if(array_key_exists("query_cruise_curr",$option1_price))   @if($rate->id==$option1_price["query_cruise_curr"]) selected  @endif @endif c_val="{{$rate->rate}}">{{ $rate-> currency}}</option>
					@endforeach
					</select>
					</td>
					<td>
					<input type="text" class="form-control query_cruise_adult" name="price[query_cruise_adult]" @if(array_key_exists("query_cruise_adult",$option1_price))  @if($option1_price["query_cruise_adult"]!="") value="{{$option1_price["query_cruise_adult"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_cruise_exadult" name="price[query_cruise_exadult]" @if(array_key_exists("query_cruise_exadult",$option1_price))  @if($option1_price["query_cruise_exadult"]!="") value="{{$option1_price["query_cruise_exadult"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_cruise_childbed" name="price[query_cruise_childbed]" @if(array_key_exists("query_cruise_childbed",$option1_price))  @if($option1_price["query_cruise_childbed"]!="") value="{{$option1_price["query_cruise_childbed"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_cruise_childwbed" name="price[query_cruise_childwbed]" @if(array_key_exists("query_cruise_childwbed",$option1_price))  @if($option1_price["query_cruise_childwbed"]!="") value="{{$option1_price["query_cruise_childwbed"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_cruise_infant" name="price[query_cruise_infant]" @if(array_key_exists("query_cruise_infant",$option1_price))  @if($option1_price["query_cruise_infant"]!="") value="{{$option1_price["query_cruise_infant"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_cruise_single" name="price[query_cruise_single]" @if(array_key_exists("query_cruise_single",$option1_price))  @if($option1_price["query_cruise_single"]!="") value="{{$option1_price["query_cruise_single"]}}"  @endif @endif>
					</td>
					</tr>
					<!--Cruise End-->
					<tr>
					...
					@foreach($rates as $rate)
						<option value="{{ $rate-> id}}" @if($rate->id==$option1_price["query_hotel_curr"]) selected  @endif c_val="{{$rate->rate}}" >{{ $rate-> currency}}</option>
					@endforeach
					</select>
					</td>
					<td>
					<input type="text" class="form-control query_hotel_adult" name="price[query_hotel_adult]" @if($option1_price["query_hotel_adult"]!="") value="{{$option1_price["query_hotel_adult"]}}"  @endif id="option1_mandate">
					</td>
					<td>
					<input type="text" class="form-control query_hotel_exadult" name="price[query_hotel_exadult]" @if($option1_price["query_hotel_exadult"]!="") value="{{$option1_price["query_hotel_exadult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_hotel_childbed" name="price[query_hotel_childbed]" @if($option1_price["query_hotel_childbed"]!="") value="{{$option1_price["query_hotel_childbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_hotel_childwbed" name="price[query_hotel_childwbed]" @if($option1_price["query_hotel_childwbed"]!="") value="{{$option1_price["query_hotel_childwbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_hotel_infant" name="price[query_hotel_infant]" @if($option1_price["query_hotel_infant"]!="") value="{{$option1_price["query_hotel_infant"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_hotel_single" name="price[query_hotel_single]" @if($option1_price["query_hotel_single"]!="") value="{{$option1_price["query_hotel_single"]}}"  @endif>
					</td>
					</tr>
					<tr>
					<td>Tours</td>
					...
					@foreach($rates as $rate)
						<option value="{{ $rate-> id}}" @if($rate->id==$option1_price["query_tours_curr"]) selected  @endif c_val="{{$rate->rate}}">{{ $rate-> currency}}</option>
					@endforeach
					</select>
					</td>
					<td>
					<input type="text" class="form-control query_tours_adult" name="price[query_tours_adult]" @if($option1_price["query_tours_adult"]!="") value="{{$option1_price["query_tours_adult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_tours_exadult" name="price[query_tours_exadult]" @if($option1_price["query_tours_exadult"]!="") value="{{$option1_price["query_tours_exadult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_tours_childbed" name="price[query_tours_childbed]" @if($option1_price["query_tours_childbed"]!="") value="{{$option1_price["query_tours_childbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_tours_childwbed" name="price[query_tours_childwbed]" @if($option1_price["query_tours_childwbed"]!="") value="{{$option1_price["query_tours_childwbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_tours_infant" name="price[query_tours_infant]" @if($option1_price["query_tours_infant"]!="") value="{{$option1_price["query_tours_infant"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_tours_single" name="price[query_tours_single]" @if($option1_price["query_tours_single"]!="") value="{{$option1_price["query_tours_single"]}}"  @endif>
					</td>
					</tr>
					<tr>
					<td>Transfers</td>
					...
					@foreach($rates as $rate)
						<option value="{{ $rate-> id}}" @if($rate->id==$option1_price["query_transfer_curr"]) selected  @endif c_val="{{$rate->rate}}" >{{ $rate-> currency}}</option>
					@endforeach
					</select>
					</td>
					<td>
					<input type="text" class="form-control query_transfer_adult" name="price[query_transfer_adult]" @if($option1_price["query_transfer_adult"]!="") value="{{$option1_price["query_transfer_adult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_transfer_exadult" name="price[query_transfer_exadult]" @if($option1_price["query_transfer_exadult"]!="") value="{{$option1_price["query_transfer_exadult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_transfer_childbed" name="price[query_transfer_childbed]" @if($option1_price["query_transfer_childbed"]!="") value="{{$option1_price["query_transfer_childbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_transfer_childwbed" name="price[query_transfer_childwbed]" @if($option1_price["query_transfer_childwbed"]!="") value="{{$option1_price["query_transfer_childwbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_transfer_infant" name="price[query_transfer_infant]" @if($option1_price["query_transfer_infant"]!="") value="{{$option1_price["query_transfer_infant"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_transfer_single" name="price[query_transfer_single]" @if($option1_price["query_transfer_single"]!="") value="{{$option1_price["query_transfer_single"]}}"  @endif>
					</td>
					</tr>
					<tr>
					<td>Visa</td>
					...
					@foreach($rates as $rate)
						<option value="{{ $rate-> id}}" @if($rate->id==$option1_price["query_visa_curr"]) selected  @endif c_val="{{$rate->rate}}">{{ $rate-> currency}}</option>
					@endforeach
					</select>
					</td>
					<td>
					<input type="text" class="form-control query_visa_adult" name="price[query_visa_adult]" @if($option1_price["query_visa_adult"]!="") value="{{$option1_price["query_visa_adult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_visa_exadult" name="price[query_visa_exadult]" @if($option1_price["query_visa_exadult"]!="") value="{{$option1_price["query_visa_exadult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_visa_childbed" name="price[query_visa_childbed]" @if($option1_price["query_visa_childbed"]!="") value="{{$option1_price["query_visa_childbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_visa_childwbed" name="price[query_visa_childwbed]" @if($option1_price["query_visa_childwbed"]!="") value="{{$option1_price["query_visa_childwbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_visa_infant" name="price[query_visa_infant]" @if($option1_price["query_visa_infant"]!="") value="{{$option1_price["query_visa_infant"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_visa_single" name="price[query_visa_single]" @if($option1_price["query_visa_single"]!="") value="{{$option1_price["query_visa_single"]}}"  @endif>
					</td>
					</tr>
					<tr>
					...
					@foreach($rates as $rate)
						<option value="{{ $rate-> id}}" @if($rate->id==$option1_price["query_inc_curr"]) selected  @endif c_val="{{$rate->rate}}" >{{ $rate-> currency}}</option>
					@endforeach
					</select>
					</td>
					<td>
					<input type="text" class="form-control query_inc_adult" name="price[query_inc_adult]" @if($option1_price["query_inc_adult"]!="") value="{{$option1_price["query_inc_adult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_inc_exadult" name="price[query_inc_exadult]" @if($option1_price["query_inc_exadult"]!="") value="{{$option1_price["query_inc_exadult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_inc_childbed" name="price[query_inc_childbed]" @if($option1_price["query_inc_childbed"]!="") value="{{$option1_price["query_inc_childbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_inc_childwbed" name="price[query_inc_childwbed]" @if($option1_price["query_inc_childwbed"]!="") value="{{$option1_price["query_inc_childwbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_inc_infant" name="price[query_inc_infant]" @if($option1_price["query_inc_infant"]!="") value="{{$option1_price["query_inc_infant"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_inc_single" name="price[query_inc_single]" @if($option1_price["query_inc_single"]!="") value="{{$option1_price["query_inc_single"]}}"  @endif>
					</td>
					</tr>
					<!--Meals  Start-->
					<tr>
					...
					<select class="form-control query_meals_curr" name="price[query_meals_curr]">
					  @foreach($rates as $rate)
						<option value="{{ $rate-> id}}" @if(array_key_exists("query_meals_curr",$option1_price))   @if($rate->id==$option1_price["query_meals_curr"]) selected  @endif @endif c_val="{{$rate->rate}}">{{ $rate-> currency}}</option>
					@endforeach
					</select>
					</td>
					<td>
					<input type="text" class="form-control query_meals_adult" name="price[query_meals_adult]" @if(array_key_exists("query_meals_adult",$option1_price))  @if($option1_price["query_meals_adult"]!="") value="{{$option1_price["query_meals_adult"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_meals_exadult" name="price[query_meals_exadult]" @if(array_key_exists("query_meals_exadult",$option1_price))  @if($option1_price["query_meals_exadult"]!="") value="{{$option1_price["query_meals_exadult"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_meals_childbed" name="price[query_meals_childbed]" @if(array_key_exists("query_meals_childbed",$option1_price))  @if($option1_price["query_meals_childbed"]!="") value="{{$option1_price["query_meals_childbed"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_meals_childwbed" name="price[query_meals_childwbed]" @if(array_key_exists("query_meals_childwbed",$option1_price))  @if($option1_price["query_meals_childwbed"]!="") value="{{$option1_price["query_meals_childwbed"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_meals_infant" name="price[query_meals_infant]" @if(array_key_exists("query_meals_infant",$option1_price))  @if($option1_price["query_meals_infant"]!="") value="{{$option1_price["query_meals_infant"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_meals_single" name="price[query_meals_single]" @if(array_key_exists("query_meals_single",$option1_price))  @if($option1_price["query_meals_single"]!="") value="{{$option1_price["query_meals_single"]}}"  @endif @endif>
					</td>
					</tr>
					<!--Meals End-->
					<!--Markup  Start-->
					...
					<select class="form-control query_markup_curr" name="price[query_markup_curr]">
					  @foreach($rates as $rate)
						<option value="{{ $rate-> id}}" @if(array_key_exists("query_markup_curr",$option1_price))   @if($rate->id==$option1_price["query_markup_curr"]) selected  @endif @endif c_val="{{$rate->rate}}">{{ $rate-> currency}}</option>
					@endforeach
					</select>
					</td>
					<td>
					<input type="text" class="form-control query_markup_adult" name="price[query_markup_adult]" @if(array_key_exists("query_markup_adult",$option1_price))  @if($option1_price["query_markup_adult"]!="") value="{{$option1_price["query_markup_adult"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_markup_exadult" name="price[query_markup_exadult]" @if(array_key_exists("query_markup_exadult",$option1_price))  @if($option1_price["query_markup_exadult"]!="") value="{{$option1_price["query_markup_exadult"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_markup_childbed" name="price[query_markup_childbed]" @if(array_key_exists("query_markup_childbed",$option1_price))  @if($option1_price["query_markup_childbed"]!="") value="{{$option1_price["query_markup_childbed"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_markup_childwbed" name="price[query_markup_childwbed]" @if(array_key_exists("query_markup_childwbed",$option1_price))  @if($option1_price["query_markup_childwbed"]!="") value="{{$option1_price["query_markup_childwbed"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_markup_infant" name="price[query_markup_infant]" @if(array_key_exists("query_markup_infant",$option1_price))  @if($option1_price["query_markup_infant"]!="") value="{{$option1_price["query_markup_infant"]}}"  @endif @endif>
					</td>
					<td>
					<input type="text" class="form-control query_markup_single" name="price[query_markup_single]" @if(array_key_exists("query_markup_single",$option1_price))  @if($option1_price["query_markup_single"]!="") value="{{$option1_price["query_markup_single"]}}"  @endif @endif>
					</td>
					</tr>
					<!--Cruise End-->
					<tr>
					...
					@foreach($rates as $rate)
						<option value="{{ $rate-> id}}" @if($rate->id==$option1_price["query_gst_curr"]) selected  @endif c_val="{{$rate->rate}}" >{{ $rate-> currency}}</option>
					@endforeach
					</select>
					</td>
					<td>
					<input type="text" class="form-control query_gst_adult" name="price[query_gst_adult]" @if($option1_price["query_gst_adult"]!="") value="{{$option1_price["query_gst_adult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_gst_exadult" name="price[query_gst_exadult]" @if($option1_price["query_gst_exadult"]!="") value="{{$option1_price["query_gst_exadult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_gst_childbed" name="price[query_gst_childbed]" @if($option1_price["query_gst_childbed"]!="") value="{{$option1_price["query_gst_childbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_gst_childwbed" name="price[query_gst_childwbed]" @if($option1_price["query_gst_childwbed"]!="") value="{{$option1_price["query_gst_childwbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_gst_infant" name="price[query_gst_infant]" @if($option1_price["query_gst_infant"]!="") value="{{$option1_price["query_gst_infant"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_gst_single" name="price[query_gst_single]" @if($option1_price["query_gst_single"]!="") value="{{$option1_price["query_gst_single"]}}"  @endif>
					</td>
					</tr>
						<tr>
					<td>Total</td>
					...
					<td>
					<input type="text" class="form-control query_total_adult" readonly="" name="price[query_total_adult]" value="{{CustomHelpers::get_quotation_total($reference_data->option1_price,'adult')}}">
					</td>
					<td>
					<input type="text" class="form-control query_total_exadult" readonly="" name="price[query_total_exadult]" value="{{CustomHelpers::get_quotation_total($reference_data->option1_price,'exadult')}}">
					</td>
					<td>
					<input type="text" class="form-control query_total_childbed" readonly="" name="price[query_total_childbed]" value="{{CustomHelpers::get_quotation_total($reference_data->option1_price,'childbed')}}">
					</td>
					<td>
					<input type="text" class="form-control query_total_childwbed" readonly="" name="price[query_total_childwbed]" value="{{CustomHelpers::get_quotation_total($reference_data->option1_price,'childwbed')}}">
					</td>
					<td>
					<input type="text" class="form-control query_total_infant" readonly="" name="price[query_total_infant]" value="{{CustomHelpers::get_quotation_total($reference_data->option1_price,'infant')}}">
					</td>
					<td>
					<input type="text" class="form-control query_total_single" readonly="" name="price[query_total_single]" value="{{CustomHelpers::get_quotation_total($reference_data->option1_price,'single')}}">
					</td>
					</tr>
					<tr>
					<td>Discount</td>
					...
					<td>
					<input type="text" class="form-control query_discount_adult" name="price[query_discount_adult]" @if($option1_price["query_discount_adult"]!="") value="{{$option1_price["query_discount_adult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_discount_exadult" name="price[query_discount_exadult]" @if($option1_price["query_discount_exadult"]!="") value="{{$option1_price["query_discount_exadult"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_discount_childbed" name="price[query_discount_childbed]" @if($option1_price["query_discount_childbed"]!="") value="{{$option1_price["query_discount_childbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_discount_childwbed" name="price[query_discount_childwbed]" @if($option1_price["query_discount_childwbed"]!="") value="{{$option1_price["query_discount_childwbed"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_discount_infant" name="price[query_discount_infant]" @if($option1_price["query_discount_infant"]!="") value="{{$option1_price["query_discount_infant"]}}"  @endif>
					</td>
					<td>
					<input type="text" class="form-control query_discount_single" name="price[query_discount_single]" @if($option1_price["query_discount_single"]!="") value="{{$option1_price["query_discount_single"]}}"  @endif>
					</td>
					</tr>
					<tr>
					<td>Grand Total</td>
					...
					<td>
					<input type="text" class="form-control query_grand_adult" readonly="" name="price[query_grand_adult]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option1_price,'adult')}}">
					</td>
					<td>
					<input type="text" class="form-control query_grand_exadult" readonly="" name="price[query_grand_exadult]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option1_price,'exadult')}}">
					</td>
					<td>
					<input type="text" class="form-control query_grand_childbed" readonly="" name="price[query_grand_childbed]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option1_price,'childbed')}}">
					</td>
					<td>
					<input type="text" class="form-control query_grand_childwbed" readonly="" name="price[query_grand_childwbed]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option1_price,'childwbed')}}">
					</td>
					<td>
					<input type="text" class="form-control query_grand_infant" readonly="" name="price[query_grand_infant]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option1_price,'infant')}}">
					</td>
					<td>
					<input type="text" class="form-control query_grand_single" readonly="" name="price[query_grand_single]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option1_price,'single')}}">
					</td>
					</tr>
					</tbody>
					</table>
				...
				<div class="panel panel-default">
					...
					<div id="Transport" class="panel-collapse collapse">
						...
						<div class="col-md-12">
							...
							<option value="{{ $trans->name }}"
							  @if($trans->name==$reference_data->option1_transport) selected @endif>{{$trans->name}}</option>
									@endforeach
							</select>
							</div>
						</div>
					   ...
					   <div class="oflight" style="display: none;">
						...
						<?php
						 $flight=unserialize($reference_data->option1_flight);
						?>
					...
					<div class="col-md-12">
					   <div class="oflight">
						  <textarea class="form-control" placeholder="Package Transport Description..." name="transport_description" id="" cols="30" rows="5">{{$reference_data->option1_transport_description}}
						</textarea>
						  <br>
					   </div>
						</div>
					...
					<div id="pac_Description" class="panel-collapse collapse">
						...
						name="description" id="" cols="30" rows="5" >{!! $reference_data->option1_description !!}</textarea>
						</div>
						<div class="form-group">
						...
						<span class="show_hide">More+</span>
						<textarea class="form-control ckeditor"
						name="highlights" id="" cols="30" rows="5" >{!! $reference_data->option1_highlights !!}</textarea>
						</div>
							  <br>
						</div>
						</div>
						...
						<div id="Inclusions" class="panel-collapse collapse">
							<div class="panel-body c_body">
								<div class="row">
									...
									{!! $reference_data->option1_inclusions !!}</textarea>
									</div>
									</div>
									<div class="col-md-12">
									<div class=" form-group ">
									...
									{!! $reference_data->option1_exclusions !!}
									</textarea>
									</div>
									</div>
								</div>
					...
					<!---->
					<?php
					$option1_dayItinerary=unserialize($reference_data->option1_dayItinerary);
					?>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
					...
					<div class="panel panel-default">
						...
						<input type="checkbox" name="visa" value="1" id="" class="visa"@if($reference_data->option1_visa=="1") checked @endif/>
						</div>
						...
						<div>
						  <?php
						$option1_package_visa=unserialize($reference_data->option1_package_visa);
						  ?>
						...
						<?php
						$option1_package_payment=unserialize($reference_data->option1_package_payment);
						  ?>
						...
						<div>
						<?php
						$option1_package_can=unserialize($reference_data->option1_package_can);
						  ?>
						...
						<div>
						<?php
						$option1_package_impnotes=unserialize($reference_data->option1_package_impnotes);
						  ?>
