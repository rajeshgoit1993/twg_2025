...
<div style="text-align: center;">
					<button type="submit" name="add" id="remove" class="btn btn-danger btn-lg location_add">CONTINUE<i class="fa fa-arrow-right"></i></button>
				</div>
				<!-- Add Rooms Modal -->
					...
					<!-- Modal content-->
						<div class="modal-content borderRadius5">
							...
							<div class="roomGuests">
								...
								<input type="text" class="quote1_pop_passenger_value" value="1 Room (2 Adults,0 Child,0 Infant)" placeholder="1 Room (2 Adults,0 Child,0 Infant)" id="" readonly>
							</div>
										...
										<div class="row">
											<div class="appendBottom5">
												<div class="border-bottom1 padding-top10">
													<label for="room" class="pfwmt appendBottom5 font-size14" style="color: #000001 !important">Room 1 <span class="requiredcolor">*</span></label>
													<div class="makeflex" style="justify-content: space-between">
														<div class="text-center">
															<input type="hidden" id="travellers" name="room[0][adult_room]" class="adult_room_value" value="2"><i class="glyphicon adult_room_dec glyphicon-minus font-size14" style="color: #9B9B9B;padding: 12px;position: unset;" aria-hidden="true"></i>
															<span class="font-size20 adult_room_result" style="color: #008CFF;font-weight: 900;padding: 12px">2</span>
															<i class="glyphicon adult_room_inc glyphicon-plus font-size14" style="color: #9B9B9B;padding: 12px;position: unset;" aria-hidden="true"></i>
															<p class="text-center font-size12" style="padding: 1px;background: #f2f2f2;color: #4a4a4a;border-radius: 3px;">Adult ( + 12yrs)</p>
														</div>
														<div class="text-center">
															<input type="hidden" id="travellers" name="room[0][child_room]" class="span_value_child_with_bed child_room_value" value="0"><i class="glyphicon glyphicon-minus font-size14 child_room_dec" style="color: #9B9B9B;padding: 12px;position: unset;" aria-hidden="true"></i>
															<span class="font-size20 child_room_result" style="color: #008CFF;font-weight: 900;padding: 12px">0</span>
															<i class="glyphicon glyphicon-plus child_room_inc font-size14" style="color: #9B9B9B;padding: 12px;position: unset;" aria-hidden="true"></i><p class="text-center" style="padding: 1px;background: #f2f2f2;color: #4a4a4a;font-size: 12px;border-radius: 3px;">Child (2-12yrs)</p>
														</div>
														<div class="text-center">
															<input type="hidden" id="travellers" name="room[0][infant_room]" class="infant_room_value" value="0"><i class="glyphicon glyphicon-minus font-size14 infant_room_dec" style="color: #9B9B9B;padding: 12px;position: unset;" aria-hidden="true"></i><span class="font-size20 infant_room_result" style="color: #008CFF;font-weight: 900;padding: 12px">0</span><i class="glyphicon glyphicon-plus infant_room_inc font-size14" style="color: #9B9B9B;padding: 12px;position: unset;" aria-hidden="true"></i><p class="text-center" style="padding: 1px;background: #f2f2f2;color: #4a4a4a;font-size: 12px;border-radius: 3px;">Infant (0-2yrs)</p>
														</div>
															<div class="text-center">
