...
<td>
  <a href="{{URL::to('quo_first/'.$query->id)}}"><button class=" btn-info">Send Quote</button></a>
</td>
<td>
...
@if(Sentinel::check())
@if(Sentinel::getUser()->inRole('administrator') || Sentinel::getUser()->inRole('super_admin') || Sentinel::getUser()->inRole('supervisor'))
<button  class="btn btn-default btn-xcrud btn btn-success unverified" id="{{$query->id}}"  > Unverify</button>
@endif
@endif
</td>
</tr>
