	...
	<div class="mtourQuoteSummaryCont">
		<h4 class="mtourQuoteTitle">{{ $data2->custom_package_name }}</h4>
		<h5 class="mtourQuoteDaysBadge">{{ $data2->duration-1 }} Nights / {{ $data2->duration }} Days</h5>
		<div class="mtouQuoteBookCont">
			...
			<div id="mobscroll" class="mobscroll overflowX">
				<?php $package_service=unserialize($data2->package_service); ?>
	...
	<div class="mtourQuoteDatePricingCont">
		<div class="flexColumn">
			...
			<div class="mtourQuoteCityBox">
				...
				<h3 class="mtourQuoteCityName">{{ $data2->source }}</h3>
			</div>	
			<!--Tour Date-->
			...
			<div>
				<div class="makeflexCenterBewtween">
					...
					<p class="mtourQuotePriceValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data2->option2_price,'adult')); ?></p>
				</div>
				<div class="mtourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="mtourQuotePriceBoxSubHead">Discount (-)</p>
					<p class="mtourQuotePriceValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data2->option2_price,'adult')); ?></p>
				</div>
				<!--<div class="mtourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
				...
				<div class="flexBetween">
					...
					<p class="mtourQuotePriceTagline">( {{ $data2->anything }} )</p>
					</div>
					<div>
					<p class="mtourQuotePriceTotalValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data2->option2_price,'adult')); ?></p>
					</div>
				</div>
			</div>
			...
			<div>
				<div class="makeflexCenterBewtween">
					...
					?>
					<p class="mtourQuotePriceValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option2_total); ?></p>
				</div>
				<div class="mtourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="mtourQuotePriceBoxSubHead">Discount (-)</p>
					...
					?>
					<p class="mtourQuotePriceValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option2_total_discount); ?></p>
				</div>
				<!--<div class="mtourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="mtourQuotePriceBoxSubHead">GST (5%)</p>
				...
				<div class="makeflexCenterBewtween">
					<p class="mtourQuotePriceTotal">Grand Total</p>
					<p class="mtourQuotePriceTotalValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option2_total-$option2_total_discount); ?></p>
				</div>
			</div>
			@endif
			<i>
		...
		@if($data2->option2_validaty!="")
			<div class="mtourQuoteValidity">QUOTE VALIDITY - {{ date("d M Y", strtotime($data2->option2_validaty)) }}</div>
		@endif
		<!--Quote Validity ends-->
	</div>
	...
	<div class="mtourQuoteFlightCont">
		<h3 class="mtourQuoteFlightHead">{{ $data2->option2_transport }}</h3>
		<div class="mtourQuoteTransportBox">
			<p class="mtransportDesc">{{ $data2->option2_transport_description }}</p>
		</div>
	</div>
	@endif
	...
	<div class="mtourQuoteBookPolicyCont">
		...
		<div class="mfoldableContent mtourQuotePolicyBox">
			...
			@endforeach
			<div class="mtourQuoteAddPolicy">{{ $data2->option2_visa_policies }}</div>
		</div>
	</div>
	...
	<div class="mtourQuoteBookPolicyCont">
		...
		@else
			...
			@endforeach
				<div class="mtourQuoteAddPolicy">{{ $data2->option2_payment_policies }}</div>
				<div class="mtourQuotePolicySeparator"></div>
		@endif
		...
		@else
			...
			@endforeach
				<div class="mtourQuoteCancelAddPolicy">{{ $data2->option2_cancellation }}</div>
		@endif
	...
	<div class="mtourQuoteBookPolicyCont">
		...
		@endforeach
			<div class="mtourQuoteAddPolicy">{{ $data2->option2_extra_imp }}</div>
			<!--<div class="mtourQuotePolicySeparator"></div>-->
		</div>
	</div>
	@endif
		...
		<div class="mtourQuotePriceBarBox overflowX mobscroll">
			<div class="mtourQuotePriceBoxCont">
				<span class="mtourQuoteValue mtourQuotePriceBarCurency">
					<?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data2->option2_price,'adult')); ?>
				</span>
