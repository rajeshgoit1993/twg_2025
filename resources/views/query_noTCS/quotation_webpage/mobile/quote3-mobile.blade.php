	...
	<div class="mtourQuoteSummaryCont">
		<h4 class="mtourQuoteTitle">{{ $data3->custom_package_name }}</h4>
		<h5 class="mtourQuoteDaysBadge">{{ $data3->duration-1 }} Nights / {{ $data3->duration }} Days</h5>
	...
	<div class="mtourQuoteDatePricingCont">
		<div class="flexColumn">
			...
			<div class="mtourQuoteCityBox">
				...
				<h3 class="mtourQuoteCityName">{{ $data3->source }}</h3>
			</div>	
			<!--Tour Date-->
			...
			<div>
				<div class="makeflexCenterBewtween">
					...
					<p class="mtourQuotePriceValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data3->option3_price,'adult')); ?></p>
				</div>
				<div class="mtourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="mtourQuotePriceBoxSubHead">Discount (-)</p>
					<p class="mtourQuotePriceValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data3->option3_price,'adult')); ?></p>
				</div>
				<!--<div class="mtourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
				...
				<div class="flexBetween">
					...
					<p class="mtourQuotePriceTagline">( {{ $data3->anything }} )</p>
					</div>
					<div>
					<p class="mtourQuotePriceTotalValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data3->option3_price,'adult')); ?></p>
					</div>
				</div>
			</div>
			...
			<div>
				<div class="makeflexCenterBewtween">
					...
					?>
					<p class="mtourQuotePriceValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option3_total); ?></p>
				</div>
				<div class="mtourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="mtourQuotePriceBoxSubHead">Discount (-)</p>
					...
					?>
					<p class="mtourQuotePriceValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option3_total_discount); ?></p>
				</div>
				<!--<div class="mtourQuotePriceSeparator"></div>
				<div class="makeflexCenterBewtween">
					<p class="mtourQuotePriceBoxSubHead">GST (5%)</p>
				...
				<div class="makeflexCenterBewtween">
					<p class="mtourQuotePriceTotal">Grand Total</p>
					<p class="mtourQuotePriceTotalValue"><span class="mtourQuoteDefaultCurency">&nbsp;</span><?php CustomHelpers::get_indian_currency($option3_total-$option3_total_discount); ?></p>
				</div>
			</div>
			@endif
			<i>
		...
		@if($data3->option3_validaty!="")
			<div class="mtourQuoteValidity">QUOTE VALIDITY - {{ date("d M Y", strtotime($data3->option3_validaty)) }}</div>
		@endif
		<!--Quote Validity ends-->
	</div>
	...
	<div class="mtourQuoteFlightCont">
		<h3 class="mtourQuoteFlightHead">{{ $data3->option3_transport }}</h3>
		<div class="mtourQuoteTransportBox">
			<p class="mtransportDesc">{{ $data3->option3_transport_description }}</p>
		</div>
	</div>
	@endif
	...
	<div class="mtourQuoteBookPolicyCont">
		...
		<div class="mfoldableContent mtourQuotePolicyBox">
			...
			@endforeach
			<div class="mtourQuoteAddPolicy">{{ $data3->option3_visa_policies }}</div>
		</div>
	</div>
	...
	<div class="mtourQuoteBookPolicyCont">
		...
		@else
			...
			@endforeach
				<div class="mtourQuoteAddPolicy">{{ $data3->option3_payment_policies }}</div>
				<div class="mtourQuotePolicySeparator"></div>
		@endif
		...
		@else
			...
			@endforeach
				<div class="mtourQuoteCancelAddPolicy">{{ $data3->option3_cancellation }}</div>
		@endif
	...
	<div class="mtourQuoteBookPolicyCont">
		...
		@endforeach
			<div class="mtourQuoteAddPolicy">{{ $data3->option3_extra_imp }}</div>
			<!--<div class="mtourQuotePolicySeparator"></div>-->
		</div>
	</div>
	@endif
		...
		<div class="mtourQuotePriceBarBox overflowX mobscroll">
			<div class="mtourQuotePriceBoxCont">
				<span class="mtourQuoteValue mtourQuotePriceBarCurency">
					<?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data3->option3_price,'adult')); ?>
				</span>
