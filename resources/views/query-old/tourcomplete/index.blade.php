...
<option value="tour_completed" @if($query->status=="tour_completed") selected @endif>Tour completed</option> <option value="vouchers_issued" @if($query->status=="vouchers_issued") selected @endif>Vouchers Issued</option>
