...
<li style="float: left;list-style: none;margin-left: 0px;font-size: 18px">
	<a href="https://www.theworldgateway.com/" style="text-decoration: none;letter-spacing: 1px;font-weight: bold;color: #000;">TheWorldGateway.com</a></li>
...
<li style="float: left;list-style: none;">
	<a href="{{url('/TheWorldGateway/'.$data->unique_code)}}" target="_blank" style="text-decoration: none;font-weight: bold;color: #fff;background: #08b2ed;padding: 8px 12px;font-size: 18px ">Access Your Quote</a></li>
...
<p class="mobile_font" style="font-size: 17px" >Below is the link to the original quote in case you have lost track of it, <a href="{{url('/TheWorldGateway/'.$data->unique_code)}}" target="_blank">you can review the details here</a></p>
<?php
...
<p class="mobile_font" style="margin:2px 0px;font-size: 17px">Package Price : Rs. <?php
          CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data->option1_price,'adult'));
            ?>
            	
            </p>
 <p class="mobile_font" style="margin:2px 0px;font-size: 17px">Discounts : Rs.  <?php
    CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data->option1_price,'adult'));
     ?>
            	
            </p>
  <p class="mobile_font" style="margin:2px 0px;font-size: 17px">Total : Rs. <?php
      CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data->option1_price,'adult'));
		?> 
...
<h2><a href="{{url('/TheWorldGateway/'.$data->unique_code)}}" target="_blank">Click Here to View Your Quote</a></h2>
</td>
