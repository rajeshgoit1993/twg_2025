    ...
    @if($loged_user->lock_before_quote_send=='')
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="lead-input-text fullWidth" id="email" name="email" value="{{ old('name', $data->email) }}" placeholder="Enter email id" />
            </div>
        </div>
            ...
            <div class="form-group">
                <div class="makeflex">
                    ...
                    <div class="fullWidth">
                        ...
                        <input type="text" class="lead-input-text fullWidth" id="mobile" name="mobile" value="{{ old('name', $data->mobile) }}" placeholder="Enter mobile number" />
                    </div>
                </div>
            </div>
        </div>
