...
<div id="enquiryDisplay" class="readonly-mode"> <!-- Use class "readonly-mode" when needed -->
    ...
    <input type="hidden" value="{{ $data->id }}" name="query_id" id="query_id" />
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="lead-input-text fullWidth" id="name" name="name" value="{{ old('name', ucwords(strtolower($data->name))) }}" placeholder="Enter name" required />
        </div>
    </div>
    ...
    @if($loged_user->lock_before_quote_send == '')
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="lead-input-text fullWidth" id="email" name="email" value="{{ old('email', strtolower($data->email)) }}"  placeholder="Enter email id" />
            </div>
        </div>
                ...
                <div class="makeflex">
                    <div style="margin-right: 5px;">
                        ...
                        <select class="lead-input-text fullWidth" name="country_code">
                            ...
                            @foreach ($data_country_code as $single)
                                <option value="{{ $single->phonecode }}" 
                                    @if($single->phonecode == old('country_code', $data->country_code)) selected @endif>
                                    {{ $single->name }} (+{{ $single->phonecode }})
                                </option>
                            @endforeach
                        </select>
                    </div>
    ...
    @else
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="lead-input-text fullWidth" id="email" name="email" value="{{ old('email', CustomHelpers::partiallyHideEmail(strtolower($data->email))) }}" placeholder="Enter email id" />
            </div>
        </div>
            ...
            <select class="lead-input-text fullWidth" name="country_of_residence">
                ...
                @foreach ($data_country_code as $single)
                    <option value="{{ $single->name }}" 
                        @if($single->name == old('country_of_residence', $data->country_of_residence)) selected @endif>
                        {{ $single->name }}
                    </option>
                @endforeach
            </select>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="lead-input-text fullWidth" id="city_of_residence" name="city_of_residence" value="{{ old('city_of_residence', ucwords(strtolower($data->city_of_residence))) }}" placeholder="Enter starting city" required />
        </div>
    </div>    
