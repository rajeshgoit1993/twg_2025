...
<div class="tab-pane active" id="option2" >
	<div class="col-md-12">
		<form action="{{URL::to('/copy_option2')}}" method="post" id="quo1" name="quo1">
			...
			<div class="panel-group" id="accordion">
						...
						<tr>
							...
							<td>
								<select class="form-control price_type" name="price_type" style="background: #f2f2f2">
									<option @if($reference_data->option2_price_type=="Per Person") selected  @endif value="Per Person">Per Person</option>
									<option @if($reference_data->option2_price_type=="Group Price") selected  @endif value="Group Price">Group Price</option>
								</select>
							</td>
					...
					<table class="table backend_custom_height">
						<thead>
							...
							<tbody>
								<tr>
									<td>Airfare</td>
									<?php $option2_price=unserialize($reference_data->option2_price); ?>
									<td class="makeflex">
										...
										@foreach($rates as $rate)
											<option value="{{ $rate-> id}}" @if($rate->id==$option2_price["query_air_curr"]) selected  @endif c_val="{{$rate->rate}}">{{ $rate-> currency}}</option>
										@endforeach
										</select>
									...
									<td><input type="text" class="form-control query_air_adult" name="price[query_air_adult]" @if($option2_price["query_air_adult"]!="") value="{{$option2_price["query_air_adult"]}}" @endif></td>
									<td><input type="text" class="form-control query_air_exadult" name="price[query_air_exadult]" @if($option2_price["query_air_exadult"]!="") value="{{$option2_price["query_air_exadult"]}}" @endif></td>
									<td><input type="text" class="form-control query_air_childbed" name="price[query_air_childbed]" @if($option2_price["query_air_childbed"]!="") value="{{$option2_price["query_air_childbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_air_childwbed" name="price[query_air_childwbed]" @if($option2_price["query_air_childwbed"]!="") value="{{$option2_price["query_air_childwbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_air_infant" name="price[query_air_infant]" @if($option2_price["query_air_infant"]!="") value="{{$option2_price["query_air_infant"]}}" @endif></td>
									<td><input type="text" class="form-control query_air_single" name="price[query_air_single]" @if($option2_price["query_air_single"]!="") value="{{$option2_price["query_air_single"]}}" @endif></td>
								</tr>
							...
							<tbody>
								<tr>
									...
									<td><input type="text" class="form-control query_cruise_adult" name="price[query_cruise_adult]" @if(array_key_exists("query_cruise_adult",$option2_price))  @if($option2_price["query_cruise_adult"]!="") value="{{$option2_price["query_cruise_adult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruise_exadult" name="price[query_cruise_exadult]" @if(array_key_exists("query_cruise_exadult",$option2_price))  @if($option2_price["query_cruise_exadult"]!="") value="{{$option2_price["query_cruise_exadult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruise_childbed" name="price[query_cruise_childbed]" @if(array_key_exists("query_cruise_childbed",$option2_price))  @if($option2_price["query_cruise_childbed"]!="") value="{{$option2_price["query_cruise_childbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruise_childwbed" name="price[query_cruise_childwbed]" @if(array_key_exists("query_cruise_childwbed",$option2_price))  @if($option2_price["query_cruise_childwbed"]!="") value="{{$option2_price["query_cruise_childwbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruise_infant" name="price[query_cruise_infant]" @if(array_key_exists("query_cruise_infant",$option2_price))  @if($option2_price["query_cruise_infant"]!="") value="{{$option2_price["query_cruise_infant"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruise_single" name="price[query_cruise_single]" @if(array_key_exists("query_cruise_single",$option2_price))  @if($option2_price["query_cruise_single"]!="") value="{{$option2_price["query_cruise_single"]}}" @endif @endif></td>
								</tr>
								<tr>
									<td>Port Charges </td>
									<td class="makeflex">
									...
									<td><input type="text" class="form-control query_cruiseport_adult" name="price[query_cruiseport_adult]" @if(array_key_exists("query_cruiseport_adult",$option2_price))  @if($option2_price["query_cruiseport_adult"]!="") value="{{$option2_price["query_cruiseport_adult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruiseport_exadult" name="price[query_cruiseport_exadult]" @if(array_key_exists("query_cruiseport_exadult",$option2_price))  @if($option2_price["query_cruiseport_exadult"]!="") value="{{$option2_price["query_cruiseport_exadult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruiseport_childbed" name="price[query_cruiseport_childbed]" @if(array_key_exists("query_cruiseport_childbed",$option2_price))  @if($option2_price["query_cruiseport_childbed"]!="") value="{{$option2_price["query_cruiseport_childbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruiseport_childwbed" name="price[query_cruiseport_childwbed]" @if(array_key_exists("query_cruiseport_childwbed",$option2_price))  @if($option2_price["query_cruiseport_childwbed"]!="") value="{{$option2_price["query_cruiseport_childwbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruiseport_infant" name="price[query_cruiseport_infant]" @if(array_key_exists("query_cruiseport_infant",$option2_price))  @if($option2_price["query_cruiseport_infant"]!="") value="{{$option2_price["query_cruiseport_infant"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruiseport_single" name="price[query_cruiseport_single]" @if(array_key_exists("query_cruiseport_single",$option2_price))  @if($option2_price["query_cruiseport_single"]!="") value="{{$option2_price["query_cruiseport_single"]}}" @endif @endif></td>
								</tr>
								<tr>
									<td>Gratuity</td>
									<td class="makeflex">
									...
									<td><input type="text" class="form-control query_cruisegratuity_adult" name="price[query_cruisegratuity_adult]" @if(array_key_exists("query_cruisegratuity_adult",$option2_price))  @if($option2_price["query_cruisegratuity_adult"]!="") value="{{$option2_price["query_cruisegratuity_adult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegratuity_exadult" name="price[query_cruisegratuity_exadult]" @if(array_key_exists("query_cruisegratuity_exadult",$option2_price))  @if($option2_price["query_cruisegratuity_exadult"]!="") value="{{$option2_price["query_cruisegratuity_exadult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegratuity_childbed" name="price[query_cruisegratuity_childbed]" @if(array_key_exists("query_cruisegratuity_childbed",$option2_price))  @if($option2_price["query_cruisegratuity_childbed"]!="") value="{{$option2_price["query_cruisegratuity_childbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegratuity_childwbed" name="price[query_cruisegratuity_childwbed]" @if(array_key_exists("query_cruisegratuity_childwbed",$option2_price))  @if($option2_price["query_cruisegratuity_childwbed"]!="") value="{{$option2_price["query_cruisegratuity_childwbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegratuity_infant" name="price[query_cruisegratuity_infant]" @if(array_key_exists("query_cruisegratuity_infant",$option2_price))  @if($option2_price["query_cruisegratuity_infant"]!="") value="{{$option2_price["query_cruisegratuity_infant"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegratuity_single" name="price[query_cruisegratuity_single]" @if(array_key_exists("query_cruisegratuity_single",$option2_price))  @if($option2_price["query_cruisegratuity_single"]!="") value="{{$option2_price["query_cruisegratuity_single"]}}" @endif @endif></td>
								</tr>
								<tr>
									<td>Cruise GST </td>
									<td class="makeflex">
									...
									<td><input type="text" class="form-control query_cruisegst_adult" name="price[query_cruisegst_adult]" @if(array_key_exists("query_cruisegst_adult",$option2_price))  @if($option2_price["query_cruisegst_adult"]!="") value="{{$option2_price["query_cruisegst_adult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegst_exadult" name="price[query_cruisegst_exadult]" @if(array_key_exists("query_cruisegst_exadult",$option2_price))  @if($option2_price["query_cruisegst_exadult"]!="") value="{{$option2_price["query_cruisegst_exadult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegst_childbed" name="price[query_cruisegst_childbed]" @if(array_key_exists("query_cruisegst_childbed",$option2_price))  @if($option2_price["query_cruisegst_childbed"]!="") value="{{$option2_price["query_cruisegst_childbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegst_childwbed" name="price[query_cruisegst_childwbed]" @if(array_key_exists("query_cruisegst_childwbed",$option2_price))  @if($option2_price["query_cruisegst_childwbed"]!="") value="{{$option2_price["query_cruisegst_childwbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegst_infant" name="price[query_cruisegst_infant]" @if(array_key_exists("query_cruisegst_infant",$option2_price))  @if($option2_price["query_cruisegst_infant"]!="") value="{{$option2_price["query_cruisegst_infant"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_cruisegst_single" name="price[query_cruisegst_single]" @if(array_key_exists("query_cruisegst_single",$option2_price))  @if($option2_price["query_cruisegst_single"]!="") value="{{$option2_price["query_cruisegst_single"]}}" @endif @endif></td>
								</tr>
							</tbody>
								<!--Cruise End-->
							<tbody>	
								<tr>
									...
									<td><input type="text" class="form-control query_hotel_adult" name="price[query_hotel_adult]" @if($option2_price["query_hotel_adult"]!="") value="{{$option2_price["query_hotel_adult"]}}" @endif id="option2_mandate"></td>
									<td><input type="text" class="form-control query_hotel_exadult" name="price[query_hotel_exadult]" @if($option2_price["query_hotel_exadult"]!="") value="{{$option2_price["query_hotel_exadult"]}}" @endif></td>
									<td><input type="text" class="form-control query_hotel_childbed" name="price[query_hotel_childbed]" @if($option2_price["query_hotel_childbed"]!="") value="{{$option2_price["query_hotel_childbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_hotel_childwbed" name="price[query_hotel_childwbed]" @if($option2_price["query_hotel_childwbed"]!="") value="{{$option2_price["query_hotel_childwbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_hotel_infant" name="price[query_hotel_infant]" @if($option2_price["query_hotel_infant"]!="") value="{{$option2_price["query_hotel_infant"]}}" @endif></td>
									<td><input type="text" class="form-control query_hotel_single" name="price[query_hotel_single]" @if($option2_price["query_hotel_single"]!="") value="{{$option2_price["query_hotel_single"]}}" @endif></td>
								</tr>
								<tr>
									<td>Sightseeing</td>
									<td class="makeflex">
									...
									<td><input type="text" class="form-control query_tours_adult" name="price[query_tours_adult]" @if($option2_price["query_tours_adult"]!="") value="{{$option2_price["query_tours_adult"]}}" @endif></td>
									<td><input type="text" class="form-control query_tours_exadult" name="price[query_tours_exadult]" @if($option2_price["query_tours_exadult"]!="") value="{{$option2_price["query_tours_exadult"]}}" @endif></td>
									<td><input type="text" class="form-control query_tours_childbed" name="price[query_tours_childbed]" @if($option2_price["query_tours_childbed"]!="") value="{{$option2_price["query_tours_childbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_tours_childwbed" name="price[query_tours_childwbed]" @if($option2_price["query_tours_childwbed"]!="") value="{{$option2_price["query_tours_childwbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_tours_infant" name="price[query_tours_infant]" @if($option2_price["query_tours_infant"]!="") value="{{$option2_price["query_tours_infant"]}}" @endif></td>
									<td><input type="text" class="form-control query_tours_single" name="price[query_tours_single]" @if($option2_price["query_tours_single"]!="") value="{{$option2_price["query_tours_single"]}}" @endif></td>
								</tr>
								<tr>
									<td>Transfers</td>
									<td class="makeflex">
									...
									<td><input type="text" class="form-control query_transfer_adult" name="price[query_transfer_adult]" @if($option2_price["query_transfer_adult"]!="") value="{{$option2_price["query_transfer_adult"]}}" @endif></td>
									<td><input type="text" class="form-control query_transfer_exadult" name="price[query_transfer_exadult]" @if($option2_price["query_transfer_exadult"]!="") value="{{$option2_price["query_transfer_exadult"]}}" @endif></td>
									<td><input type="text" class="form-control query_transfer_childbed" name="price[query_transfer_childbed]" @if($option2_price["query_transfer_childbed"]!="") value="{{$option2_price["query_transfer_childbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_transfer_childwbed" name="price[query_transfer_childwbed]" @if($option2_price["query_transfer_childwbed"]!="") value="{{$option2_price["query_transfer_childwbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_transfer_infant" name="price[query_transfer_infant]" @if($option2_price["query_transfer_infant"]!="") value="{{$option2_price["query_transfer_infant"]}}" @endif></td>
									<td><input type="text" class="form-control query_transfer_single" name="price[query_transfer_single]" @if($option2_price["query_transfer_single"]!="") value="{{$option2_price["query_transfer_single"]}}" @endif></td>
								</tr>
								<tr>
									<td>Visa Charges</td>
									<td class="makeflex">
									...
									<td><input type="text" class="form-control query_visa_adult" name="price[query_visa_adult]" @if($option2_price["query_visa_adult"]!="") value="{{$option2_price["query_visa_adult"]}}" @endif></td>
									<td><input type="text" class="form-control query_visa_exadult" name="price[query_visa_exadult]" @if($option2_price["query_visa_exadult"]!="") value="{{$option2_price["query_visa_exadult"]}}" @endif></td>
									<td><input type="text" class="form-control query_visa_childbed" name="price[query_visa_childbed]" @if($option2_price["query_visa_childbed"]!="") value="{{$option2_price["query_visa_childbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_visa_childwbed" name="price[query_visa_childwbed]" @if($option2_price["query_visa_childwbed"]!="") value="{{$option2_price["query_visa_childwbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_visa_infant" name="price[query_visa_infant]" @if($option2_price["query_visa_infant"]!="") value="{{$option2_price["query_visa_infant"]}}" @endif></td>
									<td><input type="text" class="form-control query_visa_single" name="price[query_visa_single]" @if($option2_price["query_visa_single"]!="") value="{{$option2_price["query_visa_single"]}}" @endif></td>
								</tr>
								<tr>
									...
									<td><input type="text" class="form-control query_inc_adult" name="price[query_inc_adult]" @if($option2_price["query_inc_adult"]!="") value="{{$option2_price["query_inc_adult"]}}"  @endif></td>
									<td><input type="text" class="form-control query_inc_exadult" name="price[query_inc_exadult]" @if($option2_price["query_inc_exadult"]!="") value="{{$option2_price["query_inc_exadult"]}}" @endif></td>
									<td><input type="text" class="form-control query_inc_childbed" name="price[query_inc_childbed]" @if($option2_price["query_inc_childbed"]!="") value="{{$option2_price["query_inc_childbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_inc_childwbed" name="price[query_inc_childwbed]" @if($option2_price["query_inc_childwbed"]!="") value="{{$option2_price["query_inc_childwbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_inc_infant" name="price[query_inc_infant]" @if($option2_price["query_inc_infant"]!="") value="{{$option2_price["query_inc_infant"]}}" @endif></td>
									<td><input type="text" class="form-control query_inc_single" name="price[query_inc_single]" @if($option2_price["query_inc_single"]!="") value="{{$option2_price["query_inc_single"]}}" @endif></td>
								</tr>
								<!--Meals  Start-->
								<tr>
									<td>Meals</td>
									...
									<td><input type="text" class="form-control query_meals_adult" name="price[query_meals_adult]" @if(array_key_exists("query_meals_adult",$option2_price))  @if($option2_price["query_meals_adult"]!="") value="{{$option2_price["query_meals_adult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_meals_exadult" name="price[query_meals_exadult]" @if(array_key_exists("query_meals_exadult",$option2_price))  @if($option2_price["query_meals_exadult"]!="") value="{{$option2_price["query_meals_exadult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_meals_childbed" name="price[query_meals_childbed]" @if(array_key_exists("query_meals_childbed",$option2_price))  @if($option2_price["query_meals_childbed"]!="") value="{{$option2_price["query_meals_childbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_meals_childwbed" name="price[query_meals_childwbed]" @if(array_key_exists("query_meals_childwbed",$option2_price))  @if($option2_price["query_meals_childwbed"]!="") value="{{$option2_price["query_meals_childwbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_meals_infant" name="price[query_meals_infant]" @if(array_key_exists("query_meals_infant",$option2_price))  @if($option2_price["query_meals_infant"]!="") value="{{$option2_price["query_meals_infant"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_meals_single" name="price[query_meals_single]" @if(array_key_exists("query_meals_single",$option2_price))  @if($option2_price["query_meals_single"]!="") value="{{$option2_price["query_meals_single"]}}" @endif @endif></td>
								</tr>
								<!--Meals End-->
								<!--Additional Service-->
								<tr>
								...
								<tr>
									...
									<td><input type="text" class="form-control query_markup_adult" name="price[query_markup_adult]" @if(array_key_exists("query_markup_adult",$option2_price))  @if($option2_price["query_markup_adult"]!="") value="{{$option2_price["query_markup_adult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_markup_exadult" name="price[query_markup_exadult]" @if(array_key_exists("query_markup_exadult",$option2_price))  @if($option2_price["query_markup_exadult"]!="") value="{{$option2_price["query_markup_exadult"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_markup_childbed" name="price[query_markup_childbed]" @if(array_key_exists("query_markup_childbed",$option2_price))  @if($option2_price["query_markup_childbed"]!="") value="{{$option2_price["query_markup_childbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_markup_childwbed" name="price[query_markup_childwbed]" @if(array_key_exists("query_markup_childwbed",$option2_price))  @if($option2_price["query_markup_childwbed"]!="") value="{{$option2_price["query_markup_childwbed"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_markup_infant" name="price[query_markup_infant]" @if(array_key_exists("query_markup_infant",$option2_price))  @if($option2_price["query_markup_infant"]!="") value="{{$option2_price["query_markup_infant"]}}" @endif @endif></td>
									<td><input type="text" class="form-control query_markup_single" name="price[query_markup_single]" @if(array_key_exists("query_markup_single",$option2_price))  @if($option2_price["query_markup_single"]!="") value="{{$option2_price["query_markup_single"]}}" @endif @endif></td>
								</tr>
								<!--Total before GST-->
								<tr>
									...
									<td><input type="text" class="form-control query_total_adult" readonly="" name="price[query_total_adult]" value="{{CustomHelpers::get_quotation_total($reference_data->option2_price,'adult')}}"></td>
									<td><input type="text" class="form-control query_total_exadult" readonly="" name="price[query_total_exadult]" value="{{CustomHelpers::get_quotation_total($reference_data->option2_price,'exadult')}}"></td>
									<td><input type="text" class="form-control query_total_childbed" readonly="" name="price[query_total_childbed]" value="{{CustomHelpers::get_quotation_total($reference_data->option2_price,'childbed')}}"></td>
									<td><input type="text" class="form-control query_total_childwbed" readonly="" name="price[query_total_childwbed]" value="{{CustomHelpers::get_quotation_total($reference_data->option2_price,'childwbed')}}"></td>
									<td><input type="text" class="form-control query_total_infant" readonly="" name="price[query_total_infant]" value="{{CustomHelpers::get_quotation_total($reference_data->option2_price,'infant')}}"></td>
									<td><input type="text" class="form-control query_total_single" readonly="" name="price[query_total_single]" value="{{CustomHelpers::get_quotation_total($reference_data->option2_price,'single')}}"></td>
								</tr>
								<!--GST Starts-->
								<tr>
									...
									<td><input type="text" class="form-control query_gst_adult" name="price[query_gst_adult]" @if($option2_price["query_gst_adult"]!="") value="{{$option2_price["query_gst_adult"]}}" @endif></td>
									<td><input type="text" class="form-control query_gst_exadult" name="price[query_gst_exadult]" @if($option2_price["query_gst_exadult"]!="") value="{{$option2_price["query_gst_exadult"]}}" @endif></td>
									<td><input type="text" class="form-control query_gst_childbed" name="price[query_gst_childbed]" @if($option2_price["query_gst_childbed"]!="") value="{{$option2_price["query_gst_childbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_gst_childwbed" name="price[query_gst_childwbed]" @if($option2_price["query_gst_childwbed"]!="") value="{{$option2_price["query_gst_childwbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_gst_infant" name="price[query_gst_infant]" @if($option2_price["query_gst_infant"]!="") value="{{$option2_price["query_gst_infant"]}}" @endif></td>
									<td><input type="text" class="form-control query_gst_single" name="price[query_gst_single]" @if($option2_price["query_gst_single"]!="") value="{{$option2_price["query_gst_single"]}}" @endif></td>
								</tr>
								<!--Total after GST-->
								<tr>
								...
								<tr>
									...
									<td><input type="text" class="form-control query_discount_adult" name="price[query_discount_adult]" @if($option2_price["query_discount_adult"]!="") value="{{$option2_price["query_discount_adult"]}}" @endif></td>
									<td><input type="text" class="form-control query_discount_exadult" name="price[query_discount_exadult]" @if($option2_price["query_discount_exadult"]!="") value="{{$option2_price["query_discount_exadult"]}}" @endif></td>
									<td><input type="text" class="form-control query_discount_childbed" name="price[query_discount_childbed]" @if($option2_price["query_discount_childbed"]!="") value="{{$option2_price["query_discount_childbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_discount_childwbed" name="price[query_discount_childwbed]" @if($option2_price["query_discount_childwbed"]!="") value="{{$option2_price["query_discount_childwbed"]}}" @endif></td>
									<td><input type="text" class="form-control query_discount_infant" name="price[query_discount_infant]" @if($option2_price["query_discount_infant"]!="") value="{{$option2_price["query_discount_infant"]}}" @endif></td>
									<td><input type="text" class="form-control query_discount_single" name="price[query_discount_single]" @if($option2_price["query_discount_single"]!="") value="{{$option2_price["query_discount_single"]}}" @endif></td>
								</tr>
							<tbody>
								<!--Grand Total-->
								<tr>
									...
									<td><input type="text" class="form-control query_grand_adult" readonly="" name="price[query_grand_adult]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option2_price,'adult')}}"></td>
									<td><input type="text" class="form-control query_grand_exadult" readonly="" name="price[query_grand_exadult]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option2_price,'exadult')}}"></td>
									<td><input type="text" class="form-control query_grand_childbed" readonly="" name="price[query_grand_childbed]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option2_price,'childbed')}}"></td>
									<td><input type="text" class="form-control query_grand_childwbed" readonly="" name="price[query_grand_childwbed]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option2_price,'childwbed')}}"></td>
									<td><input type="text" class="form-control query_grand_infant" readonly="" name="price[query_grand_infant]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option2_price,'infant')}}"></td>
									<td><input type="text" class="form-control query_grand_single" readonly="" name="price[query_grand_single]" value="{{CustomHelpers::get_quotation_grandtotal($reference_data->option2_price,'single')}}"></td>
								</tr>
								<!--Price to Pay-->
								<tr>
				...
				<!--Tour Accommodation-->
				<?php
					$option2_accommodation=unserialize($reference_data->option2_accommodation);
							...
							<div class="dynamic_acc">
								...
								<div class="field{{$j}}" id="{{$j}}">
									<div class="row">
										...
										<div class="col-md-4 appendBottom10">
											<label>City</label>
												<input type="text" name="accommodation[{{$j}}][city]" class="form-control query_city" placeholder="Enter city name" value="{{$option2_accommodation[$j]["city"]}}" />
										</div>
										<div class="col-md-4 appendBottom10">
											...
											<select class="form-control" name="accommodation[{{$j}}][trip]">
												...
												<option value="Manually" @if($option2_accommodation[$j]["trip"]=="Manually") selected @endif>Database</option>  
												<option value="TripAdvisor" @if($option2_accommodation[$j]["trip"]=="TripAdvisor") selected @endif>TripAdvisor</option>
											</select>
										</div>
										<div class="col-md-4 appendBottom10">
											<label>Hotel</label>
											<?php $query_data=CustomHelpers::get_quotation_hotel($option2_accommodation[$j]["city"]); ?>
										...
										<div class="col-md-4 appendBottom10" style="display: block;">
											<label>Enter Hotel</label>
												<input type="text" class="form-control" name="accommodation[{{$j}}][other_hotel]" placeholder="Enter hotel name" value="{{$option2_accommodation[$j]["other_hotel"]}}">
										</div>
										@else
										...
										<div class="col-md-4 add_star" style="display: none;">
											<label>Enter Star Rating</label>
												<input type="text" class="form-control" name="accommodation[{{$j}}][star_other]" value="{{$option2_accommodation[$j]["star_other"]}}" placeholder="Enter hotel star rating">
										</div>
										@endif
										<div class="col-md-4 appendBottom10">
											<label>Room Type</label>
												<input type="text" class="form-control" name="accommodation[{{$j}}][category]" placeholder="Enter room type" value="{{$option2_accommodation[$j]["category"]}}">
										</div> 
										<div class="col-md-4">
											<label>Hotel Website</label>
												<input type="text" class="form-control" name="accommodation[{{$j}}][hotel_link]" placeholder="Enter hotel website" @if($option2_accommodation!="" && array_key_exists("hotel_link",$option2_accommodation[$j])) value="{{$option2_accommodation[$j]["hotel_link"]}}" @endif>
										</div>
										@if($j>0)
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<select name="transport" class="form-control transport" id="transport">
											...
											<option value="{{ $trans->name }}" @if($trans->name==$reference_data->option2_transport) selected @endif>{{$trans->name}}</option>
											@endforeach
										</select>
									</div>
									@if($reference_data->option2_transport=="Flight")
									...
									<?php $flight=unserialize($reference_data->option2_flight); ?>
									<div class="flight">
										<!--Onward Flight-->
								...
								@else
									<div class="col-md-12">
									   <div class="oflight">
										  <textarea class="form-control" placeholder="Package Transport Description..." name="transport_description" id="" cols="30" rows="5">{{$reference_data->option2_transport_description}}</textarea>
										  <br>
									   </div>
									</div>
									<div class="flight">
				...
				<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									...
									@else
									   <div class="oflight">
										  <textarea class="form-control" placeholder="Tour Transfer Details..." name="transport_description" id="" cols="30" rows="5">{{$reference_data->option2_transport_description}}</textarea>
										  <br>
									   </div>
									@endif
								</div>
								...
								<div class="row">                          
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea class="form-control ckeditor" name="description" id="" cols="30" rows="5" >{!! $reference_data->option2_description !!}</textarea>
										</div>
										<div class="form-group">
											<label for="">Add Tour Highlights</label>
											<br>
											<span class="show_hide color8cff font-weight600">More+</span>
											<textarea class="form-control ckeditor" name="highlights" id="" cols="30" rows="5" >{!! $reference_data->option2_highlights !!}</textarea>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group select-container">
											...
											<br>
											<span class="show_hide color8cff font-weight600">More+</span>
											<textarea class="form-control ckeditor" name="inclusions" id="" cols="30" rows="5">{!! $reference_data->option2_inclusions !!}</textarea>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group ">
											...
											<br>
											<span class="show_hide color8cff font-weight600">More+</span>
											<textarea class="form-control ckeditor" name="exclusions" id="" cols="30" rows="5">{!! $reference_data->option2_exclusions !!}</textarea>
										</div>
									</div>
								</div>
							</div>
					...
					<!--Tour Itinerary-->
					<?php $option2_dayItinerary=unserialize($reference_data->option2_dayItinerary); ?>
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
											...
											<div class="col-md-12 day1">
												<div class="form-group font-weight600">DAY {{$j}}
													<div class="appendTop5">
														<input type="text" name="dayItinerary[day{{$j}}][title]" class="border1 borderradius3 appendTop5" style="width: 100%;height: 30px;padding: 0 10px;" placeholder="Day Title" @if($option2_dayItinerary!="" && array_key_exists("day$j",$option2_dayItinerary)) value="{{$option2_dayItinerary["day$j"]["title"]}}" @endif>
													</div>
												</div>
												<div class="form-group">
													...
													@if($option2_dayItinerary!="" && array_key_exists("day$j",$option2_dayItinerary)) {!! $option2_dayItinerary["day$j"]["desc"] !!} @endif
													</textarea>
												</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											<label for="">Is Visa Required?</label>
												<input type="checkbox" name="visa" value="1" id="visa" class="visa" "@if($reference_data->option2_visa=="1") checked @endif />
										</div>
										<div class="visa_pol" @if($reference_data->option2_visa=="1") style="display:block" @endif>
											...
											<table class="table table-bordered" id="dynamic_field">
												<tbody>
													<tr>
														<td style="width: 60%;">
														<div>
															<?php $option2_package_visa=unserialize($reference_data->option2_package_visa); ?>
															<select name="package_visa[]" class="select2 form-control" multiple>
																@foreach($visaPolicy as $pol)
																	<option value="{{$pol->id}}" @if($option2_package_visa!="" && in_array("$pol->id",$option2_package_visa)) selected @endif>{{$pol->policy}}</option>
																@endforeach
															</select>
														</div>
														</td>
													...
													<tr>
														<td>
															...
															<br>
															<textarea  name="visa_policies" placeholder="Please state your Extra visa Policies..." rows="6" class="form-control hide_text">{{$reference_data->option2_visa_policies}}</textarea>
										...
										<table class="table table-bordered">
											<tbody>
												<tr>
													<td style="width: 60%;">
														<div>
															<?php $option2_package_payment=unserialize($reference_data->option2_package_payment); ?>
															<select name="package_payment[]"  class="select2 form-control" multiple>
															@foreach($paymentPolicy as $pol)
															<option value="{{$pol->id}}" @if($option2_package_payment!="" && in_array("$pol->id",$option2_package_payment)) selected @endif >{{$pol->policy}}</option>
															@endforeach
															</select>
														</div>
													</td>
												...
												<tr>
													<td>
														<span class="show_hides color8cff font-weight600">More+</span>
														<br>
														<textarea name="payment_policies" placeholder="Please state your Payment Terms and Methods..." rows="6" class="form-control hide_text">{{$reference_data->option2_payment_policies}}</textarea>
										...
										<table class="table table-bordered" id="dynamic_field">
											<tbody>
												<tr>
													<td style="width: 60%;">
														<div>
															<?php $option2_package_can=unserialize($reference_data->option2_package_can); ?>
															<select name="package_can[]" class="select2 form-control" multiple>
															@foreach($cancelPolicy as $pol)
															<option value="{{$pol->id}}" @if($option2_package_can!="" && in_array("$pol->id",$option2_package_can)) selected @endif >{{$pol->policy}}</option>
															@endforeach
															</select>
														</div>
													</td>
										...
										<table class="table table-bordered">
											<tbody>
												<tr>
													<td style="width: 60%;">
														<div>
															<?php $option2_package_impnotes=unserialize($reference_data->option2_package_impnotes); ?>
												...
												<tr>
													<td>
														<span class="show_hides color8cff font-weight600">More+</span>
														<br>
														<textarea  name="extra_imp" placeholder="Please state your Important Notes..." rows="6" class="form-control hide_text">{{$reference_data->option2_extra_imp}}</textarea>
									...
									<div class="col-md-12">
										<div class="form-group">
											<label for="">Quote Validity</label>
												<input type="text" class="datepickers" name="validaty" value="{{$reference_data->option2_validaty}}">>
										</div>
										<br>
									</div>
								</div>
											...
											<tbody>
												<tr>
													<td>
														...
														<span class="show_hide color8cff font-weight600">More+</span>
														<br>
														<textarea name="quotation_header_extra" placeholder="Please state your Extra Quotation Header..." rows="6" class="form-control ckeditor">{!! $reference_data->option2_quotation_header_extra !!}</textarea>
														<!-- <input type="hidden" name="visa_policies" id="visa_policies_input" value=""/>-->
													</td>
												</tr>
												<tr>
													<td style="width: 60%;">
														...
														<br>
														<div>
															<?php $option2_quotation_header=unserialize($reference_data->option2_quotation_header); ?>
															<select name="quotation_header[]" class="select2 form-control" multiple>
															@foreach($quotation_header as $pol)
															<option value="{{$pol->id}}" @if($option2_quotation_header!="" && in_array("$pol->id",$option2_quotation_header)) selected @endif >{{$pol->header}}</option>
															@endforeach
															</select>
														</div>
													</td>
											...
											<tbody>
												<tr>
													<td>
														...
														<span class="show_hide color8cff font-weight600">More+</span>
														<br>
														<textarea name="quotation_footer_extra" placeholder="Please state your Extra Quotation Footer..." rows="6" class="form-control ckeditor">{!! $reference_data->option2_quotation_footer_extra !!}</textarea>
														<!-- <input type="hidden" name="visa_policies" id="visa_policies_input" value=""/>-->
													</td>
												</tr>
												<tr>
													<td style="width: 60%;">
														...
														<br>
														<div>
															<?php $option2_quotation_footer=unserialize($reference_data->option2_quotation_footer); ?>
															<select name="quotation_footer[]" class="select2 form-control" multiple>
															@foreach($quotation_footer as $pol)
															<option value="{{$pol->id}}" @if($option2_quotation_footer!="" && in_array("$pol->id",$option2_quotation_footer)) selected @endif>{{$pol->footer}}</option>
															@endforeach
															</select>
														</div>
													</td>
