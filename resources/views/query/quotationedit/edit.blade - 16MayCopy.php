		...
		<div class="col-md-12">
			<div class="box">
				<div class="makeflex aligncenter paddingAllTen">
					<a href="{{ URL::to('/Saved-Quote') }}" class="btnBack appendRight20"> Back</a>
					<span class="pfwmt font18">Edit & Add New Quote</span>
				</div>
...
// 	$("#quote1_total_payment").prop('disabled', true);
// })
//
...
var new_start_date=parseInt(new_val[1])-parseInt(days)+'/'+parseInt(new_val[0])+'/'+parseInt(new_val[2])
  ...
  $(this).parent().siblings('.payment_date_parent').children('.payment_date').datepicker({dateFormat:"dd/mm/yy"}).datepicker("setDate",new_start_date);
})
