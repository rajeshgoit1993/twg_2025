...
<!-- Main content -->
<?php
	$dept_date = str_replace(' ', '',$reference_data->tour_date);
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<div class="box">
				<div class="flexCenter padding10">
					<a href="{{ url()->previous() }}">
						<button class="btnBack">&nbsp;Back</button>
					</a>
					<div class="box-header">
						<!-- edit quote page -->
						<h3 class="box-title">Edit & Add New Quotation</h3>
					</div>
				</div>
				...
				<div class="navQuoteBar">
				    ...
				    <ul class="quoteType">
				        ...
				        @if(isset($reference_data) && $reference_data->status == "1")
				        <li class="tablinks quoteTab" id="defaultOpen" data-tab="quote2">
				            <span>Quote 2</span>							
				        </li>
				        @endif

				        @if(isset($reference_data) && $reference_data->status == "1" && isset($reference_data2) && $reference_data2->status == "1")
				        <li class="tablinks quoteTab" data-tab="quote2">
				            <span>Quote 3</span>							
				        </li>
				        @endif

				        @if(isset($reference_data) && $reference_data->status == "1" && isset($reference_data2) && $reference_data2->status == "1" && isset($reference_data3) && $reference_data3->status == "1")
				        <li class="tablinks quoteTab" data-tab="quote2">
				            <span>Quote 4</span>							
				        </li>
				        @endif
				...
				<div class="tabcontent" id="quote1">
					@include('query.quotationedit.editquote1')
				</div>
