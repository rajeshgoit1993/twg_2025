		<div class="quoteDtlsCont">
			...
			<form action="{{ URL::to('/copy_option1') }}" method="post" id="quo1" name="quo1">
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-pencil-square-o" aria-hidden="true"></i></span> Trip Details <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							<div class="row">
								<div class="col-md-3 apndBtm10">
									...
									<input type="text" class="form-control textCapitalize" name="custom_package_name" id="custom_package_name" placeholder="Enter Package Name" value="{{$reference_data->custom_package_name}}">
								</div>

								<div class="col-md-3 apndBtm10">
									<label for="sourcecity">Starting City <span class="requiredcolor">*</span></label>
									<select class="quote_city form-control" name="sourcecity" id="sourcecity" tabindex="1" required>
										<option value="{{$reference_data->sourcecity}}" selected>{{$reference_data->sourcecity}}</option>
									</select>
								</div>
								...
								<div class="col-md-3 apndBtm10">
									...
									<input type="hidden" value="{{$reference_data->tour_date}}" class="previous_tour_date">
									<input type="date" name="tour_date" id="tour_date" class="form-control tour_date" value="{{$reference_data->tour_date}}" placeholder="Tour Date" />
								</div>
								...
								<div class="col-md-12 apndBtm10">
									...
									<div class="input-group">
										...
										<select name="package_service[]" id="package_service" class="form-control select2 package_service" multiple>
											@if(count($icons)>0)
											<?php $package_service=unserialize($reference_data->package_service); ?>
								...
								<div class="col-md-12 apndBtm10">
									...
									<input type="text" class="form-control" name="admin_remarks" id="admin_remarks" placeholder="Enter Remarks (if any)..." value="{{$reference_data->admin_remarks}}">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-user-o" aria-hidden="true"></i></span> Guest Room <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							...
							<div class="roomGuests">
								...
								<input type="text" class="quote1_pop_passenger_value" 
										value="{{ CustomHelpers::get_seperate_pass($reference_data->id,1) }}" 
										placeholder="" 
										readonly />
							</div>
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-money" aria-hidden="true"></i> Tour Pricing <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
<?php $price_data=CustomHelpers::get_price_part_seperate($reference_data->option1_price,$reference_data->quote1_number_of_adult,$reference_data->extra_adult,$reference_data->child_with_bed,$reference_data->child_without_bed,$reference_data->infant,$reference_data->solo_traveller); ?>
					        ...
					        <div class="roomGuests">
					            ...
					            <select class="form-control bgF2 flexOne price_type" name="price_type">
					                <option value="1" @if($reference_data->price_type=='1') selected @endif>Per Person</option>
									<option value="2" @if($reference_data->price_type=='2') selected @endif>Group Price</option>
					            </select>

					            <!-- db table name: anything -->
					            <select class="form-control flexOne" name="priceremarks">
					            	<option value="1" @if($reference_data->anything=='1') selected @endif>Price Per Person (inclusive of taxes)</option>
									<option value="2" @if($reference_data->anything=='2') selected @endif>Price for all Person (inclusive of taxes)</option>
					            </select>
					            
					            <input type="text" class="form-control flexOne" name="remarks" value="{{ $reference_data->remarks }}" placeholder="Price Remarks (if any) ..." />
								...
								<thead>
									...
									<th>
										...
										<div class="currencyConversion">
											...
											<input type="text" name="total_value" class="bgF2 quote1_total number_test" value="{{ $reference_data->total_value}}" placeholder="Value" readonly>
										</div>
								...
								<tbody>
									...
									<tr>
										...
										<td class="makeflex">
											...
											<input type="hidden" name="price[coupon_id]" class="coupon_id" value="{{$price_data['coupon_id']}}">
											<select class="percentageValue number_test coupon_percentage" name="price[discount_coupon]">
												...
												<option coupon_id="{{$markup_pro->id}}" value="{{$markup_pro->value}}"
													@if($markup_pro->id==$price_data['coupon_id']) selected @endif>{{$markup_pro->coupon_name}}</option>
												@endforeach
											</select>
										</td>
							...
							<div class="backend_custom_height item-container">
								<div class="partPayment">
									<label for="partPayment">Part Payment?</label>
									<input type="checkbox" name="partPayment" value="1" id="show_part_payment" class="show_part_payment" @if($reference_data->partPayment==1) checked @endif >
								</div>

								<table class="part_payment table backend_custom_height table-bordered table-striped" @if($reference_data->partPayment==1) style="display:block" @else style="display:none" @endif>
									...
									<?php
										...
										$part_payments_sec=CustomHelpers::part_payments($reference_data->part_payments,$price_data['query_pricetopay_adult']);
									?>
		              				<tbody>
										...
										<tr>
											...
											<td class="payment_date_parent">
												<input type="text" name="part_payments[adv_date]" class="form-control payment_date datepicker_adv" @if($reference_data->part_payments!='' && array_key_exists('adv_date',$part_payments)) value="{{ $part_payments['adv_date'] }}" @endif>
											</td>
										</tr>
										...
										<tr>
											...
											<td class="payment_days_parent">
												<input type="hidden" name="part_payments[first_part_days]" class="days_data">           
											...
											<td class="payment_date_parent">
												<input type="text" name="part_payments[first_part_date]" class="form-control payment_date  datepicker_first_payment" @if($reference_data->part_payments!='' && array_key_exists('first_part_date',$part_payments)) value="{{ $part_payments['first_part_date'] }}" @endif>
											</td>
										</tr>
										...
										<tr class="">
											...
											<td class="payment_days_parent">
												<input type="hidden" name="part_payments[second_part_days]" class="days_data">
											...
											<td class="payment_date_parent">
												<input type="text" name="part_payments[second_part_date]" class="form-control payment_date  datepicker_second_payment" @if($reference_data->part_payments!='' && array_key_exists('second_part_date',$part_payments)) value="{{ $part_payments['second_part_date'] }}" @endif>
											</td>
										</tr>
							...
							<div class="backend_custom_height item-container">
								...
								<table class="direct_part table backend_custom_height table-bordered table-striped" @if($reference_data->directPayment==1) style="display:block" @else style="display:none" @endif>
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-bed" aria-hidden="true"></i> Trip Accommodation <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							<?php
							...
							<div class="dynamic_acc">
                                ...
                                @if($j>0)
                                @endif
								<div class="item-container makeflex field{{ $j }}" id="{{ $j }}">
									<div class="row">
										<!-- duration -->
										<div class="col-md-6 apndBtm10 relativeCont">
											<label>Duration</label>
											...
											<label class="label-duration">
												...
												@if($isAllDaysSelected) checked @endif />
											</label>

											<select class="form-control select_day select2" name="accommodation[{{$j}}][night][]" multiple>
												@for($i=1;$i<=$days;$i++)
												<option value="Night {{ $i }}" @if(array_key_exists('night',$col) && in_array("Night $i",$col["night"])) selected @endif>Night {{ $i }}</option>
												@endfor
											</select>
										</div>
										...
										<div class="col-md-3 apndBtm10 quote_city_class">
											<label>City</label>
											<select class="quote_city form-control" name="accommodation[{{$j}}][city]" required>
												<option @if(array_key_exists("city",$col)) value="{{$col['city']}}" @endif>@if(array_key_exists("city",$col)) {{$col['city']}} @endif</option>
											</select>
										</div>
										...
										<div class="col-md-4 apndBtm10 selectproperty" id="selectproperty" @if(array_key_exists('trip',$col) && $col['trip']=='packagehoteldatabase') style="display: block" @else style="display: none" @endif>
										...
										<div class="col-md-4 apndBtm10 selectpropertystar" id="selectpropertystar" 
											@if(array_key_exists('trip',$col) 
											&& $col['trip']=='packagehoteldatabase') 
										...
										<div class="col-md-4 apndBtm10 propertyname" id="propertyname"
											@if(array_key_exists('trip',$col) 
											&& $col['trip']=='manual') 
											style="display: block" @else style="display: none" @endif>
										...
										<div class="col-md-4 apndBtm10 selectpropertynamestar" id="selectpropertynamestar"
											@if(array_key_exists('trip',$col) 
											&& $col['trip']=='manual') 
											style="display: block" @else style="display: none" @endif>
										...
										<div class="col-md-4 apndBtm10 hotel_contact_class">
											...
											<input type="text" class="form-control hotel_contact" name="accommodation[{{$j}}][contact]" placeholder="Enter hotel contact no" value="{{$col['hotel_link']}}">
										</div>
										...
										@if($j>0)
											...
											<div class="col-md-4 appendTop20"><button type="button" name="add" id="{{$j}}" class="remove_acco btn btn-danger">- Remove room</button></div>
				...
				<!--Trip Flight-->
				<?php $flight_data=unserialize($reference_data->option1_flight); ?>
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-plane" aria-hidden="true"></i> Flight <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							<div class="row">
								...
								<div class="col-md-12 flight" @if(array_key_exists('flightOption',$flight_data) && $flight_data['flightOption']==1) style="display: block;" @else style="display: none;" @endif>
									...
									<div class="col-md-12">
										<div class="item-container">
											...
											<!-- Onward Flight -->
											<div class="row onwardflight" @if(array_key_exists('onward_required',$flight_data) && $flight_data['onward_required']==1) style="display: block;" @else style="display: none;" @endif>
												<div class="col-md-12 apndBtm10">
												...
												<div class="col-md-3 apndBtm20">
													...
													<div class="clearfix"></div>
														<select name="flight[dhours]" class="form-control dhours" style="max-width: 49%;display: inline-block;">
															...
															@for($i=1; $i<=24; $i++)
																<option value="{{ $i }}" @if(array_key_exists('dhours', $flight_data) && $flight_data['dhours'] == $i) selected @endif>
																	{{ $i }} {{ \Illuminate\Support\Str::plural('hour', $i) }}
																</option>
															@endfor
														</select>
									...
									<div class="col-md-12">
										<div class="item-container">
											...
											<!-- Return Flight -->
											<div class="row returnflight" @if(array_key_exists('return_required',$flight_data) && $flight_data['return_required']==1) style="display: block;" @else style="display: none;" @endif> 
												<div class="col-md-12 apndBtm10">
												...
												<div class="col-md-3 apndBtm20">
													...
													<select name="flight[dnumberstop]" class="form-control">
														<option value="" disabled>Select Stopover</option>
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-bus" aria-hidden="true"></i> Transfers (Car, Bus, Train) <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							<div class="row">
								<div class="col-md-12 transfers_input_wrapper">
									...
									<div class="item-container transfers_input" id="transfers_input-0" data-id="{{$a}}">
										<div class="row">
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-sticky-note-o" aria-hidden="true"></i> Trip Overview (Add-on Service & Highlights) <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							<div class="row">
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-plus-circle" aria-hidden="true"></i> Inclusions & Exclusions <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							<div class="row">
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-map-marker" aria-hidden="true"></i> Tour Itinerary <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							<div class="row">
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-info-circle" aria-hidden="true"></i></span> Trip Policies (Visa, Payment, Cancellation & Important Notes) <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							<div class="row">
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-calendar-times-o" aria-hidden="true"></i> Quote Validity <span class="requiredcolor">*</span>
					</div>
					<div class="panelBox">
						<div class="panelContent">
							<div class="item-container">
								<div class="row">
									...
									<div class="col-md-2">
										...
										<input type="text" class="datepicker_s form-control" name="validaty" value="{{ $reference_data->option1_validaty }}">
									</div>
									...
									<div class="col-md-3">
										...
										<div class="relativeCont">
											<span class="btn-time-reset-cont reset_class">
												@if($reference_data->validity_time!='23:59:59')
													<button type="button" class="btn-time-reset">Reset</button>
												@endif
											</span>
										</div>
										<input type="text" class="validity_time form-control" value="{{$reference_data->validity_time}}" id="timeInput" name="validity_time" pattern="^(?:[01]\d|2[0-3]):[0-5]\d:[0-5]\d$" placeholder="HH:MM:SS (24 Hours)" required />
									</div>
									    ...
									    <div class="pay-custom-radio-group makeflex">
									        <label class="pay-custom-radio flexOne">
									            <input type="radio" value="Yes" name="validity_show_on_frontend" 
									                @if($reference_data->validity_show_on_frontend == 'Yes') checked @endif />
									            <span class="pay-custom-radio-label">Yes</span>
									        </label>
									        <label class="pay-custom-radio flexOne">
									            <input type="radio" value="No" name="validity_show_on_frontend" 
									                @if($reference_data->validity_show_on_frontend == 'No') checked @endif />
				...
				<div class="panel-item-cont">
					<div class="accordion panelHeading down-arrow">
						<i class="fa fa-user" aria-hidden="true"></i></span> Greetings & Signature <span class="requiredcolor">*</span>
					</div>
