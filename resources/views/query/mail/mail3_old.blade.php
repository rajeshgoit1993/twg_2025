...
<p class="mobile_font" style="margin:2px 0px;font-size: 17px">Package Price : Rs. <?php
          CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data->option3_price,'adult'));
            ?>
            	
            </p>
 <p class="mobile_font" style="margin:2px 0px;font-size: 17px">Discounts : Rs.  <?php
    CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data->option3_price,'adult'));
     ?>
            	
            </p>
  <p class="mobile_font" style="margin:2px 0px;font-size: 17px">Total : Rs. <?php
      CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data->option3_price,'adult'));
		?> 
...
<?php
$footer=unserialize($data->option3_quotation_footer);
