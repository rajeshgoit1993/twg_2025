			...
			<table width="100%">
				...
				<tr>
					<td class="text" colspan="2">
						<!--welcome greetings-->
						@if($data!="" && $data->option3_quotation_header!="" && $data->option3_quotation_header!="N;")
						<?php
						$header=unserialize($data->option3_quotation_header);
						?>
						<!--@foreach($header as $header_data)
						{!! CustomHelpers::get_quotation_header($header_data) !!}
						@endforeach-->
						@endif
						{!! $data->option3_quotation_header_extra !!}
						...
						<!--price-->
						@if($data->option3_price_type=="Per Person")
						<div class="mobile_font">Package Price : <b>Rs. <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data->option3_price,'adult')); ?></b></div>
						<div class="mobile_font"><i>Discount(-) : <b>Rs. <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data->option3_price,'adult')); ?></b></i></div>
						<div class="mobile_font">Price To PAY : <b>Rs. <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data->option3_price,'adult')); ?></b></div>
						@elseif($data->option3_price_type=="Group Price")
							<?php
							$option3_adult=CustomHelpers::get_quotation_pricel($data->option3_price,'adult');
							$option3_extradult=CustomHelpers::get_quotation_pricel($data->option3_price,'exadult');
							$option3_child=CustomHelpers::get_quotation_pricel($data->option3_price,'childbed');
							$option3_childwithoutbed=CustomHelpers::get_quotation_pricel($data->option3_price,'childwbed');
							$option3_infant=CustomHelpers::get_quotation_pricel($data->option3_price,'infant');
							$option3_single=CustomHelpers::get_quotation_pricel($data->option3_price,'single');
							$option3_total=($option3_adult*2) + $option3_extradult + $option3_child + $option3_childwithoutbed + $option3_infant + $option3_single;
							?>
						<div class="mobile_font">Package Price : <b>Rs. <?php CustomHelpers::get_indian_currency($option3_total); ?></b></div>
						<!--Discount-->
							<?php
							$option3_adult_discount=CustomHelpers::get_quotation_discount($data->option3_price,'adult');
							$option3_extradult_discount=CustomHelpers::get_quotation_discount($data->option3_price,'exadult');
							$option3_child_discount=CustomHelpers::get_quotation_discount($data->option3_price,'childbed');
							$option3_childwithoutbed_discount=CustomHelpers::get_quotation_discount($data->option3_price,'childwbed');
							$option3_infant_discount=CustomHelpers::get_quotation_discount($data->option3_price,'infant');
							$option3_single_discount=CustomHelpers::get_quotation_discount($data->option3_price,'single');
							...
							?>
						<div class="mobile_font"><i>Discount(-) : <b>Rs. <?php CustomHelpers::get_indian_currency($option3_total_discount); ?></b></i></div>
						<!--Total Price-->
						<div class="mobile_font" style="margin-bottom: 0px;">Price To PAY : <b>Rs. <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data->option3_price,'adult')); ?></b></div>
						@endif
				...
				<tr>
					<td class="text" colspan="2">
						<!--Signature-->
						@if($data!="" && $data->option3_quotation_footer!="" && $data->option3_quotation_footer!="N;")
						<?php $footer=unserialize($data->option3_quotation_footer); ?>
						@endif
						{!! $data->option3_quotation_footer_extra !!}
					</td>
				</tr>
			</table>
		</div>
