...
<section style="background-color: #F9F9F9">
	<div class="destop_test_exp">
		<div style="padding-top: 10px;margin: 0px 4%;">
			<div class="quotation_red" style="background-color: #fff;border: 1px solid #CED0D4;border-bottom: none;border-radius: 10px 10px 0px 0px;padding: 20px 0px 0px 25px;margin: 0px">
				<h3 style="font-size: 20px;line-height: 20px;color: #4A4A4A;font-weight: 600;margin-bottom: 45px">Quote #{{ $data1->quo_ref }}</h3>
				<ul class="flexcenter">
					...
					<li class="active" style="padding-bottom: 15px;font-size: 18px;font-weight: 600;color: #CED0D4;border-bottom: 2px solid #CED0D4;margin-right: 2%"><a data-toggle="tab" href="#menu2">Quote 2</a></li>
				</ul>
			</div>
		</div>
		<div style="margin: 0px 4%;">
			<div class="" style="padding: 0px;">
				<div class="tab-content">
					<div id="menu2" class="tab-pane fade in active" style="padding: 0px;">
	...
	<div class="mobile_test_exp">
		<div style="padding-top: 3px;margin: 0px 0%;">
			<div class="" style="background-color: #fff;border-bottom: 1px solid #CED0D4;padding: 15px 0px 15px 25px;margin: 0px">
				<h3 class="pfwmt" style="font-size: 20px;line-height: 20px;color: #4A4A4A;">Quote #{{ $data1->quo_ref }}</h3>
			</div>
			<div class="" style="background-color: #fff;border-bottom: 1px solid #CED0D4;padding: 20px 0px 0px 25px;margin: 0px">
				<ul class="flexcenter">
					<li style="padding-bottom: 15px;font-size: 18px;font-weight: 600;color: #CED0D4;border-bottom: 2px solid #CED0D4;margin-right: 25px" data-toggle="tab" href="#menu3">Quote 1</a></li>
					<li class="active" style="padding-bottom: 15px;font-size: 18px;font-weight: 600;color: #CED0D4;border-bottom: 2px solid #CED0D4;margin-right: 2%"><a data-toggle="tab" href="#menu2">Quote 2</a></li>
				</ul>
			</div>
		</div>
	...
	<!--<div class="destop_test_exp" style="margin: 0px 4%;">
		<div class="" style="padding: 0px;">
			<div class="tab-content">
				<div id="menu2" class="tab-pane fade in active" style="padding: 0px;">
					@include("query.quotation_webpage.desktop.quote2-desktop")
	...
	<div class="mobile_test_exp" style="margin: 0px 0%;">
		<div class="" style="padding: 0px;">
			<div class="tab-content">
				<div id="menu2" class="tab-pane fade in active" style="padding: 0px;">
