...
<?php
$header=unserialize($data4->option4_quotation_header);
...
<h3 style="margin-top:15px;margin-bottom:0px;color: #fff">{{$data4->custom_package_name}}</h3>

<h4 style="margin-top:10px;margin-bottom:0px;color: #fff">{{$data4->duration-1}} Nights & {{$data4->duration}} Days</h4>
...
<div class="col-md-4 col-sm-6 col-xs-6">
		<div style="text-align: right;font-size: 15px;font-weight: bold;">
            ...
            <?php
          CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data4->option4_price,'adult'));
            ?>   
...
<div class="col-md-4 col-sm-6 col-xs-6">
	<div style="text-align: right;font-size: 15px;font-weight: bold;">
		<img src="http://imgak.mmtcdn.com/holidays/images/quotemanager/rupee.png"> 
     <?php
    CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data4->option4_price,'adult'));
     ?>
...
<div class="col-md-4 col-sm-6 col-xs-6">
	<div style="text-align: right;font-size: 15px;font-weight: bold;">
		<img src="http://imgak.mmtcdn.com/holidays/images/quotemanager/rupee.png">
		<?php
      CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data4->option4_price,'adult'));
		?> 
		<br>
		<span style="font-weight: bold;font-size: 8px">( {{ $data4->anything }} )</span>
	</div>
</div>
</div>
</div>
...
<div style="text-align: right;font-size: 15px;font-weight: bold;">
	...
	{{ date("d M'y", strtotime($data4->option4_validaty)) }}
</div>
	</div>
	@endif
<!---->
...
@if($data4->option4_transport=="Flight")
<?php
$flight_detail=unserialize($data4->option4_flight);
...
<tr>
<td>
<h3 class="my_h3">{{$data4->option4_transport}}</h3>
</td>
</tr>
</table>
<table width="100%">
...
<td style="padding: 15px 8px;background: #fff;border: 1px solid #bdbdbd;line-height: 22px;font-size: 14px;color: #636363;" class="custom_padding">
   ...
   $v_policy=unserialize($data4->option4_package_visa);
   ?> 
...
$p_policy=unserialize($data4->option4_package_payment);
?> 
...
{{$data4->option4_payment_policies}} 
...
$c_policy=unserialize($data4->option4_package_can);
?> 
...
$important_notes=unserialize($data4->option4_package_impnotes);
?> 
...
<?php
$footer=unserialize($data4->option4_quotation_footer);
