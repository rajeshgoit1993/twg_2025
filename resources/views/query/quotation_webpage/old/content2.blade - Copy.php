...
<?php
$header=unserialize($data2->option2_quotation_header);
...
<h3 style="margin-top:15px;margin-bottom:0px;color: #fff">{{$data2->custom_package_name}}</h3>

<h4 style="margin-top:10px;margin-bottom:0px;color: #fff">{{$data2->duration-1}} Nights & {{$data2->duration}} Days</h4>
...
<div class="col-md-4 col-sm-6 col-xs-6">
		<div style="text-align: right;font-size: 15px;font-weight: bold;">
            ...
            <?php
          CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data2->option2_price,'adult'));
            ?>   
...
<div class="col-md-4 col-sm-6 col-xs-6">
	<div style="text-align: right;font-size: 15px;font-weight: bold;">
		<img src="http://imgak.mmtcdn.com/holidays/images/quotemanager/rupee.png"> 
     <?php
    CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data2->option2_price,'adult'));
     ?>
...
<div class="col-md-4 col-sm-6 col-xs-6">
	<div style="text-align: right;font-size: 15px;font-weight: bold;">
		<img src="http://imgak.mmtcdn.com/holidays/images/quotemanager/rupee.png">
		<?php
      CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data2->option2_price,'adult'));
		?> 
		<br>
		<span style="font-weight: bold;font-size: 8px">( {{ $data2->anything }} )</span>
	</div>
</div>
</div>
</div>
...
<div style="text-align: right;font-size: 15px;font-weight: bold;">
	<img src="http://imgak.mmtcdn.com/holidays/images/quotemanager/rupee.png">
    <?php
      CustomHelpers::get_indian_currency($option2_total);
	?> 
</div>
</div>
</div>
...
<div style="text-align: right;font-size: 15px;font-weight: bold;">
	<img src="http://imgak.mmtcdn.com/holidays/images/quotemanager/rupee.png"> 
   <?php
      CustomHelpers::get_indian_currency($option2_total_discount);
	?>
...
<div class="col-md-4 col-sm-6 col-xs-6">
	<div style="text-align: right;font-size: 15px;font-weight: bold;">
        ...
        <?php
      CustomHelpers::get_indian_currency($option2_total-$option2_total_discount);
	?>
...
<div style="text-align: right;font-size: 15px;font-weight: bold;">
	...
	{{ date("d M'y", strtotime($data2->option2_validaty)) }}
</div>
	</div>
	@endif
<!---->
...
@if($data2->option2_transport=="Flight")
<?php
$flight_detail=unserialize($data2->option2_flight);
...
<td style="padding: 15px 8px;background: #fff;border: 1px solid #bdbdbd;line-height: 22px;font-size: 14px;color: #636363;" class="custom_padding">
   ...
   $v_policy=unserialize($data2->option2_package_visa);
   ?> 
...
$p_policy=unserialize($data2->option2_package_payment);
?> 
...
{{$data2->option2_payment_policies}} 
...
$c_policy=unserialize($data2->option2_package_can);
?> 
...
$important_notes=unserialize($data2->option2_package_impnotes);
?> 
...
<?php
$footer=unserialize($data2->option2_quotation_footer);
