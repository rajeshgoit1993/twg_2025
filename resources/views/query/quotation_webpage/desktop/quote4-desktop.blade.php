<div>
	...
	<div class="" style="border: 1px solid #CED0D4;padding: 25px 40px;border-radius: 10px;background: #ffffff;margin-bottom: 10px">
		<div class="makeflex" style="">
			...
			<div>
				<div class="flexcenter" style="justify-content: space-between">
					...
					<p class="pfwmt" style="font-size: 16px"><span style="font-size:14px;font-weight: 400">&#x20B9; </span> <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_total($data4->option4_price,'adult')); ?></p>
				</div>
				<hr style="border: 1px solid lightgray;margin: 16px 0px"></hr>
				<div class="flexcenter" style="justify-content: space-between">
					<p class="pfwmt">Discount (-)</p>
					<p class="pfwmt" style="font-size: 16px"><span style="font-size:14px;font-weight: 400">&#x20B9; </span> <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_discount($data4->option4_price,'adult')); ?></p>
				</div>
				<hr style="border: 1px solid lightgray;margin: 16px 0px"></hr>
				<div class="flexcenter" style="justify-content: space-between">
				...
				<div class="makeflex" style="justify-content: space-between">
					...
					<div>
					<p class="pfwmt" style="font-size: 21px"><span style="font-size:14px;font-weight: 400">&#x20B9; </span> <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data4->option4_price,'adult')); ?></p>
					</div>
				</div>
			</div>
			...
			<div>
				<div class="flexcenter" style="justify-content: space-between">
					...
					?>
					<p class="pfwmt" style="font-size: 16px"><span style="font-size:14px;font-weight: 400">&#x20B9; </span> <?php CustomHelpers::get_indian_currency($option4_total); ?></p>
				</div>
				<hr style="border: 1px solid lightgray;margin: 16px 0px"></hr>
				<div class="flexcenter" style="justify-content: space-between">
					<p class="pfwmt">Discount (-)</p>
					...
					?>
					<p class="pfwmt" style="font-size: 16px"><span style="font-size:14px;font-weight: 400">&#x20B9; </span> <?php CustomHelpers::get_indian_currency($option4_total_discount); ?></p>
				</div>
				<hr style="border: 1px solid lightgray;margin: 16px 0px"></hr>
				<div class="flexcenter" style="justify-content: space-between">
					<p class="pfwmt">GST (5%)</p>
				...
				<div class="flexcenter" style="justify-content: space-between">
					...
					<p class="pfwmt" style="font-size: 21px"><span style="font-size:14px;font-weight: 400">&#x20B9; </span> <?php CustomHelpers::get_indian_currency($option4_total-$option4_total_discount); ?></p>
				</div>
			</div>
			@endif
			<i>
		...
		@if($data4->option4_validaty!="")
			<div class="flexcenter" style="justify-content: flex-end;margin-top: 10px">
				...
				<div class="pfwmt" style="font-size: 12px;color: #9B9B9B;line-height: 12px;text-transform: uppercase">{{ date("d M Y", strtotime($data4->option4_validaty)) }}</div>
			</div>
		@endif
		<!--Quote Validity ends-->
	</div>
	...
	@else
		<div style="border: 1px solid #CED0D4;border-radius: 5px;padding: 25px;background: #ffffff;margin-bottom: 10px">
			...
			@endforeach
				<div class="pfwmt" style="margin: 20px 20px 0px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 3px;background: #ffffff">{{ $data4->option4_visa_policies }}</div>
		</div>
	@endif
	@endif
	...
	@else
		...
		@endforeach
			<div class="pfwmt" style="margin: 0px 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 3px;background: #ffffff">{{ $data4->option4_payment_policies }}</div>
	...
	@else
		...
		@endforeach
			<div class="pfwmt" style="margin: 0px 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 3px;background: #ffffff">{{ $data4->option4_cancellation }}</div>
	@endif
	...
	@if(empty($data4->option4_package_impnotes) || $data4->option4_package_impnotes=="N;")
	@else
	<div style="border: 1px solid #CED0D4;border-radius: 5px;padding: 25px;background: #ffffff;margin-bottom: 10px">
		...
		@endforeach
			<div class="pfwmt" style="margin: 0px 20px;padding: 5px 10px;font-size: 14px;line-height: 20px;border: 1px solid #e9e9e9;border-radius: 3px;background: #ffffff">{{ $data4->option4_extra_imp }}</div>
	</div>
	@endif
