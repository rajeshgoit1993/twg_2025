				...
				@else
					...
					<div class="tourQteSvcIcns">
						<div class="tourQteSvcIcnImg">
							<img class="tourQteSvcImg" src="{{ url('/public/uploads/icons/'.CustomHelpers::getimagename($icon,'rt_icons','icon')) }}">
						</div>
		...
		<div class="makeflex">
			...
			<div>
				<div class="makeflexCenterBewtween">
					...
					<p class="tourQuotePriceValue"><span class="tourQuoteDefaultCurency">&nbsp;</span> {{CustomHelpers::get_indian_currency(round($price_data_first['query_total_group']/($data1->quote1_number_of_adult+$data1->extra_adult+$data1->child_with_bed+$data1->child_without_bed+$data1->infant+$data1->solo_traveller)))}}
			...
			<div class="tourQuoteOnwardFlightBox">
				...
				<div class="onwardFlightBox">
					<div class="flexCenter appendBottom15">
						...
						<span class="flightClass">@if(array_key_exists('cabin',$flight_detail)) {{CustomHelpers::get_flight_class_name($flight_detail['cabin'])}} Class @endif</span>
					</div>
					<div class="flexCenter appendLeft20">
						...
						<div class="W100">
							...
							<p class="flightCity">@if($flight_detail['origin']!="") {{ CustomHelpers::get_city_seperate_code($flight_detail['origin'],'last_str') }} @endif</p>
						</div>
						...
						<div class="W100">
							...
							<p class="flightCity" >@if($flight_detail['dest']!="") {{ CustomHelpers::get_city_seperate_code($flight_detail['dest'],'last_str') }} @endif</p>
						</div>
					</div>
			...
			<div class="tourQuoteReturnFlightBox">
				...
				<div class="returnFlightBox">
					<div class="flexCenter appendBottom15">
						...
						<span class="flightStop">@if($flight_detail['numberstop']!="") {{$flight_detail['numberstop']}} @endif</span>
						<div class="classSeparator"></div>
						<span class="flightClass"> @if(array_key_exists('dcabin',$flight_detail)) {{CustomHelpers::get_flight_class_name($flight_detail['dcabin'])}} Class @endif</span>
					...
					<div class="flexCenter appendLeft20">
						...
						<div class="W100">
							...
							<p class="flightCity">@if(array_key_exists("dOrigin", $flight_detail) && $flight_detail['dOrigin']!="") {{ CustomHelpers::get_city_seperate_code($flight_detail['dOrigin'],'last_str') }}@endif</p>
						</div>
						<div class="flightDurationCont">
						...
						<div class="W100">
							...
							<p class="flightCity" >@if(array_key_exists("ddest", $flight_detail) && $flight_detail['ddest']!="") {{ CustomHelpers::get_city_seperate_code($flight_detail['ddest'],'last_str') }} @endif</p>
						</div>
					</div>
					<p class="baggageTitle">Baggage info</p>
					<div class="flexCenter">
	...
	@if($data1->transfers!='' && unserialize($data1->transfers)!='N;' && is_array(unserialize($data1->transfers)) && unserialize($data1->transfers)[0]['mode_title']!='')
