<div>
	...
	<div class="" style="padding: 20px;background: #ffffff;margin-bottom: 10px">
		...
		@if($data2->option2_validaty!="")
			<div class="flexcenter" style="justify-content: flex-end;margin-top: 10px">
				...
				<p class="pfwmt" style="font-size: 12px;color: #9B9B9B;line-height: 12px;text-transform: uppercase">{{ date("d M Y", strtotime($data2->option2_validaty)) }}</p>
			</div>
		@endif
		<!--Quote Validity ends-->
	</div>
	...
	<div style="padding: 20px;background: #ffffff;margin-bottom: 10px">
		<h3 class="pfwmt" style="font-size: 16px;line-height: 19px;color: #000000;margin-bottom: 20px;text-transform: uppercase">{{ $data2->option2_transport }}</h3>
		<div style="">
			<p class="pfwmt" style="font-size: 16px;line-height: 16px;font-weight: 500;color: #4A4A4A">{{ $data2->option2_transport_description }}</p>
		</div>
	</div>
	@endif
	...
	<div style="width: 100%;background-color: #000000;position: fixed;bottom: 0px;z-index:999">
		<div class="flexcenter" style="padding: 10px 20px;justify-content: space-between">
			<div class="makeflex" style="align-items: baseline">
				<p class="pfwmt" style="font-size: 20px;line-height: 24px;color: #ffffff;margin-right: 5px"><span style="font-size: 18px;font-weight: 500;">&#x20B9;</span> <?php CustomHelpers::get_indian_currency(CustomHelpers::get_quotation_grandtotal($data2->option2_price,'adult')); ?></p>
