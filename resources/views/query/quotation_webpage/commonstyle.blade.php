<style type="text/css">
.dCallBackBtn, .dCallBackBtn:hover {
	background: #fff;
    color: #a1a1a1;
    border: none;
	cursor: default;
	}
.dBookReqst, .dBookReqst:hover {
	background: #08b2ed;
    color: #fff;
	font-weight: 600;
    border: none;
...
.custom_padding ul > li {
	/*margin-left: -16px;*/
	list-style: disc;
	}
.custom_padding ol>li {
	/*margin-left: -16px;*/
	list-style:decimal;
	}
.my_h3 {
...
.quotation_red {
	border-top: 3px solid #08b2ed;
	/*border-bottom: 2px solid #08b2ed;*/
	margin-bottom: 5px;
	padding-top: 5px;
	}
.price_data {
