...
@section('content')
    ...
    <link rel="stylesheet" href="{{ url('/') }}/resources/assets/frontend/css/fullcalendar.min.css" />
...
<script type="text/javascript" src="{{url('/')}}/resources/assets/frontend/js/fullcalendar.js"></script>
