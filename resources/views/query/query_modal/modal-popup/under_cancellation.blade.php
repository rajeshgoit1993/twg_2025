<!-- Trip Under Cancellation Modal -->
<div id="under_cancelllation_modal" class="modal">
	<div class="modalContent lead-modalbox">
		<!-- Modal content starts-->
		<!-- Modal header-->
		<form class="user" id="enquiry_lead_under_cancelllation" method="POST" enctype="multipart/form-data">
			{{csrf_field()}}
			<input type="hidden" name="query_id" id="query_id_under_cancelllation" value="">

			<div class="lead-modalheader">
				<h2>Under Cancelllation</h2>
			</div>
			...
			<div class="lead-modalbody">
				...
				<div class="form-group">
					...
					<select class="lead-input-text fullWidth" required id="assign_person_under_cancelllation" name="assign_person"></select>
				</div>

				<!--Lead Cancelled Reason-->
				<div class="form-group">
					<label for="lead_cancel_reason" class="detailsInput">Reason </label>
					<select class="lead-input-text fullWidth" required id="under_cancelllation_reason" name="lead_cancel_reason"></select>
				</div>
			...
			<div class="lead-modalfooter">
				<button type="button" class="btn_lead_modal_close btn_lead_modal_under_cancelllation" id="btn_lead_modal_under_cancelllation">Cancel</button>
