...
<div id="refund_payment_modal" class="modal modal_js">
	<div class="modalContent lead-modalbox">
		<!-- Modal content starts-->
		<!-- Modal header-->
		<form class="user" id="update_refund_payments" method="POST" enctype="multipart/form-data">
			{{csrf_field()}}
			<input type="hidden" name="query_id" id="query_id_refund_payment" value="">
			<input type="hidden" name="quote_no_refund_payment" id="quote_no_refund_payment" value="">
			<input type="hidden" name="quote_id_refund_payment" id="quote_id_refund_payment" value="">
			...
			<div class="lead-modalbody">
				...
				<div class="form-group">
					...
					<input type="text" class="lead-input-text fullWidth" id="assigned_user_refund_payment" name="assigned_user" placeholder="Assigned User" disabled />
				</div>
				<!--Booking Reference No-->
				<div class="form-group">
					<label for="booking_reference_no">Booking Reference No</label>
					<input type="text" class="lead-input-text fullWidth" id="refund_booking_reference_no" name="booking_reference_no" placeholder="Booking Reference No" disabled />
				</div>
				<!--Guest Name-->
				<div class="form-group">
					<label for="booking_guest_name">Guest Name</label>
					<input type="text" class="lead-input-text fullWidth" id="refund_booking_guest_name" name="booking_guest_name" placeholder="Guest Name" disabled />
				</div>
				<!--Guest Mobile No-->
				<div class="form-group">
					<label for="booking_guest_mobile_no">Guest Mobile No</label>
					<input type="text" class="lead-input-text fullWidth" id="refund_booking_guest_mobile_no" name="booking_guest_mobile_no" placeholder="Guest Mobile No" disabled />
				</div>
				<!--Guest Email ID-->
				<div class="form-group">
					<label for="booking_guest_email_id">Guest Email ID</label>
					<input type="text" class="lead-input-text fullWidth" id="refund_booking_guest_email_id" name="booking_guest_email_id" placeholder="Guest Email ID" disabled />
				</div>
				...
				<div class="form-group">
					...
					<div class="makeflex">
						...
						<input type="text" class="lead-input-text fullWidth" style="border-radius: 0px 4px 4px 0px;background-color: #f9f9f9" id="total_quote_amount" name="total_amount" placeholder="Total Amount" readonly/>
					</div>
				</div>

				<!--Total Refundable Amount-->
				<div class="form-group">
					<label for="total_refundable_amount">Total Refundable Amount</label>
					<div class="makeflex">
						<div class="payment-currency-box"><span class="defaultCurencyPay"></span></div>
						<input type="text" class="lead-input-text fullWidth" style="border-radius: 0px 4px 4px 0px;background-color: #f9f9f9" id="total_refundable_amount" name="total_refundable_amount" placeholder="Total Refundable Amount" readonly/>
					</div>
				</div>

				<!--Refunded Amount-->
				<div class="form-group">
					<label for="refunded_amounts">Total Refunded Amount</label>
					<div class="makeflex">
						<div class="payment-currency-box"><span class="defaultCurencyPay"></span></div>
						<input type="text" class="lead-input-text fullWidth" style="border-radius: 0px 4px 4px 0px;background-color: #f9f9f9" id="refunded_amounts" name="refunded_amounts" placeholder="Total Refunded Amount" readonly/>
					</div>
				</div>

				<!--Due Amount-->
				<div class="form-group">
					<label for="due_refund_amount">Due Refund</label>
					<div class="makeflex">
						<div class="payment-currency-box"><span class="defaultCurencyPay"></span></div>
						<input type="text" class="lead-input-text fullWidth" style="border-radius: 0px 4px 4px 0px;background-color: #f9f9f9" id="due_refund_amount" name="due_refund_amount" placeholder="Due Refund" readonly/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="makeflex">
						<div class="payment-currency-box"><span class="defaultCurencyPay"></span></div>
						<input type="text" required class="lead-input-text fullWidth" style="border-radius: 0px 4px 4px 0px" id="cancellation_charge" name="cancellation_charge" placeholder="Enter Cancellation Charge" readonly />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="makeflex">
						<div class="payment-currency-box"><span class="defaultCurencyPay"></span></div>
						<input type="text" required class="lead-input-text fullWidth" style="border-radius: 0px 4px 4px 0px" id="receiving_amount" name="receiving_amount" placeholder="Enter Amount" />
					</div>
				</div>
				...
				<div class="form-group fullWidth">
					<label for="receiving_amount_datetime" class="detailsInput">Amount Refund Date & Time </label>
					<div class="makeflex">
						<input type="datetime-local" class="lead-input-text fullWidth" id="receiving_amount_datetime" name="receiving_amount_datetime" style="border-radius: 4px 0px 0px 4px; border-right: none;" />
			...
			<div class="lead-modalfooter make_bottom_bar_sticky">
				<button type="button" class="btn_lead_modal_close btn_lead_modal_close_refund_payment" id="btn_lead_modal_close_refund_payment">Cancel</button>
