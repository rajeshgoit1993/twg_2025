			...
			<div class="mobscroll scrollX">
				<div class="dPageContainer">
					...
					<div class="dSearchInputBox tourCityBox_update" onclick="document.getElementById('fromCity').focus();">
					    ...
					    <!-- <input type="text" id="fromCity" name="fromCity" value="{{ $details->sourcecity ?? 'JoiningDirect' }}" placeholder="Select City" readonly /> -->
					    <input type="text" id="fromCity" name="fromCity" value="{{ $details->sourcecity == null ? 'JoiningDirect' : $details->sourcecity }}" placeholder="Select City" readonly />
					</div>
					...
					<!-- <div class="dSearchInputBox tourCityBox_update">
						...
						<input type="text" id="tourName" name="tourName" value="{{ $details->title }}" placeholder="Enter city e.g. Goa, Singapore.." readonly />
					</div> -->
