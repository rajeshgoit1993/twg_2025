                ...
                <div class="box">
                    ...
                    <div class="box-body">
                    	...
                    	<div class="payment-mode-container">
                    		<form action="{{URL::to('/update_payment_mode')}}" method="Post" enctype="multipart/form-data">
		                            ...
		                            <div class="row">
		                                <div class="col-md-3">
		                                    <div class="form-group">
		                                        ...
		                                        <input type="text" class="form-control textCapitalize" id="mode" name="mode" value="{{$payment_mode_data->mode}}" placeholder="Payment Mode Name">
		                                    </div>
		                                </div>
		                                <div class="col-md-3">
		                                    <div class="form-group">
		                                        <label for="gateway_id" class="field-required">Gateway Name</label>
		                                        <select class="form-control textCapitalize" id="gateway_id" name="gateway_id" required>
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
		                                        ...
		                                        <select class="form-control" id="mdr" name="mdr" required>
		                                            ...
		                                            @for ($i = 1; $i <= 10; $i++)
		                                                <option value="{{ $i }}" @if($payment_mode_data->mdr == $i) selected @endif>{{ $i }} %</option>
		                                            @endfor
		                                        </select>
		                                    </div>
		                                </div>
		                                ...
		                                <div class="col-md-3">
		                                    <div class="form-group">
		                                        ...
		                                        <select class="form-control" id="gst_on_mdr" name="gst_on_mdr" required>
		                                            <option value="" selected disabled>Select</option>
		                                            @for ($i = 1; $i <= 18; $i++)
		                                                <option value="{{ $i }}" @if($payment_mode_data->gst_on_mdr == $i) selected @endif>{{ $i }} %</option>
		                                            @endfor
		                                        </select>
		                                    </div>
		                                </div>
