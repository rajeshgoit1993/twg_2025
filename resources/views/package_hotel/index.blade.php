                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <select id="country" class="form-control addcountry" name="choosecountry">
                                        ...
                                        @foreach($hotels_countries as $row=>$col)
                                        
                                            <option value="{{ $col }}">{{ CustomHelpers::get_master_table_data('countries', 'id', (int)$col, 'name') }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="box-body">
                        ...
                        <table  id="example2" class="table table-bordered table-striped example2">
                            ...
                            @if(Sentinel::check())
                                ...
                                <div class="add">
                                    <a href="{{ route('packageHotel') }}" class="btn btn-success">
...
function fetch_datas($statesave) {
    ...
    var table = $('#example2').DataTable({
        ...
        stateSave: $statesave,
        ajax: {
            url: "{{ route('package_hotels') }}", // Server route for fetching data
