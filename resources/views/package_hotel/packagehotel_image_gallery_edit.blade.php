            ...
            <div class="box-body">
              ...
              <div id="dGalleryTopBarCont">
                <div class="makeflex align-center">
                  <div>
                    <a href="{{URL::to('/packagehotelUploads/'.Request::segment(3))}}" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left"> </i> Back</a>
                  </div>
                </div>
              </div>
              ...
              <div class="box-header">
                <h3 class="box-title">Edit Photos from gallery <span class="font14">
                  (Image from
                    {{$country_name}} &rarr;
                    {{$city_name}} &rarr;
                    {{ CustomHelpers::get_packagehotel_title(Request::segment(3)) }}
                  )</span>
                </h3>
              </div>
              <div class="dImgSelectionCont">
                <!-- Image Selection Form -->
                <form action="{{ URL::to('/packagehotel_image_save/'.Request::segment(2).'/'.Request::segment(3).'/'.Request::segment(4)) }}" method="post">
                  {{ csrf_field() }}
                      ...
                      <div class="dImgCardCont">
                        <div class="dImgCardBox">
                          ...
                          <label class="labelGallery">
                            <input type="radio" name="image_from_gallery" value="{{$datavalue->id}}" @if(CustomHelpers::get_data_conditions_packagehotel($datavalue->id)==Request::segment(2)) checked @endif>
