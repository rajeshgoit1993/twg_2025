                    ...
                    <div class="box-body">
                         ...
                         <div id="dGalleryTopBarCont">
                              <div class="makeflex align-center">
                                   <div>
                                        <a href="{{ URL::to('/packagehotel_image_location/'.Request::segment(2)) }}" class="btn btn-success"><i class="glyphicon glyphicon-arrow-left"></i> Back</a>
                                   </div>
...
{{CustomHelpers::get_master_table_data('city', 'id', (int)$city, 'name')  }}
                         ...
                         <div class="dImgSelectionCont">
                              ...
                              <form action="{{ URL::to('/packagehotel_image_save/'.Request::segment(2)) }}" method="post">
                                   {{ csrf_field() }}
                                   <div class="row">
