...
<li class="{{Request::is('Activate-Services') ? 'active' : ''}} "><a href="{{URL::to('/Activate-Services')}}"><i class="fa fa-dashboard"></i> Activate Services</a></li>
@endif
@endif
@if(Sentinel::check())
<!--New Role Start-->
...
?>
<li class="treeview {{Request::is('query') || Request::is('enquiry') || Request::is('saved_quotation') || Request::is('quotation') || Request::is('add_quotation') || Request::is('add_customer') || Request::is('Leads-Follow-up') || Request::is('Payment') || Request::is('Confirmation') || Request::is('Cancelled-Leads') || Request::is('Deleted-Leads') || Request::is('Vouchers') || Request::is('Post-Tour') || Request::is('lead_settings') ? 'active' : '' }}">
<a href="#">
...
?>
<li class="{{Request::is('add_customer')  ? 'active' : ''  }}"><a href="{{URL::to('/add_customer')}}"><i class="fa fa-circle-o"></i>Add Leads</a></li>
<?php
endif;
?>
@endif
...
if($check_data_leads->activation==1):
?>
<li class="{{Request::is('enquiry')  ? 'active' : ''  }}"><a href="{{URL::to('/enquiry')}}"><i class="fa fa-circle-o"></i>Web Leads</a></li>
<?php
endif;
?>
<?php
...
?>
<li class="{{Request::is('query')  ? 'active' : ''  }}"><a href="{{URL::to('/query')}}"><i class="fa fa-circle-o"></i>Verified Leads</a></li>
<li class="{{Request::is('saved_quotation')  ? 'active' : ''  }}"><a href="{{URL::to('/saved_quotation')}}"><i class="fa fa-circle-o"></i>Saved Quote</a></li>
<li class="{{Request::is('quotation')  ? 'active' : ''  }}"><a href="{{URL::to('/quotation')}}"><i class="fa fa-circle-o"></i>Quote sent</a></li>
<li class="{{Request::is('Leads-Follow-up')  ? 'active' : ''  }}"><a href="{{URL::to('/Leads-Follow-up')}}"><i class="fa fa-circle-o"></i>Leads Follow-up</a></li>
<li class="{{Request::is('Payment')  ? 'active' : ''  }}"><a href="{{URL::to('/Payment')}}"><i class="fa fa-circle-o"></i>Payment</a></li>
<li class="{{Request::is('Confirmation')  ? 'active' : ''  }}"><a href="{{URL::to('/Confirmation')}}"><i class="fa fa-circle-o"></i>Confirmation </a></li>
<li class="{{Request::is('Cancelled-Leads')  ? 'active' : ''  }}"><a href="{{URL::to('/Cancelled-Leads')}}"><i class="fa fa-circle-o"></i>Cancelled Leads </a></li>
<li class="{{Request::is('Vouchers')  ? 'active' : ''  }}"><a href="{{URL::to('/Vouchers')}}"><i class="fa fa-circle-o"></i>Vouchers </a></li>
...
<a href="#">
<i class="fa fa-briefcase"></i>
<span>Tour Package Manager</span>
<span class="pull-right-container">
<i class="fa fa-angle-left pull-right"></i>
</span>
</a>
...
@if(Sentinel::getUser()->inRole('administrator') || Sentinel::getUser()->inRole('supervisor') || Sentinel::getUser()->inRole('super_admin'))
<li class="{{ Request::is('add-package') ? 'active' : '' }}"><a href="{{URL::to('/add-package')}}"><i class="fa fa-circle-o"></i>Add Package</a></li>
@endif
...
<li class="{{ Request::is('package-settings') ? 'active' : '' }}"><a href="{{URL::to('/package-settings')}}"><i class="fa fa-circle-o"></i>Settings</a></li>
<li class="{{ Request::is('package-locations') ? 'active' : '' }}"><a href="{{URL::to('/package-locations')}}"><i class="fa fa-circle-o"></i>Destinations</a></li>
...
?>
<li class="treeview  {{ Request::is('rate') || Request::is('add_city') || Request::is('mid_images') || Request::is('testimonials')  || Request::is('add_testimonial') || Request::is('newsletter_back') ? 'active' : '' }} " >
<a href="#">
<i class="fa fa-briefcase"></i>
<span>Settings</span>
<span class="pull-right-container">
...
@if(Sentinel::getUser()->inRole('administrator') || Sentinel::getUser()->inRole('supervisor') || Sentinel::getUser()->inRole('super_admin'))
<li class="{{ Request::is('add_city') ? 'active' : '' }}"><a  href="{{URL::to('/add_city')}}"><i class="fa fa-circle-o"></i>Add City</a></li>
@endif
@if(Sentinel::getUser()->inRole('administrator') || Sentinel::getUser()->inRole('super_admin'))
