	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">Edit Tour Tour Discounts</h3>
			</div>
			<div class="box-body">
				<form action="{{URL::to('/update-tourdiscounts/'.$data->id)}}" method="post" >
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<select class="form-control" id="charge_type" required name="charges_type">
									...
									<option value="Markup Profit" @if($data->charges_type=='Markup Profit') selected @endif>Markup Profit</option>
									<option value="Discount (+)" @if($data->charges_type=='Discount (+)') selected @endif>Discount (+)</option>
									<option value="Discount (-)" @if($data->charges_type=='Discount (-)') selected @endif>Discount (-)</option>
								</select>
							</div>
						</div>
