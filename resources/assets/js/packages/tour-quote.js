...
$(".editTourType").on("click", function () {
    ...
    $('#editToursModel .location').html('').html('<option value="'+typelocation+'" selected>'+typelocation+'</option>');
...
$(".editActivityType").on("click", function () {
    ...
    $('#editActivityModel .location').html('').html('<option value="'+typelocation+'" selected>'+typelocation+'</option>');
...
$(document).on("change",".price_applicable_for",function(){
    ...
    if(price_applicable_for=='all') {
        $(this).parent().siblings(".price_td").children(".price_daywise").css("display","none")
        $(this).parent().siblings(".price_td").children(".over_all_discount_type").css("display","block")
    } else {
        $(this).parent().siblings(".price_td").children(".price_daywise").css("display","block")
        $(this).parent().siblings(".price_td").children(".over_all_discount_type").css("display","none")
    }
});
...
$(document).ready(function () {
    ...
    /*// Handle select all duration or deselect all duration functionality
    ...
    $("#add-continent-row").click(function () {
        ...
        if (row_count < limit && duration_days_count >= limit) {
                ...
                <div class='col-md-12'>
                    <div class='item-container remove dfp dfp-${rowId}'>
                        <div class='col-md-2 form-group'>
                            ...
                            <select name='continent[${continent_name}]' id='continent' class='form-control continent'>
                        ...
                        <div class='col-md-2 form-group'>
                            ...
                            <select name='country[${continent_name}]' id='package_dest_countries${continent_name}' class='form-control package_dest_country' onchange='myFunction(this)'>
                                <option value='0'></option>
                            </select>
                        </div>
                        <div class='col-md-2 form-group'>
                            <label for='package_dest_state'>State</label>
                            <select name='state[${continent_name}]' id='package_dest_state${continent_name}' class='form-control package_dest_countries${continent_name}' onchange='sateFunction(this)'></select>
                        </div>
                        <div class='col-md-2 form-group'>
                            <label for='package_dest_city'>City</label>
                            <select name='city[${continent_name}]' id='package_dest_city' class='form-control package_dest_state${continent_name} package_dest_cities city_package_dest_countries${continent_name} min-select' onchange='cityFunction(this)'></select>
                        </div>
                        <div class='col-md-2 form-group'>
            ...
            $.ajax({
                ...
                url: APP_URL + '/country_url',
                success: function(data) {
                    // Populate countries dropdown based on AJAX response
                    $('#package_dest_countries' + continent_name).html('').html(data);
                },
                error: function(data) {
