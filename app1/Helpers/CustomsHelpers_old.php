...
return $PkgTours;
  ...
  public static function get_master_table_data($table, $whereColumn, $id, $returnColumn) {
    ...
    if ($data !== null) {
        ...
        // If no record was found, log a warning and return null
        //\Log::warning("No record found in table '$table' where column '$whereColumn' equals '$id'");
  ...
  public static function get_inclusions($id) {
    // Perform the query to select the name from the rt_pkg_inclusions table where the ID matches
  ...
  /*public static function get_exc($id) {
    $poli = DB::table('rt_pkg_exclusions')
    ->select('name')
    ->where('id',$id)
    ->get()->first();
    return $poli->name;
  ...
  public static function get_exc($id) {
    // Perform the query to select the name from the rt_pkg_exclusions table where the ID matches
...
$sta=CustomHelpers::get_master_table_data('city', 'id', (int)$datavalue->city, 'name');
  ...
  public static function get_remaining_amount_second($quote_no,$unique_code)
  {
     ...
     // $total_quote_amount=CustomHelpers::get_quotation_price($data);
